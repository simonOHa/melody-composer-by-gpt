    ...
    (e = {
      ...
      6306: function (e, t, r) {
        ...
        !(function () {
          "use strict";
          var e, t;
          (a.startAnimation = function (r, a, i) {
            function s(e) {
            ...
            var o;
            function c(e) {
              i.hideCurrentMeasure
                ? (function (e) {
                    s(r.querySelectorAll(e));
                  })(e)
                : i.hideFinishedMeasures &&
                  (function (e) {
      ...
      4321: function (e, t, r) {
        var n = r(4916),
          a = r(5952),
          i = { violin: "ViolinTab", guitar: "GuitarTab" },
          s = {
            inited: !1,
            plugins: {},
            register: function (e) {
            ...
            preparePlugins: function (e, t, r) {
              ...
              if (r.tablature) {
                ...
                for (var s = 0; s < a.length; s++) {
                  ...
                  if (null == c)
                    return (
                      this.setError(e, "tablature 'instrument' is missing"), n
                    );
                  var l = i[c],
                    h = null;
                  if ((l && (h = this.plugins[l]), !h))
                    return (
                      this.setError(e, "Undefined tablature plugin: " + c), n
                    );
                  0 != r.visualTranspose &&
                    (o.visualTranspose = r.visualTranspose),
                    (o.abcSrc = r.tablature.abcSrc);
                  var u = {
                    classz: h,
                    tuneNumber: t,
                    params: o,
                ...
                if (i)
                  for (var s = 0; s < i.length; s++)
                    if (r[s]) {
                      var o = r[s];
                      null == o.instance &&
                        ((o.instance = new o.classz()),
                        o.instance.init(t, o.tuneNumber, o.params, s)),
                        o.instance.render(e, a, s);
                    }
              }
            },
            init: function () {
      ...
      5681: function (e) {
        e.exports = function (e, t) {
          ...
          if (
            (t || (t = {}),
            (r.qpm = t.qpm ? parseInt(t.qpm, 10) : null),
            !r.qpm)
          ) {
          ...
          (r.extraMeasuresAtBeginning = t.extraMeasuresAtBeginning
            ...
            (r.replaceTarget = function (e) {
              (r.noteTimings = e.setTiming(r.qpm, r.extraMeasuresAtBeginning)),
                0 === e.noteTimings.length && e.setTiming(0, 0),
                r.lineEndCallback &&
                  (r.lineEndTimings = (function (e, t) {
                    for (var r = [], n = null, a = 0; a < e.length; a++) {
                      var i = e[a];
                      "end" !== i.type &&
                        i.top !== n &&
                        (r.push({
                          measureNumber: i.measureNumber,
                          milliseconds: i.milliseconds - t,
                          top: i.top,
                ...
                0 !== r.noteTimings.length &&
                  ((r.millisecondsPerBeat =
                    1e3 / (r.qpm / 60) / r.beatSubdivisions),
                  (r.lastMoment =
                    r.noteTimings[r.noteTimings.length - 1].milliseconds),
                  (r.totalBeats = Math.round(
                    r.lastMoment / r.millisecondsPerBeat
                  )));
            }),
            r.replaceTarget(e),
            ...
            (r.doBeatCallback = function (e) {
              if (r.beatCallback) {
                for (
                  var t, n, a = r.currentEvent;
                  a < r.noteTimings.length && null === r.noteTimings[a].left;

                )
                  a++;
                if (a < r.noteTimings.length) {
                  for (
                    t = r.noteTimings[a].milliseconds, a = r.currentEvent - 1;
                    a >= 0 && null === r.noteTimings[a].left;
            ...
            (r.start = function (e, t) {
              if (
                ((r.isRunning = !0),
                r.isPaused &&
                  ((r.isPaused = !1), void 0 === e && (r.justUnpaused = !0)),
                e)
              )
                r.setProgress(e, t);
              else if (0 === e) r.reset();
            ...
            (r.setProgress = function (e, t) {
              ...
              switch (t) {
                case "seconds":
                  (r.currentTime = 1e3 * e),
                    ...
                    r.currentTime > r.lastMoment &&
                      (r.currentTime = r.lastMoment),
                    (n = r.currentTime / r.lastMoment);
                  break;
                case "beats":
                  (r.currentTime =
                    e * r.millisecondsPerBeat * r.beatSubdivisions),
                    r.currentTime < 0 && (r.currentTime = 0),
                    r.currentTime > r.lastMoment &&
                      (r.currentTime = r.lastMoment),
                    (n = r.currentTime / r.lastMoment);
                ...
                default:
                  (n = e) < 0 && (n = 0),
                    n > 1 && (n = 1),
                    (r.currentTime = r.lastMoment * n);
              }
              r.isRunning || (r.pausedPercent = n);
              var a = performance.now();
              for (
                r.startTime = a - r.currentTime,
                  r.currentEvent,
                  r.currentEvent = 0;
                r.noteTimings.length > r.currentEvent &&
                r.noteTimings[r.currentEvent].milliseconds < r.currentTime;
              ...
              if (r.lineEndCallback)
                for (
                  ...
                  r.currentLine++;
              var i = r.currentBeat;
              (r.currentBeat = Math.floor(
                r.currentTime / r.millisecondsPerBeat
              )),
                r.beatCallback &&
                  i !== r.currentBeat &&
        ...
        !(function () {
          ...
          (e.prototype.getTuneById = function (e) {
            ...
            (o.parseOnly = function (e, t) {
              for (var r = o.numberOfTunes(e), n = [], a = 0; a < r; a++)
                n.push(1);
              return o.renderEngine(function () {}, n, e, t);
            }),
            (o.renderEngine = function (t, r, i, o) {
              var c = [];
              if (void 0 !== r && void 0 !== i) {
                var l;
                (!(l = r) ||
                  l.propertyIsEnumerable("length") ||
                  "object" !== n(l) ||
                  "number" != typeof l.length) &&
                  (r = [r]),
                  void 0 === o && (o = {});
                for (
                  var h = o.startingTune ? parseInt(o.startingTune, 10) : 0,
                    u = new e(i),
                    d = new a(),
                    f = 0;
                  f < r.length;
                  ...
                  if (
                    ...
                    if (h >= 0 && h < u.tunes.length) {
                      d.parse(
                        u.tunes[h].abc,
                        o,
                        u.tunes[h].startPos - u.header.length
                      );
                      var m = d.getTune();
                      o.tablature &&
                        (s.init(), (m.tablatures = s.preparePlugins(m, h, o)));
                      var g = d.getWarnings();
                      g && (m.warnings = g);
            ...
            (o.extractMeasures = function (t) {
              for (var r = [], n = new e(t), a = 0; a < n.tunes.length; a++) {
                for (
                  var i = n.tunes[a],
                    s = i.abc.split("K:"),
                    c = s[1].split("\n"),
                  ...
                  if (b.staff)
                    for (var y = 0; y < 1; y++)
                      for (var w = b.staff[y], x = 0; x < 1; x++)
                        for (var k = w.voices[x], C = 0; C < k.length; C++) {
                          var T = k[C];
                          if (
                            (null === d &&
                              T.startChar >= 0 &&
                              ((d = T.startChar),
                              (u = void 0 === T.chord ? h : null)),
                            T.chord && (h = T),
                            "bar" === T.el_type)
                          ) {
                            if (p) {
                              var S = { abc: i.abc.substring(d, T.endChar) };
                              (h =
                                u && u.chord && u.chord.length > 0
                                  ? u.chord[0].name
                                  : null) && (S.lastChord = h),
                                T.startEnding &&
                                  (S.startEnding = T.startEnding),
                                T.endEnding && (S.endEnding = T.endEnding),
                                f.push(S),
                                (d = null),
                                (p = !1);
                            }
      ...
      6859: function (e, t, r) {
        ...
        e.exports = function (e, t, r, o, c) {
          ...
          if (r) {
            ...
            u.warnings_id &&
              u.tablature &&
              (u.tablature.warning_id = u.warnings_id);
          }
          if (o)
            for (h in o)
              o.hasOwnProperty(h) &&
                ("listener" === h
                  ? o[h].highlight && (u.clickListener = o[h].highlight)
                  : (u[h] = o[h]));
              ...
              return (
                ...
                !o && u.wrap && u.staffwidth
                  ? ((t = (function (e, t, r, n, o) {
                      var c = new a(e, o).getMeasureWidths(t),
                      ...
                      return (
                        l(e, t, h.revisedParams, r, 0),
                        (t.explanation = h.explanation),
                        t
                      );
                    })(e, t, r, n, u)),
                    t)
      ...
      9447: function (e, t, r) {
        var n = r(4914).relativeMajor,
          ...
          m = { acc: "flat", note: "c" },
          g = {
            "C#": [a, i, s, o, c, l, { acc: "sharp", note: "B" }],
            "F#": [a, i, s, o, c, l],
            B: [a, i, s, o, c],
            E: [a, i, s, o],
            A: [a, i, s],
      ...
      4914: function (e) {
        ...
        e.exports = {
          ...
          relativeMode: function (e, r) {
            ...
            if (!n) return e;
            if ("" === r) return e;
            var a = r.toLowerCase().match(/^(maj|min|mix|dor|phr|lyd|loc|m)/);
            if (!a) return e;
            for (var i = a[1], s = 0; s < n.modes.length; s++) {
              var o = n.modes[s],
                c = o.toLowerCase().indexOf(i);
              if (-1 !== c && c === o.length - i.length)
                return o.substring(0, o.length - i.length);
            }
            return e;
          },
          transposeKey: function (e, r) {
            ...
            for (; r < 0; ) r += 12;
            for (
              var a = (n.stepsFromC + r) % 12, i = 0;
              i < Object.keys(t).length;
              i++
            ) {
              var s = Object.keys(t)[i];
              if (t[s].stepsFromC === a) return s;
            }
            return e;
          },
        };
      ...
      6780: function (e, t, r) {
        ...
        e.exports = function () {
          function e(e, t, r, n) {
            for (var a = 0; a < n.length; a++) e[r][n[a]] = t[r][n[a]];
          }
          function t(e, t) {
          ...
          (this.reset = function () {
              ...
              var e = this.getBarLength(),
                t = (function (e, t) {
                  for (var r = 0, n = 0; n < e.length; n++)
                    if (e[n].staff)
                      for (var a = 0; a < e[n].staff.length; a++)
                        for (var i = 0; i < e[n].staff[a].voices.length; i++)
                          for (
                            var s = e[n].staff[a].voices[i], o = 1, c = 0;
                            c < s.length;
                            c++
                          ) {
              ...
              for (var t = 0; t < this.lines.length; t++) {
                ...
                if (r.staff)
                  for (var n = 0; n < r.staff.length; n++)
                    for (var a = r.staff[n], i = 0; i < a.voices.length; i++)
                      for (var s = a.voices[i], o = 0; o < s.length; o++) {
                        var c = s[o];
                        if (
                          c.startChar &&
                          c.endChar &&
            ...
            (this.addElementToEvents = function (e, t, r, a, i, s, o, c, l, h) {
                ...
                if (void 0 !== l)
                  ...
                  if (e["event" + r]) {
                    if (
                      ...
                      null === e["event" + r].startChar &&
                        (e["event" + r].startChar = t.abcelem.startChar),
                      null === e["event" + r].endChar &&
                        (e["event" + r].endChar = t.abcelem.endChar),
                      t.abcelem.midiPitches && t.abcelem.midiPitches.length)
                    )
                      for (
                        e["event" + r].midiPitches ||
                          (e["event" + r].midiPitches = []),
                          f = 0;
                        f < t.abcelem.midiPitches.length;
                        f++
                      )
                        e["event" + r].midiPitches.push(
                          t.abcelem.midiPitches[f]
                        );
                    if (
                      t.abcelem.midiGraceNotePitches &&
                      t.abcelem.midiGraceNotePitches.length
                    ) {
                      e["event" + r].midiGraceNotePitches ||
                        (e["event" + r].midiGraceNotePitches = []);
                      for (
                        var m = 0;
                        ...
                        e["event" + r].midiGraceNotePitches.push(
                    ...
                    (e["event" + r] = {
                      ...
                      midiPitches: t.abcelem.midiPitches
                        ? n.cloneArray(t.abcelem.midiPitches)
                        : [],
                    }),
                      t.abcelem.midiGraceNotePitches &&
                        (e["event" + r].midiGraceNotePitches = n.cloneArray(
                          t.abcelem.midiGraceNotePitches
                        ));
                  h && ((e["event" + r].measureStart = !0), (h = !1)),
                    p && (l = r);
                }
              }
              return {
            ...
            (this.makeVoicesArray = function () {
              for (
                var e = [], t = [], r = {}, n = 0;
                n < this.engraver.staffgroups.length;
                n++
              ) {
                var i = this.engraver.staffgroups[n];
                if (i && i.staffs && i.staffs.length > 0)
                  for (
                    var s = i.staffs[0],
                      o = s.absoluteY,
                      c = o - s.top * a.STEP,
                      l = i.staffs[i.staffs.length - 1],
                      h = (o = l.absoluteY) - l.bottom * a.STEP - c,
                      u = i.voices,
                      d = 0;
                    d < u.length;
                    d++
                    ...
                    for (var p = u[d].children, m = 0; m < p.length; m++)
                      "tempo" === p[m].type &&
                        ...
                        "bar" === p[m].type && f && t[d]++,
                        ("note" !== p[m].type && "rest" !== p[m].type) ||
                          (f = !0);
                  }
              }
              return (this.tempoLocations = r), e;
            }),
            (this.setupEvents = function (e, r, n, a) {
              a || (a = 1);
              for (
                var i,
                  s = [],
                ...
                for (var y = -1, w = 0; w < v.length; w++) {
                  var x = v[w].measureNumber;
                  y !== x &&
                    this.tempoLocations[x] &&
                    ((b = this.tempoLocations[x]),
                    (r = (a * this.getBeatLength() * b) / 60),
                    (y = x));
                  var k,
                    C = v[w].elem,
                    T = this.addElementToEvents(
                      o,
                      C,
                      p,
                      v[w].top,
                  ...
                  if (
                    ...
                    var S = C.abcelem.type,
                      _ = "bar_right_repeat" === S || "bar_dbl_repeat" === S,
                      A = "1" === C.abcelem.startEnding,
                      E =
                        "bar_left_repeat" === S ||
                        "bar_dbl_repeat" === S ||
                        "bar_right_repeat" === S;
                    if (_) {
                      w > 0 && (o[k].endX = C.x), -1 === g && (g = w);
                      var N = 0;
                      y = -1;
                      for (var M = m; M < g; M++) {
                        y !== (x = v[M].measureNumber) &&
                          this.tempoLocations[x] &&
                          ((b = this.tempoLocations[x]),
                          (r = (a * this.getBeatLength() * b) / 60),
                          (y = x));
                        var B = v[M].elem;
                        (i = (T = this.addElementToEvents(
                          o,
                          B,
                          p,
                          v[M].top,
                      ...
                      o["event" + N] && (o["event" + N].endX = v[g].elem.x),
                        (l = !0),
                        (g = -1);
                    }
                    A && (g = w), E && (m = w);
              ...
              return (
                (function (e) {
                  for (var t, r, n, a, i = e.length - 1; i >= 0; i--) {
                    var s = e[i];
                    "bar" === s.type
                      ? ((s.top = n),
                        (s.nextTop = t),
                    ...
                    for (var n = 0; n < r.length - 1; n++) {
                      ...
                      if (null !== a.left) {
                        var s =
                          i && a.top === i.top
                            ? i.left
                            : e[a.line].staffGroup.w;
                        void 0 !== a.endX
                          ? s > a.left && (a.endX = Math.min(a.endX, s))
                          : (a.endX = s);
                      }
                    }
                    var o = r[r.length - 1];
                ...
                this.addUsefulCallbackInfo(s, b * a),
                s
              );
            }),
            (this.addUsefulCallbackInfo = function (e, t) {
              for (
                var r = this.millisecondsPerMeasure(t), n = 0;
                n < e.length;
                n++
              )
                e[n].millisecondsPerMeasure = r;
            }),
            (this.getBpm = function (e) {
              ...
              if (e) {
                ...
                t =
                  (t *
                    (e.duration && e.duration.length > 0 ? e.duration[0] : r)) /
                  r;
              }
              if (!t) {
                t = 180;
            ...
            (this.setTiming = function (e, t) {
              ...
              var i = this.getBeatLength(),
                s = e / 60,
                o = ((this.getBarLength() / i) * t) / s;
              o && (o -= this.getPickupLength() / i / s);
              var c = i * s;
              return (
                (this.noteTimings = this.setupEvents(o, c, e, a)),
                this.noteTimings.length > 0
                  ? ((this.totalTime =
                      this.noteTimings[this.noteTimings.length - 1]
                        .milliseconds / 1e3),
            ...
            (this.setUpAudio = function (e) {
              e || (e = {});
              var t = i(this, e);
              return s(t, e, this.formatting.percmap);
            }),
      ...
      351: function (e) {
        ...
        function o(e) {
          for (var t = {}, r = Object.keys(e), n = 0; n < r.length; n++)
            if ("staff" !== r[n]) t[r[n]] = e[r[n]];
              ...
              t.staff = [];
              for (var a = 0; a < e.staff.length; a++) {
                for (
                  var i = {}, s = Object.keys(e.staff[a]), o = 0;
                  o < s.length;
                  o++
                )
                  if ("voices" !== s[o]) i[s[o]] = e.staff[a][s[o]];
                  else {
                    i.voices = [];
                    for (var c = 0; c < e.staff[a].voices.length; c++)
                      i.voices.push([].concat(e.staff[a].voices[c]));
                  }
                t.staff.push(i);
              }
            }
        ...
        e.exports = function (e, t) {
          ...
          for (
            ...
            if (y.staff) {
              if (h && !y.vskip)
                for (var w = l[l.length - 1], x = 0; x < w.staff.length; x++) {
                  var k = y.staff[x],
                    C = w.staff[x];
                  if (
                    (k &&
                      (s(k.meter, u[x]) ||
                        ...
                        delete k.meter),
                      s(k.key, d[x]) ||
                        (n(k.key, k.voices), (d[x] = k.key), delete k.key),
                      k.title && (C.abbrevTitle = k.title),
                      s(k.clef, f[x]) ||
                        (a(k.clef, k.voices), (f[x] = k.clef), delete k.clef),
                      s(k.vocalfont, p[x]) ||
                        (i(k.vocalfont, k.voices, "vocalfont"),
                        (p[x] = k.vocalfont),
                        delete k.vocalfont),
                      s(k.gchordfont, m[x]) ||
                        (i(k.gchordfont, k.voices, "gchordfont"),
                        (m[x] = k.gchordfont),
                        delete k.gchordfont),
                      s(k.tripletfont, g[x]) ||
                        (i(k.tripletfont, k.voices, "tripletfont"),
                        (g[x] = k.tripletfont),
                        delete k.tripletfont),
                      s(k.annotationfont, v[x]) ||
                        (i(k.annotationfont, k.voices, "annotationfont"),
                        (v[x] = k.annotationfont),
                    ...
                    for (var T = 0; T < C.voices.length; T++) {
                      var S = C.voices[T],
                        _ = k.voices[T];
                      c && S.push({ el_type: "break" }),
                        _ && (C.voices[T] = S.concat(_));
                    }
                }
              else {
                for (var A = 0; A < y.staff.length; A++)
                  (d[A] = y.staff[A].key),
                    (u[A] = y.staff[A].meter),
                    (f[A] = y.staff[A].clef);
                l.push(o(y));
          ...
          c = function (e, t) {
            (this.abcjsParams = (function (e) {
              var t,
                r = {};
              if (e.abcjsParams)
                for (t in e.abcjsParams)
                  e.abcjsParams.hasOwnProperty(t) && (r[t] = e.abcjsParams[t]);
              if (e.midi_options)
                for (t in e.midi_options)
                  e.midi_options.hasOwnProperty(t) &&
                    (r[t] = e.midi_options[t]);
              if (e.parser_options)
                for (t in e.parser_options)
                  e.parser_options.hasOwnProperty(t) &&
                    (r[t] = e.parser_options[t]);
              if (e.render_options)
                for (t in e.render_options)
                  e.render_options.hasOwnProperty(t) &&
                    (r[t] = e.render_options[t]);
              return (
                r.tablature &&
                  e.warnings_id &&
                  (r.tablature.warnings_id = e.warnings_id),
                r
              );
            })(t)),
                ...
                : ((this.div = document.createElement("DIV")),
                  this.editarea
                    ...
                    .parentNode.insertBefore(
                      this.div,
                      this.editarea.getElem()
                    )),
              "string" == typeof this.div &&
        ...
        (c.prototype.redrawMidi = function () {
          ...
          (c.prototype.synthParamChanged = function (e) {
            if (this.synth) {
              if (((this.synth.options = {}), e))
                for (var t in e)
                  e.hasOwnProperty(t) && (this.synth.options[t] = e[t]);
              (this.currentAbc = ""), this.fireChanged();
            }
          }),
          ...
          (c.prototype.fireChanged = function () {
            if (!this.bIsPaused && this.parseABC()) {
              ...
              var t = this.isDirty();
              this.wasDirty !== t &&
                ((this.wasDirty = t), this.setDirtyStyle(t)),
          ...
          (c.prototype.highlight = function (e, t, r, n, a, i) {
            this.editarea.setSelection(e.startChar, e.endChar),
              ...
              this.clientClickListener &&
                this.clientClickListener(e, t, r, n, a, i);
          }),
          ...
          function e(e, t, r) {
            ...
            for (var i = 0, s = 0; s < n.length; s++) {
              ...
              for (var l = 0; l < o.length; l++) {
                var h = o[l];
                h.volume
                  ? e.startNote(h.pitch, h.volume, h.cents)
                  : e.endNote(h.pitch);
              }
            }
          }
          n = function (t, r) {
            ...
            for (var h = 0; h < n.tracks.length; h++) {
              ...
              for (var u = {}, d = 0; d < n.tracks[h].length; d++) {
                ...
                switch (f.cmd) {
                  case "text":
                    i.setText(f.type, f.text);
                    break;
                  case "program":
                    var p = 0;
                    r.pan && r.pan.length > h && (p = r.pan[h]),
                      i.setChannel(f.channel, p),
                      i.setInstrument(f.instrument);
                    break;
                  case "note":
                    var m = f.gap * l,
                      g = f.start,
      ...
      5008: function (e) {
        var t = {
          ...
          each: function (e, t, r) {
            for (var n = 0, a = e.length; n < a; n++) t.apply(r, [e[n], n]);
          },
          last: function (e) {
        ...
        e.exports = function () {
              ...
              addFormattingOptions: function (e, t, r) {
                "note" === r
                  ? ("auto" !== this.vocalPosition &&
                      f(e, "vocalPosition", this.vocalPosition),
                    "auto" !== this.dynamicPosition &&
                      f(e, "dynamicPosition", this.dynamicPosition),
                    "auto" !== this.chordPosition &&
                      f(e, "chordPosition", this.chordPosition),
                    "auto" !== this.ornamentPosition &&
                      f(e, "ornamentPosition", this.ornamentPosition),
                    "auto" !== this.volumePosition &&
                      f(e, "volumePosition", this.volumePosition),
                    this.differentFont("annotationfont", t) &&
                      p(e, "annotationfont", this.annotationfont),
                    this.differentFont("gchordfont", t) &&
                      p(e, "gchordfont", this.gchordfont),
                    this.differentFont("vocalfont", t) &&
                      p(e, "vocalfont", this.vocalfont),
                    this.differentFont("tripletfont", t) &&
                      p(e, "tripletfont", this.tripletfont))
                  : "bar" === r &&
                    ("auto" !== this.dynamicPosition &&
                      f(e, "dynamicPosition", this.dynamicPosition),
                    "auto" !== this.chordPosition &&
                    ...
                    this.differentFont("measurefont", t) &&
                      p(e, "measurefont", this.measurefont),
                    this.differentFont("repeatfont", t) &&
                      p(e, "repeatfont", this.repeatfont));
              },
              duplicateStartEndingHoldOvers: function () {
                ...
                for (var e = 0; e < this.inTie.length; e++)
                  if ((this.endingHoldOver.inTie.push([]), this.inTie[e]))
                    for (var t = 0; t < this.inTie[e].length; t++)
                      this.endingHoldOver.inTie[e].push(this.inTie[e][t]);
                for (var r in this.inTieChord)
                  this.inTieChord.hasOwnProperty(r) &&
                    (this.endingHoldOver.inTieChord[r] = this.inTieChord[r]);
              },
              restoreStartEndingHoldOvers: function () {
                if (this.endingHoldOver.inTie) {
                  ...
                  for (var e = 0; e < this.endingHoldOver.inTie.length; e++) {
                    ...
                    for (
                      var t = 0;
                      t < this.endingHoldOver.inTie[e].length;
                      t++
                    )
          ...
          var w = function (t, r) {
              if (r.indexOf("") >= 0) u += r;
                ...
                "-" !== (r = n.strip(r)).charAt(r.length - 1) && (r += " ");
                for (
                  var a = [],
                    i = 0,
                    s = !1,
                    o = function (t) {
                      var o = n.strip(r.substring(i, t));
                      if (
                        ((o = o.replace(/\\([-_*|~])/g, "$1")),
                        (i = t + 1),
                        o.length > 0)
                  ...
                  switch (r[l]) {
                    ...
                    case "-":
                      ...
                      break;
                    case "_":
                      c || (o(l), a.push({ skip: !0, to: "slur" }));
                      break;
                    case "*":
                      c || (o(l), a.push({ skip: !0, to: "next" }));
                      break;
                    case "|":
                      c || (o(l), a.push({ skip: !0, to: "bar" }));
                      break;
                    case "~":
                      c || (s = !0);
                  }
            ...
            x = function (t, r) {
              if (r.indexOf("") >= 0) d += r;
                ...
                for (
                  ...
                  switch (r.charAt(c)) {
                    ...
                    case "-":
                      ...
                      break;
                    case "_":
                      o(c), a.push({ skip: !0, to: "slur" });
                      break;
                    case "*":
                      o(c), a.push({ skip: !0, to: "next" });
                      break;
                    case "|":
                      o(c), a.push({ skip: !0, to: "bar" });
                      break;
                    case "~":
                      s = !0;
                  }
                ...
                y("Can't add symbols before the first line of music", t, 0);
            },
            k = function (e) {
              if (n.startsWith(e, "%%")) {
                var t = a.addDirective(e.substring(2));
                t && y(t, e, 2);
              } else {
                var i = e.indexOf("%");
                if (
                  ...
                  if (u) w(r.getCurrentVoice(), e.substring(2));
                  else if (d) x(r.getCurrentVoice(), e.substring(2));
                  else if (
                    e.length < 2 ||
                    ":" !== e.charAt(1) ||
                    g.lineContinuation
                    ...
                    s.regular && g.parseMusic(e),
                      ...
                      s.words && w(r.getCurrentVoice(), e.substring(2)),
                      s.symbols && x(r.getCurrentVoice(), e.substring(2));
                  }
              }
            };
          function C(e, t) {
            ...
            for (var r = 0; r < t.length; r++) {
              var a = t[r],
                i = n.clone(a);
              if ((e.push(i), "bar" === a.el_type)) return;
            }
          }
          function T(e, t) {
          ...
          this.parse = function (l, h, f) {
              ...
              h.visualTranspose
                ? ((v.globalTranspose = parseInt(h.visualTranspose)),
                  0 === v.globalTranspose
                    ...
                    : r.setVisualTranspose(h.visualTranspose))
                : (v.globalTranspose = void 0),
              h.lineBreaks && (v.lineBreaks = h.lineBreaks),
              m.reset(e, y, v, t);
            try {
              h.format && a.globalFormatting(h.format);
              for (var S = e.nextLine(); S; ) {
                if (h.header_only && !1 === v.is_in_header)
                  throw "normal_abort";
                if (h.stop_on_warning && v.warnings) throw "normal_abort";
                var _ = v.is_in_header;
                k(S),
                  _ &&
                    !v.is_in_header &&
              ...
              u && w(r.getCurrentVoice(), ""),
                d && x(r.getCurrentVoice(), ""),
                (v.openSlurs = r.cleanUp(
                  v.barsperstaff,
                  v.staffnonote,
                  v.openSlurs
                ));
            ...
            t.formatting.pagewidth || (t.formatting.pagewidth = E),
              t.formatting.pageheight || (t.formatting.pageheight = A),
              h.hint_measures &&
                (function () {
                  for (var e = 0; e < t.lines.length; e++) {
                    ...
                    if (r) {
                      for (
                        var n = e + 1;
                        n < t.lines.length && void 0 === t.lines[n].staff;
      ...
      9565: function (e, t, r) {
        ...
        e.exports = function (e) {
          ...
          if (
            ...
            o.length > 1 && !n.startsWith(o[0].abc, "X:"))
          ) {
            var c = o.shift().abc.split("\n");
            n.each(c, function (e) {
              n.startsWith(e, "%%") && (t += e + "\n");
            });
          }
          ...
          return (
            n.each(o, function (e) {
              var r = e.abc.indexOf("\n\n");
              r > 0 && (e.abc = e.abc.substring(0, r)),
                (e.pure = e.abc),
                (e.abc = t + e.abc),
                (e.title = "");
              var a = e.pure.split("T:");
              a.length > 1 &&
                ((a = a[1].split("\n")), (e.title = n.strip(a[0])));
              var i = e.pure.substring(2, e.pure.indexOf("\n"));
              e.id = n.strip(i);
            }),
            { header: l, tunes: o }
          );
      ...
      8360: function (e, t, r) {
        ...
        !(function () {
          "use strict";
          var e, t, r, i, s;
          a.initialize = function (n, a, o, c, l) {
            (e = n),
              (t = a),
              (i = c),
              (s = l),
              ...
              (i.formatting.annotationfont = r.annotationfont),
              (i.formatting.gchordfont = r.gchordfont),
              (i.formatting.historyfont = r.historyfont),
              (i.formatting.infofont = r.infofont),
              (i.formatting.measurefont = r.measurefont),
              (i.formatting.partsfont = r.partsfont),
              (i.formatting.repeatfont = r.repeatfont),
              (i.formatting.textfont = r.textfont),
              (i.formatting.tripletfont = r.tripletfont),
              (i.formatting.vocalfont = r.vocalfont),
              (i.formatting.wordsfont = r.wordsfont);
          };
          var o = {
              gchordfont: !0,
              measurefont: !0,
            ...
            c = function (e, r, n, a, i) {
                ...
                return (
                  ...
                  r
                    ? 0 === e.length
                      ...
                      : (t("Extra parameters in font definition.", n, a),
                        {
                          face: r.face,
                          weight: r.weight,
                          style: r.style,
              ...
              if ("*" === e[0].token) {
                ...
                t("Expected font size number after *.", n, a);
              }
                ...
                switch (p) {
                  case "face":
                    ...
                    ("utf" !== v &&
                      ...
                      ? l.length > 0 && "-" === g.token
                        ? ((m = !0),
                          (l[l.length - 1] = l[l.length - 1] + g.token))
                        : m
                        ? ((m = !1),
                          (l[l.length - 1] = l[l.length - 1] + g.token))
                        : l.push(g.token)
                      ...
                      ? (o[i]
                          ? (f = !0)
                          : t('This font style doesn\'t support "box"', n, a),
                        (p = "finished"))
                      : "utf" === v
                      ? ((g = e.shift()), (p = "size"))
                      : t(
                  ...
                  case "size":
                    "number" === g.type
                      ? c
                        ...
                        : (c = g.token)
                      : t("Expected font size in font definition.", n, a),
                      (p = "modifier");
                    break;
                  case "modifier":
                    "bold" === v
            ...
            l = function (e, t, n) {
              return 0 === t.length
                ...
                : ((r[e] = c(t, r[e], n, 0, e)),
                  r.is_in_header && (i.formatting[e] = r[e]),
                  null);
            },
            h = function (e, t) {
              var r = "";
              ...
              if (isNaN(a) || 0 === a)
                return (
                  'Directive "' + e + '" requires a number as a parameter.'
                );
              i.formatting.scale = a;
            },
            u = [
              "acoustic-bass-drum",
              "bass-drum-1",
            ...
            d = function (e, t, n, a, i) {
              if (1 !== n.length || "number" !== n[0].type)
                return (
                  'Directive "' + t + '" requires a number as a parameter.'
                );
              var s = n[0].intt;
              return void 0 !== a && s < a
                ? 'Directive "' +
            ...
            f = function (e, t, n) {
              if (
                1 === n.length &&
                ("true" === n[0].token || "false" === n[0].token)
              )
            ...
            p = function (e, t, n, a) {
              ...
              for (var i = n[0].token, s = !1, o = 0; !s && o < a.length; o++)
                a[o] === i && (s = !0);
              return s
                ? ((r[e] = i), null)
                : 'Directive "' +
          ...
          a.parseFontChangeLine = function (e) {
            ...
            if (t.length > 1 && r.setfont) {
              for (var n = [{ text: t[0] }], a = 1; a < t.length; a++)
                "0" === t[a].charAt(0)
                  ? n.push({ text: t[a].substring(1) })
                  : "1" === t[a].charAt(0) && r.setfont[1]
                  ? n.push({ font: r.setfont[1], text: t[a].substring(1) })
                  : "2" === t[a].charAt(0) && r.setfont[2]
                  ? n.push({ font: r.setfont[2], text: t[a].substring(1) })
                  : "3" === t[a].charAt(0) && r.setfont[3]
                  ? n.push({ font: r.setfont[3], text: t[a].substring(1) })
                  : "4" === t[a].charAt(0) && r.setfont[4]
                  ? n.push({ font: r.setfont[4], text: t[a].substring(1) })
                  : (n[n.length - 1].text += "$" + t[a]);
          ...
          function _(e) {
            ...
            if (1 === e.length)
              if ("number" === e[0].type) {
                if (e[0].floatt >= 0 || e[0].floatt <= 1)
                  return { value: e[0].floatt };
              } else {
          ...
          (a.addDirective = function (o) {
            var A = e.tokenize(o, 0, o.length);
            if (0 === A.length || "alpha" !== A[0].type) return null;
            var E = o.substring(o.indexOf(A[0].token) + A[0].token.length);
            E = e.stripComment(E);
            var N,
              M = A.shift().token.toLowerCase(),
              B = "";
            switch (M) {
              case "bagpipes":
                i.formatting.bagpipes = !0;
                break;
              case "flatbeams":
                i.formatting.flatbeams = !0;
                break;
              case "jazzchords":
                i.formatting.jazzchords = !0;
                break;
              case "landscape":
                r.landscape = !0;
                break;
              ...
              case "graceslurs":
                ...
                if ("0" === A[0].token || "false" === A[0].token)
                  i.formatting.graceSlurs = !1;
                else {
                  if ("1" !== A[0].token && "true" !== A[0].token)
                    return (
                      "Directive graceslurs requires one parameter: 0 or 1 (received " +
                      A[0].token +
                      ")"
                    );
                  i.formatting.graceSlurs = !0;
                }
                break;
              case "stretchlast":
                var P = _(A);
                if (
                  (void 0 !== P.value && (i.formatting.stretchlast = P.value),
                  P.error)
                )
                  return P.error;
                break;
              case "titlecaps":
                ...
                break;
              case "titleleft":
                i.formatting.titleleft = !0;
                break;
              case "measurebox":
                i.formatting.measurebox = !0;
                break;
              case "vocal":
                return p("vocalPosition", M, A, S);
              case "dynamic":
                return p("dynamicPosition", M, A, S);
              case "gchord":
                return p("chordPosition", M, A, S);
              case "ornament":
                return p("ornamentPosition", M, A, S);
              case "volume":
                return p("volumePosition", M, A, S);
              case "botmargin":
              case "botspace":
              case "composerspace":
              case "indent":
              ...
              case "wordsspace":
                return (function (t, r) {
                  ...
                  return 0 === n.used || 0 !== r.length
                    ...
                    : ((i.formatting[t] = n.value), null);
                })(M, A);
              case "voicescale":
                if (1 !== A.length || "number" !== A[0].type)
                  return "voicescale requires one float as a parameter";
                var L = A.shift();
                return (
                  r.currentVoice &&
                    ((r.currentVoice.scale = L.floatt),
                    s.changeVoiceScale(r.currentVoice.scale)),
                  null
                );
              case "vskip":
                var H = Math.round(
                ...
                return H.error ? H.error : (s.addSpacing(H), null);
              case "scale":
                h(M, A);
                break;
              case "sep":
                if (0 === A.length)
                  s.addSeparator(14, 14, 85, {
                    startChar: r.iChar,
                    endChar: r.iChar + 5,
                  });
                else {
                  var O = e.getMeasurement(A);
                  if (0 === O.used)
                    return (
                      'Directive "' +
                      M +
                  ...
                  var z = O.value;
                  if (0 === (O = e.getMeasurement(A)).used)
                    return (
                      'Directive "' +
                      M +
                      '" requires 3 numbers: space above, space below, length of line'
                  ...
                  var F = O.value;
                  if (0 === (O = e.getMeasurement(A)).used || 0 !== A.length)
                    return (
                      'Directive "' +
                      M +
                      '" requires 3 numbers: space above, space below, length of line'
                  ...
                  var D = O.value;
                  s.addSeparator(z, F, D, {
                    startChar: r.iChar,
                    endChar: r.iChar + E.length,
                  });
                }
                break;
              case "barsperstaff":
                if (null !== (B = d("barsperstaff", M, A))) return B;
                break;
              case "staffnonote":
                if (1 !== A.length)
                ...
                break;
              case "printtempo":
                if (null !== (B = f("printTempo", M, A))) return B;
                break;
              case "partsbox":
                if (null !== (B = f("partsBox", M, A))) return B;
                r.partsfont.box = r.partsBox;
                break;
              case "freegchord":
                if (null !== (B = f("freegchord", M, A))) return B;
                break;
              case "measurenb":
              case "barnumbers":
                if (null !== (B = d("barNumbers", M, A))) return B;
                break;
              case "setbarnb":
                if (1 !== A.length || "number" !== A[0].type)
                  return "Directive setbarnb requires a number as a parameter.";
                r.currBarNumber = s.setBarNumberImmediate(A[0].intt);
                break;
              case "begintext":
                var I = "";
              ...
              case "continueall":
                ...
                break;
              case "beginps":
                for (N = e.nextLine(); N && 0 !== N.indexOf("%%endps"); )
                  e.nextLine();
                t("Postscript ignored", o, 0);
                break;
              case "deco":
                E.length > 0 &&
                  r.ignoredDecorations.push(E.substring(0, E.indexOf(" "))),
                  t("Decoration redefinition ignored", o, 0);
                break;
              case "text":
                var j = e.translateString(E);
                s.addText(a.parseFontChangeLine(j), {
                  startChar: r.iChar,
                  endChar: r.iChar + E.length + 7,
                });
                break;
              case "center":
                var V = e.translateString(E);
                s.addCentered(a.parseFontChangeLine(V));
                break;
              case "font":
                break;
              case "setfont":
                var G = e.tokenize(E, 0, E.length);
                if (
                  G.length >= 4 &&
                  "-" === G[0].token &&
                  "number" === G[1].type
                ) {
                  var Y = parseInt(G[1].token);
                  Y >= 1 &&
                    Y <= 4 &&
                    (r.setfont || (r.setfont = []),
                    G.shift(),
                    G.shift(),
                    (r.setfont[Y] = c(G, r.setfont[Y], o, 0, "setfont")));
                }
                break;
              case "gchordfont":
              case "partsfont":
              ...
              case "headerfont":
                return (function (e, t, r) {
                  return 0 === t.length
                    ? 'Directive "' + e + '" requires a font as a parameter.'
                    : ((i.formatting[e] = c(t, i.formatting[e], r, 0, e)),
                      null);
                })(M, A, o);
              case "barlabelfont":
              case "barnumberfont":
              case "barnumfont":
                return l("measurefont", A, o);
              case "staves":
              case "score":
                r.score_is_present = !0;
                for (
                  var q,
                    W = function (e, t, a, i, s) {
                      (t || 0 === r.staves.length) &&
                        r.staves.push({ index: r.staves.length, numVoices: 0 });
                      var o = n.last(r.staves);
                      void 0 !== a && void 0 === o.bracket && (o.bracket = a),
                        void 0 !== i && void 0 === o.brace && (o.brace = i),
                    ...
                    Z = function () {
                      if (((J = !0), q)) {
                        ...
                        q.staffNum > 0 &&
                          (("start" !==
                            r.staves[q.staffNum - 1].connectBarLines &&
                            "continue" !==
                              r.staves[q.staffNum - 1].connectBarLines) ||
                            (e = "continue")),
                          (r.staves[q.staffNum].connectBarLines = e);
                      }
                    };
                  A.length;
                  ...
                  switch (ee.token) {
                    case "(":
                      R
                        ? t("Can't nest parenthesis in %%score", o, ee.start)
                        : ((R = !0), (K = !0));
                      break;
                    case ")":
                      !R || K
                    ...
                    case "[":
                      U
                        ? t("Can't nest brackets in %%score", o, ee.start)
                        : ((U = !0), (Q = !0));
                      break;
                    case "]":
                      !U || Q
                        ? t("Unexpected close bracket in %%score", o, ee.start)
                        : ((U = !1), (r.staves[q.staffNum].bracket = "end"));
                      break;
                    case "{":
                      X
                        ? t("Can't nest braces in %%score", o, ee.start)
                        : ((X = !0), ($ = !0));
                      break;
                    case "}":
                      !X || $
                        ? t("Unexpected close brace in %%score", o, ee.start)
                        : ((X = !1), (r.staves[q.staffNum].brace = "end"));
                      break;
                    case "|":
                      Z();
                      break;
                    default:
                      for (
                        var te = "";
                        ("alpha" === ee.type || "number" === ee.type) &&
                        ((te += ee.token), ee.continueId);
                      ...
                      W(
                        te,
                        !R || K,
                        Q ? "start" : U ? "continue" : void 0,
                        $ ? "start" : X ? "continue" : void 0,
                        J
                      ),
                        (K = !1),
                        (Q = !1),
              ...
              case "newpage":
                var re = e.getInt(E);
                s.addNewPage(0 === re.digits ? -1 : re.value);
                break;
              case "abc":
                var ne = E.split(" ");
                switch (ne[0]) {
                  ...
                  case "-charset":
                    var ae = ne.shift();
                    s.addMetaText(M + ae, ne.join(" "), {
                      startChar: r.iChar,
                      endChar: r.iChar + E.length + 5,
                    });
                    break;
                  default:
                    return "Unknown directive: " + M + ne[0];
                }
                break;
              case "header":
              case "footer":
                var ie = e.getMeat(E, 0, E.length);
                '"' === (ie = E.substring(ie.start, ie.end)).charAt(0) &&
                ...
                (oe =
                  1 === se.length
                    ? { left: "", center: se[0], right: "" }
                    : 2 === se.length
                    ? { left: se[0], center: se[1], right: "" }
                    : { left: se[0], center: se[1], right: se[2] }),
                  se.length > 3 &&
                    t(
                      "Too many tabs in " + M + ": " + se.length + " found.",
                      E,
                      0
                    ),
                  s.addMetaTextObj(M, oe, {
                    startChar: r.iChar,
                    endChar: r.iChar + o.length,
                  });
                break;
              case "midi":
                var ce = e.tokenize(E, 0, E.length, !0);
                ce.length > 0 && "=" === ce[0].token && ce.shift(),
                  0 === ce.length
                    ? t("Expected midi command", E, 0)
                    : (function (e, r, n) {
                        var a = e.shift().token,
                          i = [];
                        if (m.indexOf(a) >= 0)
                          0 !== e.length &&
                            t("Unexpected parameter in MIDI " + a, n, 0);
                        else if (g.indexOf(a) >= 0)
                          1 !== e.length
                            ? t("Expected one parameter in MIDI " + a, n, 0)
                            : i.push(e[0].token);
                          ...
                          1 !== e.length
                            ...
                            : "number" !== e[0].type
                            ? t(
                                "Expected one integer parameter in MIDI " + a,
                                n,
                                0
                              )
                            : i.push(e[0].intt);
                          ...
                          1 !== e.length && 2 !== e.length
                            ? t(
                                "Expected one or two parameters in MIDI " + a,
                                n,
                                0
                              )
                            : "number" !== e[0].type ||
                              (2 === e.length && "number" !== e[1].type)
                            ? t("Expected integer parameter in MIDI " + a, n, 0)
                            : (i.push(e[0].intt),
                              2 === e.length && i.push(e[1].intt));
                        else if (y.indexOf(a) >= 0)
                          2 !== e.length
                            ? t("Expected two parameters in MIDI " + a, n, 0)
                            ...
                            : (i.push(e[0].intt), i.push(e[1].intt));
                          ...
                          2 !== e.length
                            ...
                            : (i.push(e[0].token), i.push(e[1].intt));
                        else if ("drummap" === a)
                          2 === e.length &&
                          "alpha" === e[0].type &&
                          "number" === e[1].type
                            ? (r.formatting || (r.formatting = {}),
                              ...
                              r.formatting.midi.drummap ||
                                (r.formatting.midi.drummap = {}),
                              (r.formatting.midi.drummap[e[0].token] =
                                e[1].intt),
                              (i = r.formatting.midi.drummap))
                            : 3 === e.length &&
                              "punct" === e[0].type &&
                              "alpha" === e[1].type &&
                              "number" === e[2].type
                        ...
                        else if (C.indexOf(a) >= 0)
                          3 !== e.length ||
                          "number" !== e[0].type ||
                          "/" !== e[1].token ||
                          "number" !== e[2].type
                            ? t(
                                "Expected fraction parameter in MIDI " + a,
                                n,
                                0
                              )
                            : (i.push(e[0].intt), i.push(e[2].intt));
                        else if (w.indexOf(a) >= 0)
                          4 !== e.length
                            ? t("Expected four parameters in MIDI " + a, n, 0)
                            : "number" !== e[0].type ||
                              "number" !== e[1].type ||
                              "number" !== e[2].type ||
                              "number" !== e[3].type
                          ...
                          5 !== e.length
                            ? t("Expected five parameters in MIDI " + a, n, 0)
                            : "number" !== e[0].type ||
                              "number" !== e[1].type ||
                              "number" !== e[2].type ||
                              "number" !== e[3].type ||
                          ...
                          1 !== e.length || 4 !== e.length
                            ...
                            ? ("octave" !== e[1].token &&
                                t(
                                  "Expected octave parameter in MIDI " + a,
                                  n,
                                  0
                                ),
                              "=" !== e[2].token &&
                          ...
                          if (e.length < 2)
                            ...
                            var o = e.shift();
                            for (i.push(o.token); e.length > 0; )
                              "number" !== (o = e.shift()).type &&
                                t(
                                  "Expected integer parameter in MIDI " + a,
                                  n,
                                  0
                                ),
                                i.push(o.intt);
                        ...
                        s.hasBeginMusic()
                          ? s.appendElement("midi", -1, -1, {
                              cmd: a,
                              params: i,
                            })
                          : (void 0 === r.formatting.midi &&
                              (r.formatting.midi = {}),
                            (r.formatting.midi[a] = i));
                      })(ce, i, E);
                break;
              case "percmap":
                var le = (function (e) {
                  ...
                  if (
                    ((isNaN(n) || n < 35 || n > 81) &&
                      t[1] &&
                      (n = u.indexOf(t[1].toLowerCase()) + 35),
                    isNaN(n) || n < 35 || n > 81)
                  )
                    return {
                      error: 'Expected drum name, received "' + t[1] + '"',
                    };
                  var a = { sound: n };
                  return (
                    3 === t.length && (a.noteHead = t[2]), { key: r, value: a }
                  );
                })(E);
                le.error
                  ? t(le.error, o, 8)
                  : (i.formatting.percmap || (i.formatting.percmap = {}),
                    (i.formatting.percmap[le.key] = le.value));
                break;
              case "map":
              case "playtempo":
              case "auquality":
              ...
              case "nobarcheck":
                ...
                break;
              default:
                return "Unknown directive: " + M;
            }
            return null;
          }),
            (a.globalFormatting = function (n) {
              for (var a in n)
                if (n.hasOwnProperty(a)) {
                  ...
                  switch (a) {
                    ...
                    case "scale":
                      ...
                      break;
                    case "partsbox":
                      null !== (s = f("partsBox", a, c)) && t(s),
                        (r.partsfont.box = r.partsBox);
                      break;
                    case "freegchord":
                      null !== (s = f("freegchord", a, c)) && t(s);
                      break;
                    case "fontboxpadding":
                      (1 === c.length && "number" === c[0].type) ||
                        ...
                        (i.formatting.fontboxpadding = c[0].floatt);
                      break;
                    case "stretchlast":
                      var u = _(c);
                      if (
                        (void 0 !== u.value &&
                          (i.formatting.stretchlast = u.value),
                        u.error)
                      )
                        return u.error;
                      break;
      ...
      9928: function (e, t, r) {
        ...
        e.exports = function (e, t, r, s, o) {
          (this.reset = function (e, t, r, n) {
            i.initialize(e, t, r, n, o), a.initialize(e, t, r, n, o);
          }),
            this.reset(e, t, r, s),
            ...
            (this.setMeter = function (n) {
              ...
              try {
                ...
                return (
                  !0 === r.havent_set_length &&
                    ((r.default_length = o < 0.75 ? 0.0625 : 0.125),
            ...
            (this.calcTempo = function (e) {
              ...
              r.meter && "specified" === r.meter.type
                ...
                : r.origMeter &&
                  "specified" === r.origMeter.type &&
                  (t = 1 / parseInt(r.origMeter.value[0].den));
            ...
            (this.resolveTempo = function () {
              r.tempo &&
                ...
                (s.metaText.tempo = r.tempo),
                delete r.tempo);
            }),
            (this.addUserDefinition = function (e, a, i) {
              var s = e.indexOf("=", a);
              if (-1 !== s) {
                var o = n.strip(e.substring(a, s)),
                  c = n.strip(e.substring(s + 1));
                1 === o.length
                  ? -1 !== "HIJKLMNOPQRSTUVWXYhijklmnopqrstuvw~".indexOf(o)
                    ? 0 !== c.length
                      ? (void 0 === r.macros && (r.macros = {}),
                        (r.macros[o] = c))
                      : t("Missing macro definition", e, a)
                    : t("Macro definitions must be H-Y, h-w, or tilde", e, a)
                  : t("Macro definitions can only be one character", e, a);
              } else t("Need an = in a macro definition", e, a);
            }),
            (this.setDefaultLength = function (e, t, a) {
              var i = n.gsub(e.substring(t, a), " ", "").split("/");
              if (2 === i.length) {
                var s = parseInt(i[0]),
                  o = parseInt(i[1]);
                o > 0 &&
                  ((r.default_length = s / o), (r.havent_set_length = !1));
              } else
                1 === i.length &&
                  "1" === i[0] &&
          ...
          (this.setTempo = function (n, a, i, s) {
            try {
              var o = e.tokenize(n, a, i);
              if (0 === o.length) throw "Missing parameter in Q: field";
              var l = { startChar: s + a - 2, endChar: s + i },
                h = !0,
                u = o.shift();
              if (
                "quote" === u.type &&
                ((l.preString = u.token), (u = o.shift()), 0 === o.length)
              )
                return (
                  c[l.preString.toLowerCase()] &&
                    ((l.bpm = c[l.preString.toLowerCase()]),
                    (l.suppressBpm = !0)),
              ...
              if ("alpha" === u.type && "C" === u.token) {
                ...
                if (0 === o.length || "quote" === o[0].type)
                  (l.duration = [1]), (l.bpm = d);
                else {
                  if (
                    ((h = !1),
                    "punct" !== (u = o.shift()).type && "/" !== u.token)
                  )
                  ...
                  for (
                    l.duration = [d / f];
                    o.length > 0 && "=" !== o[0].token && "quote" !== o[0].type;
              ...
              if (
                0 !== o.length &&
                ("quote" === (u = o.shift()).type &&
                  ((l.postString = u.token), (u = o.shift())),
                0 !== o.length)
              )
                throw "Unexpected string at end of Q: field";
              return (
                !1 === r.printTempo && (l.suppress = !0),
                { type: h ? "delaySet" : "immediate", tempo: l }
              );
            } catch (e) {
              return t(e, n, a), { type: "none" };
            }
          }),
            (this.letter_to_inline_header = function (n, c, l) {
              ...
              if (
                ...
                switch (n.substring(c, c + 3)) {
                  case "[I:":
                    var p = a.addDirective(n.substring(c + 3, u));
                    return p && t(p, n, c), [u - c + 1 + h];
                  case "[M:":
                    var m = this.setMeter(n.substring(c + 3, u));
                    return (
                      o.hasBeginMusic() && m
                        ? o.appendStartingElement("meter", d, f, m)
                        : (r.meter = m),
                      [u - c + 1 + h]
                    );
                  case "[K:":
                    var g = i.parseKey(n.substring(c + 3, u), !0);
                    return (
                      g.foundClef &&
                        o.hasBeginMusic() &&
                        o.appendStartingElement("clef", d, f, r.clef),
                      g.foundKey &&
                        o.hasBeginMusic() &&
                        o.appendStartingElement(
                          "key",
                          d,
                          f,
                          i.fixKey(r.clef, r.key)
                        ),
                      [u - c + 1 + h]
                    );
                  case "[P:":
                    return (
                      l || s.lines.length <= s.lineNum
                        ? (r.partForNextLine = {
                            title: n.substring(c + 3, u),
                            startChar: d,
                            endChar: f,
                          })
                        : o.appendElement("part", d, f, {
                            title: n.substring(c + 3, u),
                          }),
                      [u - c + 1 + h]
                    );
                  ...
                  case "[Q:":
                    if (u > 0) {
                      ...
                      return (
                        ...
                        [u - c + 1 + h, n.charAt(c + 1), n.substring(c + 3, u)]
                      );
                    }
                    break;
                  case "[V:":
            ...
            (this.letter_to_body_header = function (e, s) {
              if (e.length >= s + 3)
                switch (e.substring(s, s + 2)) {
                  case "I:":
                    var c = a.addDirective(e.substring(s + 2));
                  ...
                  case "K:":
                    var h = i.parseKey(e.substring(s + 2), o.hasBeginMusic());
                    return (
                      h.foundClef &&
                        o.hasBeginMusic() &&
                        o.appendStartingElement(
                    ...
                    return (
                      o.hasBeginMusic() &&
                        o.appendElement(
                          ...
                          r.iChar + s,
                          r.iChar + e.length,
                          { title: e.substring(s + 2) }
                        ),
                      [e.length]
                    );
                  case "L:":
                    return (
                      this.setDefaultLength(e, s + 2, e.length), [e.length]
                    );
                  case "Q:":
                    var u = e.indexOf("", s + 2);
                    -1 === u && (u = e.length);
                    ...
                    return (
                      ...
                      [u, e.charAt(s), n.strip(e.substring(s + 2))]
                    );
                  case "V:":
                    return (
                      i.parseVoice(e, s + 2, e.length),
                      [e.length, e.charAt(s), n.strip(e.substring(s + 2))]
                    );
                }
              return [0];
            });
          ...
          this.parseHeader = function (n) {
                ...
                "unalignedWords" === c
                  ? o.addMetaTextArray(
                      ...
                      a.parseFontChangeLine(
                        e.translateString(e.stripComment(n.substring(2)))
                      ),
                      { startChar: r.iChar, endChar: r.iChar + n.length }
                    )
                  : o.addMetaText(
                      c,
                      e.translateString(e.stripComment(n.substring(2))),
            ...
            switch (n.charAt(0)) {
              case "H":
                for (
                  ...
                  e.nextLine(),
                    o.addMetaText(
                      "history",
                      e.translateString(e.stripComment(n)),
                      { startChar: r.iChar, endChar: r.iChar + n.length }
                    ),
                    (n = e.peekLine());
                break;
              case "K":
                this.resolveTempo();
                var d = i.parseKey(n.substring(2), !1);
                !r.is_in_header &&
                  o.hasBeginMusic() &&
              ...
              case "Q":
                ...
                "delaySet" === f.type
                  ...
                  : "immediate" === f.type &&
                    (s.metaText.tempo
                      ? (r.tempoForNextLine = ["tempo", h, u, f.tempo])
                      : (s.metaText.tempo = f.tempo));
                break;
              case "T":
              ...
              case "U":
                ...
                break;
              case "V":
                if ((i.parseVoice(n, 2, n.length), !r.is_in_header))
                  return { newline: !0 };
                break;
              case "s":
                return { symbols: !0 };
      ...
      9708: function (e, t, r) {
        ...
        !(function () {
          var e, t, r, o;
          (s.initialize = function (n, a, i, s, c) {
            (e = n), (t = a), (r = i), (o = c);
          }),
            (s.standardKey = function (e, t, n, a) {
              return i.keySignature(r, e, t, n, a);
            });
          var c = {
          ...
          (s.fixClef = function (e) {
            ...
            (s.deepCopyKey = function (e) {
              ...
              return (
                n.each(e.accidentals, function (e) {
          ...
          (s.addPosToKey = function (e, t) {
            ...
            n.each(t.accidentals, function (e) {
              ...
              t.impliedNaturals &&
                n.each(t.impliedNaturals, function (e) {
                  var t = h[e.note];
                  (t -= r), (e.verticalPos = t);
                }),
              r < -10
          ...
          (s.parseKey = function (n, i) {
            0 === n.length && (n = "none");
            var o = e.tokenize(n, 0, n.length),
              c = {};
            if (0 === o.length)
              return t("Must pass in key signature.", n, 0), c;
            switch (o[0].token) {
              case "HP":
              ...
              default:
                ...
                if (h.len > 0) {
                  ...
                  var u = "",
                    d = "";
                  o[0].token.length > 1
                    ? (o[0].token = o[0].token.substring(1))
                    : o.shift();
                  var f = h.token;
                  if (o.length > 0) {
                  ...
                  var g,
                    ...
                    b = !i && r.globalTranspose ? -r.globalTranspose : 0;
                  if (
                    (i && (g = r.globalTransposeOrigKeySig),
                    (r.key = s.deepCopyKey(s.standardKey(f, h.token, u, b))),
                    i && (r.globalTransposeOrigKeySig = g),
                    (r.key.mode = d),
                    v)
                  ) {
                    for (var y, w = 0; w < r.key.accidentals.length; w++)
                      for (y = 0; y < v.accidentals.length; y++)
                        v.accidentals[y].note &&
                          r.key.accidentals[w].note.toLowerCase() ===
            ...
            if ((k.warn && t(k.warn, n, 0), k.accs)) {
              ...
              for (var C = 0; C < k.accs.length; C++) {
                for (var T = !1, S = 0; S < r.key.accidentals.length && !T; S++)
                  r.key.accidentals[S].note === k.accs[C].note &&
                    ((T = !0),
                    r.key.accidentals[S].acc !== k.accs[C].acc &&
                      ((r.key.accidentals[S].acc = k.accs[C].acc),
                      r.key.explicitAccidentals ||
                        (r.key.explicitAccidentals = []),
                ...
                if (
                  ...
                  for (var _ = 0; _ < r.key.impliedNaturals.length; _++)
                    r.key.impliedNaturals[_].note === k.accs[C].note &&
                      r.key.impliedNaturals.splice(_, 1);
              }
            }
            for (; o.length > 0; )
              switch (o[0].token) {
                case "m":
                case "middle":
                  if ((o.shift(), 0 === o.length))
                    return t("Expected = after middle", n, 0), c;
                  if ("=" !== (x = o.shift()).token) {
                    t("Expected = after middle", n, x.start);
                    break;
                  }
                  if (0 === o.length)
                    return t("Expected parameter after middle=", n, 0), c;
                  var A = e.getPitchFromTokens(o);
                  A.warn && t(A.warn, n, 0),
                    A.position && (r.clef.verticalPos = A.position - 6);
                  break;
                case "transpose":
                  if ((o.shift(), 0 === o.length))
                    return t("Expected = after transpose", n, 0), c;
                  if ("=" !== (x = o.shift()).token) {
                    t("Expected = after transpose", n, x.start);
                    break;
                  }
                  if (0 === o.length)
                    return t("Expected parameter after transpose=", n, 0), c;
                  if ("number" !== o[0].type) {
                ...
                case "stafflines":
                  if ((o.shift(), 0 === o.length))
                    return t("Expected = after stafflines", n, 0), c;
                  if ("=" !== (x = o.shift()).token) {
                    t("Expected = after stafflines", n, x.start);
                    break;
                  }
                  if (0 === o.length)
                    return t("Expected parameter after stafflines=", n, 0), c;
                  if ("number" !== o[0].type) {
                ...
                case "staffscale":
                  if ((o.shift(), 0 === o.length))
                    return t("Expected = after staffscale", n, 0), c;
                  if ("=" !== (x = o.shift()).token) {
                    t("Expected = after staffscale", n, x.start);
                    break;
                  }
                  if (0 === o.length)
                    return t("Expected parameter after staffscale=", n, 0), c;
                  if ("number" !== o[0].type) {
                ...
                case "style":
                  if ((o.shift(), 0 === o.length))
                    return t("Expected = after style", n, 0), c;
                  if ("=" !== (x = o.shift()).token) {
                    t("Expected = after style", n, x.start);
                    break;
                  }
                  if (0 === o.length)
                    return t("Expected parameter after style=", n, 0), c;
                  switch (o[0].token) {
                    case "normal":
                    case "harmonic":
                    case "rhythm":
                    ...
                    default:
                      t(
                        "error parsing style element: " + o[0].token,
                        n,
                        o[0].start
                      );
                  }
                ...
                case "clef":
                  if ((o.shift(), 0 === o.length))
                    return t("Expected = after clef", n, 0), c;
                  if ("=" !== (x = o.shift()).token) {
                    t("Expected = after clef", n, x.start);
                    break;
                  }
                  if (0 === o.length)
                    return t("Expected parameter after clef=", n, 0), c;
                case "treble":
                case "bass":
                case "alto":
                case "tenor":
                ...
                case "none":
                  ...
                  switch (E.token) {
                    ...
                    case "g":
                      ...
                      break;
                    default:
                      t("Expected clef name. Found " + E.token, n, E.start);
                  }
                  o.length > 0 &&
                    "number" === o[0].type &&
                    ((E.token += o[0].token), o.shift()),
                    o.length > 1 &&
                      ("-" === o[0].token ||
                        "+" === o[0].token ||
                        "^" === o[0].token ||
                        "_" === o[0].token) &&
                      "8" === o[1].token &&
                      ((E.token += o[0].token + o[1].token),
                      o.shift(),
                      o.shift()),
                    (r.clef = { type: E.token, verticalPos: l(E.token, 0) }),
                    r.currentVoice &&
                  ...
                  break;
                default:
                  t("Unknown parameter: " + o[0].token, n, o[0].start),
                    o.shift();
              }
            return c;
          }),
            (s.parseVoice = function (n, a, i) {
              var s = e.getMeat(n, a, i),
                c = s.start,
                h = s.end,
                d = e.getToken(n, c, h);
              if (0 !== d.length) {
                ...
                for (
                  var p = { startStaff: f },
                    m = function (r) {
                      ...
                      void 0 !== a.warn
                        ? t(
                            "Expected value for " + r + " in voice: " + a.warn,
                            n,
                            c
                          )
                        : void 0 !== a.err
                        ? t(
                            "Expected value for " + r + " in voice: " + a.err,
                            n,
                            c
                          )
                        : 0 === a.token.length && '"' !== n.charAt(c)
                    ...
                    g = function (a, i, s) {
                      ...
                      void 0 !== o.warn
                        ? t(
                            "Expected value for " + i + " in voice: " + o.warn,
                            n,
                            c
                          )
                        : void 0 !== o.err
                        ? t(
                            "Expected value for " + i + " in voice: " + o.err,
                            n,
                            c
                          )
                        : 0 === o.token.length && '"' !== n.charAt(c)
                        ? t("Expected value for " + i + " in voice", n, c)
                        : ("number" === s && (o.token = parseFloat(o.token)),
                          (r.voices[a][i] = o.token)),
                        (c += o.len);
                    },
                    v = function (r, a) {
                      ...
                      if (void 0 !== i.warn)
                        t(
                          "Expected value for " + r + " in voice: " + i.warn,
                          n,
                          c
                        );
                      else if (void 0 !== i.err)
                        t(
                          "Expected value for " + r + " in voice: " + i.err,
                          n,
                          c
                        );
                      else {
                        if (0 !== i.token.length || '"' === n.charAt(c))
                          return (
                            "number" === a && (i.token = parseFloat(i.token)),
                            i.token
                          );
                        t("Expected value for " + r + " in voice", n, c);
                      }
                    ...
                    b = function (a, i) {
                      ...
                      else if (0 === s.token.length && '"' !== n.charAt(c))
                        t(
                          "Expected one of (_B, _E, _b, _e) for " +
                            i +
                            " in voice",
                  ...
                  if (((c += y.len), y.warn))
                    t("Error parsing voice: " + y.warn, n, c);
                  else {
                    var w = null;
                    switch (y.token) {
                      case "clef":
                      case "cl":
                        ...
                        void 0 !== p.clef &&
                          ...
                          -1 !== p.clef.indexOf("+16") &&
                            ((x += 14), (p.clef = p.clef.replace("+16", ""))),
                          (p.verticalPos = l(p.clef, x)));
                        break;
                      case "treble":
                      case "bass":
                      case "tenor":
                      ...
                      case "stem":
                      case "stems":
                        void 0 !== (w = e.getVoiceToken(n, c, h)).warn
                          ? t(
                              "Expected value for stems in voice: " + w.warn,
                              n,
                              c
                            )
                          : void 0 !== w.err
                          ? t(
                              "Expected value for stems in voice: " + w.err,
                              n,
                              c
                            )
                      ...
                      case "m":
                        m("verticalPos"),
                          (p.verticalPos = u(p.verticalPos).mid);
                        break;
                      case "gchords":
                      case "gch":
                        (r.voices[d].suppressChords = !0),
                          "0" === (w = e.getVoiceToken(n, c, h)).token &&
                            (c += w.len);
                        break;
                      case "space":
                      case "spc":
                      ...
                      case "style":
                        void 0 !== (w = e.getVoiceToken(n, c, h)).warn
                          ? t(
                              "Expected value for style in voice: " + w.warn,
                              n,
                              c
                            )
                          : void 0 !== w.err
                          ? t(
                              "Expected value for style in voice: " + w.err,
                              n,
                              c
                            )
                          : "normal" === w.token ||
                ...
                if (
                  ((p.startStaff || 0 === r.staves.length) &&
                    ...
                    r.score_is_present ||
                      (r.staves[r.staves.length - 1].numVoices = 0)),
                  void 0 === r.voices[d].staffNum)
                ) {
                  r.voices[d].staffNum = r.staves.length - 1;
                  var C = 0;
                  for (var T in r.voices)
                    r.voices.hasOwnProperty(T) &&
                      r.voices[T].staffNum === r.voices[d].staffNum &&
                      C++;
                  r.voices[d].index = C - 1;
                }
                var S = r.staves[r.voices[d].staffNum];
                r.score_is_present || S.numVoices++,
                  p.clef &&
                    (S.clef = { type: p.clef, verticalPos: p.verticalPos }),
                  p.spacing && (S.spacing_below_offset = p.spacing),
                  p.verticalPos && (S.verticalPos = p.verticalPos),
                  p.name &&
                    (S.name ? S.name.push(p.name) : (S.name = [p.name])),
                  p.subname &&
                    (S.subname
                      ? S.subname.push(p.subname)
                      : (S.subname = [p.subname])),
                  (function (e) {
                    (r.currentVoice = r.voices[e]),
                      o.setCurrentVoice(
                        r.currentVoice.staffNum,
                        r.currentVoice.index
                      );
                  })(d);
      ...
      6476: function (e, t, r) {
        var n,
          ...
          f = function (e, t, r) {
            ...
            var n = e.currentVoice ? e.currentVoice.index : 0;
            return !(
              !e.inTie[t][n] ||
              (void 0 === r.pitches && "spacer" === r.rest.type)
            );
          },
          p = {};
        d.prototype.parseMusic = function (e) {
          c.resolveTempo(), (i.is_in_header = !1);
          for (
            var t = 0, r = i.iChar;
            n.isWhiteSpace(e.charAt(t)) && t < e.length;

          )
            t++;
          if (t !== e.length && "%" !== e.charAt(t)) {
            var h = i.start_new_line;
            void 0 === i.continueall
              ? (i.start_new_line = !0)
              : (i.start_new_line = !1);
            var u = 0,
              d = c.letter_to_body_header(e, t);
            d[0] > 0 && ((t += d[0]), "V" === d[1] && this.startNewLine());
            for (var w = 0; t < e.length; ) {
              var x = t;
              if ("%" === e.charAt(t)) break;
              var k = c.letter_to_inline_header(e, t, h);
              if (k[0] > 0) (t += k[0]), "V" === k[1] && (h = !0);
              else {
                var C;
                for (
                  (!o.hasBeginMusic() || (h && !this.lineContinuation)) &&
                  (this.startNewLine(), (h = !1));
                  ;

                )
                  if (
                    ((C = n.eatWhiteSpace(e, t)) > 0 && (t += C),
                    t > 0 &&
                      "" === e.charAt(t - 1) &&
                      (C = c.letter_to_body_header(e, t))[0] > 0 &&
                      ("V" === C[1] && this.startNewLine(),
                      (t = C[0]),
                      (i.start_new_line = !1)),
                    (C = _(e, t))[0] > 0 && (t += C[0]),
                    (C = g(e, t))[0] > 0)
                    ...
                    p.chord || (p.chord = []);
                    var T = n.translateString(C[1]);
                    T = T.replace(/;/g, "\n");
                    for (var E = !1, B = 0; B < p.chord.length; B++)
                      p.chord[B].position === C[2] &&
                        ((E = !0), (p.chord[B].name += "\n" + T));
                    !1 === E &&
                      (null === C[2] && C[3]
                        ? p.chord.push({ name: T, rel_position: C[3] })
                        : p.chord.push({ name: T, position: C[2] })),
                      (t += C[0]);
                    var P = n.skipWhiteSpace(e.substring(t));
                    P > 0 && (p.force_end_beam_last = !0), (t += P);
                  } else if (
                    (C =
                      -1 === "ABCDEFGabcdefgxyzZ[]|^_{".indexOf(e.charAt(t))
                        ? S(e, t)
                        : [0])[0] > 0
                  )
                    null === C[1]
                      ...
                      : C[1].length > 0 &&
                        (0 === C[1].indexOf("style=")
                          ? (p.style = C[1].substr(6))
                          : (void 0 === p.decoration && (p.decoration = []),
                            "beambr1" === C[1]
                              ? (p.beambr = 1)
                              : "beambr2" === C[1]
                              ? (p.beambr = 2)
                              : p.decoration.push(C[1]))),
                      (t += C[0]);
                  else {
                    if (!((C = v(e, t))[0] > 0)) break;
                    (p.gracenotes = C[1]), (t += C[0]);
                  }
                if ((C = A(e, t))[0] > 0) {
                  (w = 0),
                    void 0 !== p.gracenotes &&
                      ((p.rest = { type: "spacer" }),
                      (p.duration = 0.125),
                      i.addFormattingOptions(p, s.formatting, "note"),
                      o.appendElement("note", r + t, r + t + C[0], p),
                      (i.measureNotEmpty = !0),
                      (p = {}));
                  var L = { type: C[1] };
                  0 === L.type.length
                    ? a("Unknown bar type", e, t)
                    : (i.inEnding &&
                        "bar_thin" !== L.type &&
                        ((L.endEnding = !0), (i.inEnding = !1)),
                      C[2] &&
                        ((L.startEnding = C[2]),
                        i.inEnding && (L.endEnding = !0),
                        (i.inEnding = !0),
                        "bar_right_repeat" === C[1]
                          ? i.restoreStartEndingHoldOvers()
                          : i.duplicateStartEndingHoldOvers()),
                      void 0 !== p.decoration && (L.decoration = p.decoration),
                      void 0 !== p.chord && (L.chord = p.chord),
                      L.startEnding && void 0 === i.barFirstEndingNum
                        ? (i.barFirstEndingNum = i.currBarNumber)
                        : L.startEnding && L.endEnding && i.barFirstEndingNum
                        ? (i.currBarNumber = i.barFirstEndingNum)
                        : L.endEnding && (i.barFirstEndingNum = void 0),
                      "bar_invisible" !== L.type &&
                        i.measureNotEmpty &&
                        (void 0 === i.currentVoice ||
                          (0 === i.currentVoice.staffNum &&
                            0 === i.currentVoice.index)) &&
                        (i.currBarNumber++,
                        i.barNumbers &&
                          i.currBarNumber % i.barNumbers == 0 &&
                          (L.barNumber = i.currBarNumber)),
                      i.addFormattingOptions(p, s.formatting, "bar"),
                      o.appendElement("bar", r + x, r + t + C[0], L),
                      (i.measureNotEmpty = !1),
                      (p = {})),
                    (t += C[0]);
                } else if ("&" === e[t])
                  (C = b(e, t))[0] > 0 &&
                    (o.appendElement("overlay", r, r + 1, {}), (t += 1), w++);
                else {
                  if (
                    ((C = N(e, t)).consumed > 0 &&
                      (void 0 !== C.startSlur && (p.startSlur = C.startSlur),
                      C.dottedSlur && (p.dottedSlur = !0),
                      void 0 !== C.triplet &&
                        (u > 0
                          ? a("Can't nest triplets", e, t)
                          : ((p.startTriplet = C.triplet),
                            (p.tripletMultiplier = C.tripletQ / C.triplet),
                            (p.tripletR = C.num_notes),
                            (u =
                              void 0 === C.num_notes
                                ? C.triplet
                                : C.num_notes))),
                    ...
                    t++;
                    for (var z = null, F = !1, D = !1; !D; ) {
                      var I = S(e, t);
                      I[0] > 0 && (t += I[0]);
                      var j = H(e, t, {}, !1);
                      if (null !== j && void 0 !== j.pitch)
                        I[0] > 0 &&
                          0 !== I[1].indexOf("style=") &&
                          (void 0 === p.decoration && (p.decoration = []),
                          p.decoration.push(I[1])),
                          j.end_beam && ((p.end_beam = !0), delete j.end_beam),
                          void 0 === p.pitches
                            ? ((p.duration = j.duration), (p.pitches = [j]))
                            : p.pitches.push(j),
                          delete j.duration,
                          I[0] > 0 &&
                            0 === I[1].indexOf("style=") &&
                            (p.pitches[p.pitches.length - 1].style =
                              I[1].substr(6)),
                          i.inTieChord[p.pitches.length] &&
                            ((j.endTie = !0),
                            (i.inTieChord[p.pitches.length] = void 0)),
                          j.startTie && (i.inTieChord[p.pitches.length] = !0),
                          (t = j.endChar),
                          delete j.endChar;
                      else if (" " === e.charAt(t))
                        a("Spaces are not allowed in chords", e, t), t++;
                      else {
                        if (t < e.length && "]" === e.charAt(t)) {
                          t++,
                            0 !== i.next_note_duration &&
                              ((p.duration = p.duration * i.next_note_duration),
                              (i.next_note_duration = 0)),
                            f(i, w, p) &&
                              (l.each(p.pitches, function (e) {
                                e.endTie = !0;
                              }),
                              m(i, w, !1)),
                            u > 0 &&
                    ...
                    var q = {},
                      W = H(e, t, q, !0);
                    void 0 !== q.endTie && m(i, w, !0),
                      null !== W &&
                        (void 0 !== W.pitch
                          ? ((p.pitches = [{}]),
                            void 0 !== W.accidental &&
                              (p.pitches[0].accidental = W.accidental),
                            (p.pitches[0].pitch = W.pitch),
                            (p.pitches[0].name = W.name),
                            (W.midipitch || 0 === W.midipitch) &&
                              (p.pitches[0].midipitch = W.midipitch),
                            void 0 !== W.endSlur &&
                              (p.pitches[0].endSlur = W.endSlur),
                            void 0 !== W.endTie &&
                              (p.pitches[0].endTie = W.endTie),
                            void 0 !== W.startSlur &&
                              (p.pitches[0].startSlur = W.startSlur),
                            void 0 !== p.startSlur &&
                              (p.pitches[0].startSlur = p.startSlur),
                            void 0 !== p.dottedSlur &&
                              (p.pitches[0].dottedSlur = !0),
                            void 0 !== W.startTie &&
                              (p.pitches[0].startTie = W.startTie),
                            void 0 !== p.startTie &&
                              (p.pitches[0].startTie = p.startTie))
                          : ((p.rest = W.rest),
                            void 0 !== W.endSlur && (p.endSlur = W.endSlur),
                            void 0 !== W.endTie && (p.rest.endTie = W.endTie),
                            void 0 !== W.startSlur &&
                              (p.startSlur = W.startSlur),
                            void 0 !== W.startTie &&
                              (p.rest.startTie = W.startTie),
                            void 0 !== p.startTie &&
                              (p.rest.startTie = p.startTie)),
                        void 0 !== W.chord && (p.chord = W.chord),
                        void 0 !== W.duration && (p.duration = W.duration),
                        void 0 !== W.decoration &&
                          (p.decoration = W.decoration),
                        void 0 !== W.graceNotes &&
                          (p.graceNotes = W.graceNotes),
                        delete p.startSlur,
                        delete p.dottedSlur,
                        f(i, w, p) &&
                          (void 0 !== p.pitches
                          ...
                          m(i, w, !1)),
                        (W.startTie || p.startTie) && m(i, w, !0),
                        (t = W.endChar),
                        u > 0 &&
                          (!W.rest || "spacer" !== W.rest.type) &&
                          0 == --u &&
                          (p.endTriplet = !0),
                        W.end_beam && M(p),
                        p.rest &&
                          ...
                          1 === p.duration &&
                          y(i) <= 1 &&
                          ((p.rest.type = "whole"), (p.duration = y(i))),
                        p.duration < 1 &&
                          -1 ===
                            [
                              0.5, 0.75, 0.875, 0.9375, 0.96875, 0.984375, 0.25,
                              0.375, 0.4375, 0.46875, 0.484375, 0.4921875,
                              0.125, 0.1875, 0.21875, 0.234375, 0.2421875,
                              0.24609375, 0.0625, 0.09375, 0.109375, 0.1171875,
                              0.12109375, 0.123046875, 0.03125, 0.046875,
                              0.0546875, 0.05859375, 0.060546875, 0.0615234375,
                              0.015625, 0.0234375, 0.02734375, 0.029296875,
                              0.0302734375, 0.03076171875,
                            ].indexOf(p.duration) &&
                          0 !== p.duration &&
                          ((p.rest && "spacer" === p.rest.type) ||
                            a(
                  ...
                  t === x &&
                    (" " !== e.charAt(t) &&
                      "`" !== e.charAt(t) &&
                      a("Unknown character ignored", e, t),
                    t++);
                }
              }
            }
            (this.lineContinuation = e.indexOf("") >= 0 || d[0] > 0),
              this.lineContinuation || (p = {});
          }
        };
        var m = function (e, t, r) {
            ...
            if ('"' === e.charAt(t)) {
              ...
              if (
                ...
                0 === s.digits &&
                  ...
                  "," !== r[1][0] &&
                    a("Missing comma absolutely positioned annotation.", e, t),
                  (r[1] = r[1].substring(1));
          ...
          v = function (e, t) {
            if ("{" === e.charAt(t)) {
              ...
              r[2] ||
                a("Missing the closing '}' while parsing grace note", e, t),
                ")" === e[t + r[0]] && (r[0]++, (r[1] += ")"));
              for (var s = [], o = 0, c = !1; o < r[1].length; ) {
                ...
                var h = H(r[1], o, {}, !1);
                null !== h
                  ? ((h.duration = h.duration / (8 * i.default_length)),
                    l && (h.acciaccatura = !0),
                    s.push(h),
                    c && ((h.endTie = !0), (c = !1)),
                    h.startTie && (c = !0),
        ...
        var w = [
          ...
          S = function (e, t) {
            ...
            if (void 0 !== r)
              return (
                ...
                l.detect(w, function (e) {
                  return r === e;
                })
                  ? [1, r]
                  : l.detect(x, function (e) {
                      return r === e;
                    })
                  ? ("hidden" === i.volumePosition && (r = ""), [1, r])
                  : l.detect(k, function (e) {
                      return (
                        "hidden" === i.dynamicPosition && (r = ""), r === e
                      );
                    })
                  ? [1, r]
                  : (l.detect(i.ignoredDecorations, function (e) {
                      return r === e;
                    }) || a("Unknown macro: " + r, e, t),
                    [1, ""])
              );
            switch (e.charAt(t)) {
              case ".":
              ...
              case "+":
                ...
                return (
                  ...
                  l.detect(w, function (e) {
                    ...
                    ? ("hidden" === i.volumePosition && (s[1] = ""), s)
                    : l.detect(k, function (e) {
                        return s[1] === e;
                      })
                    ? ("hidden" === i.dynamicPosition && (s[1] = ""), s)
                    : l.detect(C, function (e) {
                        return s[1] === e[0] && ((s[1] = e[1]), !0);
                      })
                    ? s
                    : l.detect(T, function (e) {
                        return s[1] === e[0] && ((s[1] = e[1]), !0);
                      })
                    ? ("hidden" === i.dynamicPosition && (s[1] = ""), s)
                    : "!" !== e.charAt(t) ||
                      (1 !== s[0] && "!" === e.charAt(t + s[0] - 1))
                    ? (a("Unknown decoration: " + s[1], e, t), (s[1] = ""), s)
                    : [1, null]
                );
              case "H":
                return [1, "fermata"];
          ...
          _ = function (e, t) {
            for (var r = t; n.isWhiteSpace(e.charAt(t)); ) t++;
            return [t - r];
          },
          A = function (e, t) {
            var r = n.getBarLine(e, t);
            if (0 === r.len) return [0, ""];
            if (r.warn) return a(r.warn, e, t), [r.len, ""];
            for (
              var i = 0;
              i < e.length && " " === e.charAt(t + r.len + i);
              i++
            );
            var s = r.len;
            if (
              ("[" === e.charAt(t + r.len + i) && (r.len += i + 1),
              '"' === e.charAt(t + r.len) && "[" === e.charAt(t + r.len - 1))
            ) {
          ...
          E = { 2: 3, 3: 2, 4: 3, 5: 2, 6: 2, 7: 2, 8: 3, 9: 2 },
          N = function (e, t) {
            var r = {},
              i = t;
            for (
              "." === e[t] && "(" === e[t + 1] && ((r.dottedSlur = !0), t++);
              "(" === e.charAt(t) || n.isWhiteSpace(e.charAt(t));
              ...
              "(" === e.charAt(t) &&
                ...
                e.charAt(t + 1) <= "9"
                  ? (void 0 !== r.triplet
                      ? a("Can't nest triplets", e, t)
                      : ((r.triplet = e.charAt(t + 1) - "0"),
                        (r.tripletQ = E[r.triplet]),
                        (r.num_notes = r.triplet),
                        t + 2 < e.length &&
                          ":" === e.charAt(t + 2) &&
                          (t + 3 < e.length && ":" === e.charAt(t + 3)
                            ? t + 4 < e.length &&
                              e.charAt(t + 4) >= "1" &&
                              e.charAt(t + 4) <= "9"
                              ? ((r.num_notes = e.charAt(t + 4) - "0"),
                                (t += 3))
                              : a(
                            ...
                            : t + 3 < e.length &&
                              e.charAt(t + 3) >= "1" &&
                              e.charAt(t + 3) <= "9"
                            ? ((r.tripletQ = e.charAt(t + 3) - "0"),
                              t + 4 < e.length && ":" === e.charAt(t + 4)
                                ? t + 5 < e.length &&
                                  e.charAt(t + 5) >= "1" &&
                                  e.charAt(t + 5) <= "9" &&
                                  ((r.num_notes = e.charAt(t + 5) - "0"),
                                  (t += 4))
                                : (t += 2))
                            : a(
                  ...
                  : r.startSlur++),
                t++;
            return (r.consumed = t - i), r;
          };
        d.prototype.startNewLine = function () {
          var e = { startChar: -1, endChar: -1 };
          i.partForNextLine.title && (e.part = i.partForNextLine),
            (e.clef =
              i.currentVoice &&
              void 0 !== i.staves[i.currentVoice.staffNum].clef
                ? l.clone(i.staves[i.currentVoice.staffNum].clef)
                : l.clone(i.clef));
          var t = i.currentVoice ? i.currentVoice.scoreTranspose : 0;
          if (
            ((e.key = h.standardKey(
              i.key.root + i.key.acc + i.key.mode,
              i.key.root,
              i.key.acc,
              t
            )),
            (e.key.mode = i.key.mode),
            i.key.impliedNaturals &&
              (e.key.impliedNaturals = i.key.impliedNaturals),
            i.key.explicitAccidentals)
          )
            for (var r = 0; r < i.key.explicitAccidentals.length; r++) {
              for (var n = !1, a = 0; a < e.key.accidentals.length; a++)
                e.key.accidentals[a].note ===
                  i.key.explicitAccidentals[r].note &&
                  ((e.key.accidentals[a].acc =
                    i.key.explicitAccidentals[r].acc),
                  (n = !0));
              n || e.key.accidentals.push(i.key.explicitAccidentals[r]);
            }
          if (
            ((i.targetKey = e.key),
            ...
            null !== i.meter
              ? (i.currentVoice
                  ? (l.each(i.staves, function (e) {
                      e.meter = i.meter;
                    }),
                    (e.meter = i.staves[i.currentVoice.staffNum].meter),
                    (i.staves[i.currentVoice.staffNum].meter = null))
                  : (e.meter = i.meter),
                (i.meter = null))
              : i.currentVoice &&
                i.staves[i.currentVoice.staffNum].meter &&
                ((e.meter = i.staves[i.currentVoice.staffNum].meter),
                (i.staves[i.currentVoice.staffNum].meter = null)),
            i.currentVoice &&
              i.currentVoice.name &&
              (e.name = i.currentVoice.name),
            i.vocalfont && (e.vocalfont = i.vocalfont),
            i.tripletfont && (e.tripletfont = i.tripletfont),
            i.gchordfont && (e.gchordfont = i.gchordfont),
            i.style && (e.style = i.style),
            i.currentVoice)
          ) {
            var s = i.staves[i.currentVoice.staffNum];
            s.brace && (e.brace = s.brace),
              s.bracket && (e.bracket = s.bracket),
              s.connectBarLines && (e.connectBarLines = s.connectBarLines),
              s.name && (e.name = s.name[i.currentVoice.index]),
              s.subname && (e.subname = s.subname[i.currentVoice.index]),
              i.currentVoice.stem && (e.stem = i.currentVoice.stem),
              i.currentVoice.stafflines &&
                (e.stafflines = i.currentVoice.stafflines),
              i.currentVoice.staffscale &&
                (e.staffscale = i.currentVoice.staffscale),
              i.currentVoice.scale && (e.scale = i.currentVoice.scale),
              i.currentVoice.style && (e.style = i.currentVoice.style),
              i.currentVoice.transpose &&
                (e.clef.transpose = i.currentVoice.transpose);
          }
          var c =
            void 0 === i.currentVoice ||
            (0 === i.currentVoice.staffNum && 0 === i.currentVoice.index);
          0 === i.barNumbers &&
            c &&
            1 !== i.currBarNumber &&
            (e.barNumber = i.currBarNumber),
            o.startNewLine(e),
            i.key.impliedNaturals && delete i.key.impliedNaturals,
            (i.partForNextLine = {}),
            4 === i.tempoForNextLine.length &&
              o.appendElement(
                i.tempoForNextLine[0],
                i.tempoForNextLine[1],
                i.tempoForNextLine[2],
                i.tempoForNextLine[3]
              ),
            (i.tempoForNextLine = []);
        };
        var M = function (e) {
              ...
              switch (e.charAt(t)) {
                ...
                case "g":
                  if (
                    ...
                    return l(h) ? ((r.endChar = t), r) : null;
                  if (
                    ((r.pitch = B[e.charAt(t)]),
                    (r.name = e.charAt(t)),
                    r.accidental && (r.name = L[r.accidental] + r.name),
                    u.note(i, r),
                    (h = "octave"),
                    a && 0 !== i.next_note_duration
                      ? ((r.duration = i.default_length * i.next_note_duration),
                        (i.next_note_duration = 0),
                        (d = !0))
                      : (r.duration = i.default_length),
                    (i.clef && "perc" === i.clef.type) ||
                      (i.currentVoice && "perc" === i.currentVoice.clef))
                  ) {
                    var f = e.charAt(t);
                ...
                case "Z":
                  ...
                  (r.rest = { type: P[e.charAt(t)] }),
                    ...
                    r.rest.type.indexOf("multimeasure") >= 0
                      ? ((r.duration = s.getBarLength()),
                        (r.rest.text = 1),
                        (h = "Zduration"))
                      : (a && 0 !== i.next_note_duration
                          ? ((r.duration =
                              i.default_length * i.next_note_duration),
                            (i.next_note_duration = 0),
                            (d = !0))
                          : (r.duration = i.default_length),
                        (h = "duration"));
                ...
                case "/":
                  if ("octave" === h || "duration" === h) {
                    ...
                    for (
                      ...
                      p.index < e.length &&
                      (n.isWhiteSpace(e.charAt(p.index)) ||
                        "-" === e.charAt(p.index));
                    ...
                    (r.accidental = "quartersharp"), (h = "pitch");
                  else {
                    if ("flat2" !== h) {
                      if ("Zduration" === h) {
                        var m = n.getNumber(e, t);
                        return (
                          (r.duration = m.num * s.getBarLength()),
                          (r.rest.text = m.num),
                          (r.endChar = m.index),
                          r
                        );
                ...
                case "-":
                  if ("startSlur" === h) o.addTieToLastNote(c), (r.endTie = !0);
                    ...
                    if ("octave" !== h && "duration" !== h && "end_slur" !== h)
                      return "broken_rhythm" === h
                        ? ((r.endChar = t), r)
                        : null;
                    if (((r.startTie = {}), d || !a))
                      return (
                        n.isWhiteSpace(e.charAt(t + 1)) && M(r),
                        (r.endChar = t + 1),
                        r
                      );
                    h = "broken_rhythm";
                ...
                case "\t":
                  ...
                  do {
                    "." === e.charAt(t) &&
                      ...
                      ((c = !0), t++),
                      "-" === e.charAt(t) &&
                        ((r.startTie = {}), c && (r.startTie.style = "dotted")),
                      t++;
                  } while (
                    (t < e.length &&
                      (n.isWhiteSpace(e.charAt(t)) || "-" === e.charAt(t))) ||
                    ("." === e.charAt(t) && "-" === e.charAt(t + 1))
                  );
                  if (
                    ((r.endChar = t),
                    d || !a || ("<" !== e.charAt(t) && ">" !== e.charAt(t)))
                  )
                    return r;
                  t--, (h = "broken_rhythm");
                  break;
                ...
                case "<":
                  if (!l(h)) return null;
                  if (!a) return (r.endChar = t), r;
                  var g = O(e, t);
                  (t += g[0] - 1),
                    (i.next_note_duration = g[2]),
                    (r.duration = g[1] * r.duration),
                    (h = "end_slur");
                  break;
                default:
                  return l(h) ? ((r.endChar = t), r) : null;
          ...
          a = function (e, t) {
            ...
            (this.eatWhiteSpace = function (e, t) {
              ...
              (this.getMode = function (e) {
                ...
                var a = e.substring(n, n + 3).toLowerCase();
                switch (
              ...
              (this.getClef = function (e, t) {
                var a = e,
                  i = this.skipWhiteSpace(e);
                if (r(e, i)) return { len: 0 };
                var s = !1,
                  o = e.substring(i);
                if (
                  (n.startsWith(o, "clef=") &&
                    ((s = !0), (o = o.substring(5)), (i += 5)),
                  0 === o.length && s)
                )
                  return { len: i + 5, warn: "No clef specified: " + a };
                var c = this.skipWhiteSpace(o);
                if (r(o, c)) return { len: 0 };
                c > 0 && ((i += c), (o = o.substring(c)));
                var l = null;
                if (n.startsWith(o, "treble")) l = "treble";
                  ...
                  if (t || !s || !n.startsWith(o, "G"))
                    return { len: i + 5, warn: "Unknown clef specified: " + a };
                  l = "treble";
                }
                return (
                  (o = o.substring(l.length)),
                  (c = this.isMatch(o, "+8")) > 0
                    ? (l += "+8")
                    : (c = this.isMatch(o, "-8")) > 0 && (l += "-8"),
                  { len: i + l.length, token: l, explicit: s }
                );
              }),
              ...
              (this.getTokenOf = function (e, t) {
                for (var r = 0; r < e.length; r++)
                  if (t.indexOf(e.charAt(r)) < 0)
                    return { len: r, token: e.substring(0, r) };
                return { len: r, token: e };
              }),
              (this.getToken = function (e, t, r) {
                for (var n = t; n < r && !this.isWhiteSpace(e.charAt(n)); ) n++;
                return e.substring(t, n);
              }),
              (this.isMatch = function (e, t) {
                var a = this.skipWhiteSpace(e);
                return r(e, a)
                  ? 0
                  : n.startsWith(e.substring(a), t)
                  ? a + t.length
                  : 0;
              }),
              ...
              (this.getKeyAccidentals2 = function (e) {
                for (var t; e.length > 0; ) {
                  ...
                  switch (e[0].token.charAt(0)) {
                    ...
                    case "G":
                      void 0 === t && (t = []),
                        t.push({ acc: r, note: e[0].token.charAt(0) }),
                        1 === e[0].token.length
                          ? e.shift()
              ...
              (this.getKeyAccidental = function (e) {
                ...
                switch (e.charAt(n)) {
                  ...
                  case "G":
                    return {
                      len: n + 1,
                      token: { acc: t[a], note: e.charAt(n) },
                    };
                  case "^":
                  case "_":
                  case "/":
                    if (((a += e.charAt(n)), n++, r(e, n)))
                      return {
                        len: 2,
                        warn: "Expected note name after accidental",
                      };
            ...
            (this.tokenize = function (e, t, r, n) {
              ...
              for (var o, c = []; t < r; ) {
                if ('"' === e.charAt(t)) {
                  for (o = t + 1; o < r && '"' !== e.charAt(o); ) o++;
                  c.push({
                    type: "quote",
                    token: e.substring(t + 1, o),
                    start: t + 1,
                    end: o,
                  }),
                    o++;
                } else if (a(e.charAt(t))) {
                  if (((o = t + 1), n))
                    for (; o < r && !this.isWhiteSpace(e.charAt(o)); ) o++;
                  else for (; o < r && a(e.charAt(o)); ) o++;
                  c.push({
                    type: "alpha",
                    ...
                    (t = o + 1);
                } else if ("." === e.charAt(t) && i(e.charAt(o + 1))) {
                  o = t + 1;
                  for (var l; o < r && i(e.charAt(o)); ) o++;
                  ...
                  i(e.charAt(t)) ||
                  ("-" === e.charAt(t) && i(e.charAt(o + 1)))
                ) {
                  o = t + 1;
                  for (var h, u = null; o < r && i(e.charAt(o)); ) o++;
                  if ("." === e.charAt(o) && i(e.charAt(o + 1)))
                    for (o++; o < r && i(e.charAt(o)); ) o++;
              ...
              (this.getVoiceToken = function (e, t, r) {
                for (
                  var n = t;
                  (n < r && this.isWhiteSpace(e.charAt(n))) ||
                  "=" === e.charAt(n);
                ...
                if ('"' === e.charAt(n)) {
                  ...
                  return -1 === a || a >= r
                    ...
                    : {
                        len: a - t + 1,
                        token: this.translateString(e.substring(n + 1, a)),
                      };
                }
                for (
                  var i = n;
                  i < r &&
                  !this.isWhiteSpace(e.charAt(i)) &&
                  "=" !== e.charAt(i);

                )
                  i++;
                return { len: i - t + 1, token: e.substring(n, i) };
              });
            var s = {
                "`a": "à",
                "'a": "á",
            ...
            (this.translateString = function (e) {
              ...
              (this.getFraction = function (e, t) {
                ...
                if ("/" === e.charAt(t)) {
                  if ((t++, "/" === e.charAt(t))) {
                    for (var i = 0.5; "/" === e.charAt(t++); ) i /= 2;
                    return { value: r * i, index: t - 1 };
                  }
                  var s = t,
              ...
              (this.getMeasurement = function (e) {
                ...
                if (((r += e.shift().token), 0 === e.length))
                  return { used: 1, value: parseInt(r) };
                var n = e.shift();
                if ("." === n.token) {
                  if ((t++, 0 === e.length))
                    return { used: t, value: parseInt(r) };
                  if (
                    "number" === e[0].type &&
                    ((r = r + "." + (n = e.shift()).token), t++, 0 === e.length)
                  )
            ...
            this.getBrackettedSubstring = function (e, t, r, n) {
              for (
                var a = n || e.charAt(t), i = t + 1, s = !1;
                i < e.length && (s || e[i] !== a);

              )
                (s = "\\" === e[i]), ++i;
              return e.charAt(i) === a
                ? [i - t + 1, l(e.substring(t + 1, i)), !0]
                : ((i = t + r) > e.length - 1 && (i = e.length - 1),
                  [i - t + 1, l(e.substring(t + 1, i)), !1]);
            };
          };
        (a.prototype.peekLine = function () {
          return this.lines[this.lineIndex];
        }),
          (a.prototype.nextLine = function () {
            if (
              (this.lineIndex > 0 &&
                (this.multilineVars.iChar +=
                  this.lines[this.lineIndex - 1].length + 1),
      ...
      2821: function (e, t, r) {
        ...
        (s.keySignature = function (e, t, r, n, a) {
          if ("perc" === e.clef.type || "none" === e.clef.type)
            return { accidentals: i(t), root: r, acc: n };
          a || (a = 0),
          ...
          if (
            ((e.localTranspose =
              (e.globalTranspose ? e.globalTranspose : 0) + a),
            !e.localTranspose)
          )
          ...
          if (((e.globalTransposeOrigKeySig = s), e.localTranspose % 12 == 0))
            return (
              ...
              { accidentals: s, root: r, acc: n }
            );
          var h = t[0];
          "b" === t[1] || "#" === t[1]
            ? ((h += t[1]), (t = t.substr(2)))
            : (t = t.substr(1));
          for (var u = o[h] + e.localTranspose; u < 0; ) u += 12;
          u > 11 && (u %= 12);
          var d = "m" === t[0] ? l[u] : c[u],
            f = d + t,
            p = i(f);
          ...
          return (
            ...
            { accidentals: p, root: d[0], acc: d.length > 1 ? d[1] : "" }
          );
        }),
          ...
          if (e.localTranspose && "perc" !== e.clef.type) {
            ...
            if (
              ...
              var a = t.accidental ? t.name.substring(1) : t.name,
                i = t.accidental ? t.name[0] : "",
                s = n.pitchIndex(a);
              t.name = i + n.noteName(s + e.localTransposeVerticalMovement);
            }
            if (t.accidental) {
              var o = (function (e, t, r, n, a) {
                for (var i = h[(e + 49) % 7], s = 0, o = 0; o < n.length; o++)
                  n[o].note.toLowerCase() === i && (s = u[n[o].acc]);
                for (
                  var c = u[r] - s, l = h[(t + 49) % 7], d = 0, f = 0;
                  f < a.accidentals.length;
                  f++
                )
                  a.accidentals[f].note.toLowerCase() === l &&
                    (d = u[a.accidentals[f].acc]);
                var p = c + d;
                return (
                  p < -2 && (t--, (p += "c" === l || "f" === l ? 1 : 2)),
                  p > 2 && (t++, (p -= "b" === l || "e" === l ? 1 : 2)),
              ...
              (t.pitch = o[0]),
                (t.accidental = d[o[1]]),
                t.name && (t.name = f[o[1]] + t.name.replace(/[_^=]/g, ""));
            }
          }
        }),
          (e.exports = s);
        ...
        e.exports = function (e) {
          ...
          (this.setVisualTranspose = function (t) {
            ...
            (this.resolveOverlays = function () {
              for (var t = !1, n = [], i = 0; i < e.lines.length; i++) {
                var s = e.lines[i];
                if (s.staff)
                  for (var o = 0; o < s.staff.length; o++) {
                    for (
                      var c = s.staff[o], l = [], h = 0;
                      h < c.voices.length;
                      h++
                    ) {
                      var u = c.voices[h];
                      l.push({ hasOverlay: !1, voice: [], snip: [] }),
                        (n[i] = 0);
                      for (
                        var d = 0, f = !1, p = 0, m = -1, g = 0;
                        g < u.length;
                        g++
                      ) {
                        var v = u[g];
                        if ("overlay" !== v.el_type || f)
                          ...
                          for (var b = 0; b < i; b++)
                            n[b] &&
                              e.lines[b].staff &&
                              c.voices.length >=
                                e.lines[b].staff[0].voices.length &&
                      ...
                      l[h].hasOverlay &&
                        0 === l[h].snip.length &&
                        l[h].snip.push({ start: m, len: u.length - m });
                    }
                    for (h = 0; h < l.length; h++) {
                      ...
                      if (y.hasOverlay) {
                        y.voice.splice(0, 0, {
                          ...
                          c.voices.push(y.voice);
                        for (var w = y.snip.length - 1; w >= 0; w--) {
                          var x = y.snip[w];
                          c.voices[h].splice(x.start, x.len),
                            c.voices[h].splice(x.start + 1, 0, {
                              el_type: "stem",
                              direction: "auto",
                            });
                          var k = r(c.voices[h], x.start);
                          c.voices[h].splice(k, 0, {
                            el_type: "stem",
                            direction: "up",
                          });
                        }
                        for (
                          w = 0;
                          w < c.voices[c.voices.length - 1].length;
                          w++
                        ) {
                          c.voices[c.voices.length - 1][w] = a.clone(
                            c.voices[c.voices.length - 1][w]
                          );
                          var C = c.voices[c.voices.length - 1][w];
                          "bar" === C.el_type &&
                            C.startEnding &&
                            delete C.startEnding,
                            "bar" === C.el_type &&
                              C.endEnding &&
                              delete C.endEnding;
                        }
              ...
              for (s = 0; s < e.lines.length; s++)
                if (void 0 !== e.lines[s].staff) {
                  ...
                  for (o = 0; o < e.lines[s].staff.length; o++)
                    if (void 0 === e.lines[s].staff[o])
                      (l = !0), (e.lines[s].staff[o] = null);
                    else
                      for (c = 0; c < e.lines[s].staff[o].voices.length; c++)
                        void 0 === e.lines[s].staff[o].voices[c]
                          ? (e.lines[s].staff[o].voices[c] = [])
                          : this.containsNotes(e.lines[s].staff[o].voices[c]) &&
                            (h = !0);
                  h || ((e.lines[s] = null), (l = !0));
                }
              if (
                (l &&
                  ((e.lines = a.compact(e.lines)),
                  a.each(e.lines, function (e) {
                    e.staff && (e.staff = a.compact(e.staff));
                  })),
                t)
              )
                for (; p(e.lines, t); );
              ...
              for (
                (function (e) {
                  for (var t = !0, r = 0; r < e.length; r++) {
                    var n = e[r];
                    if (n.staff) {
                      for (var a = 0; a < n.staff.length; a++) {
                        var i = n.staff[a];
                        if (i.title) {
                          for (var s = !1, o = 0; o < i.title.length; o++)
                            i.title[o]
                              ? ((i.title[o] = t
                                  ? i.title[o].name
                                  : i.title[o].subname),
                                i.title[o] ? (s = !0) : (i.title[o] = ""))
                              : (i.title[o] = "");
                          s || delete i.title;
                        }
                      }
                ...
                if (e.lines[s].staff)
                  for (o = 0; o < e.lines[s].staff.length; o++)
                    delete e.lines[s].staff[o].workingClef;
              ...
              function d(e, t, r) {
                ...
                for (
                  var s = function (e, s, o) {
                      ...
                      for (var l, h = 0; h < s; h++)
                        (l = i[t][r][o].pop()), e.endSlur.push(l);
                      return 0 === i[t][r][o].length && delete i[t][r][o], l;
                    },
                    o = function (e, n, s, o) {
                      (e.startSlur = []),
                        void 0 === i[t][r][s] && (i[t][r][s] = []);
                      for (var c = 100 * s + 1, l = 0; l < n; l++)
                        o &&
                          (a.each(o, function (e) {
                            c === e && ++c;
                          }),
                          ...
                          i[t][r][s].push(c),
                          e.startSlur.push({ label: c }),
                          e.dottedSlur &&
                            ((e.startSlur[e.startSlur.length - 1].style =
                              "dotted"),
                            delete e.dottedSlur),
                          c++;
                    },
                  ...
                  if ("note" === l.el_type) {
                    if (l.gracenotes)
                      for (var h = 0; h < l.gracenotes.length; h++) {
                        if (l.gracenotes[h].endSlur) {
                          var u = l.gracenotes[h].endSlur;
                          l.gracenotes[h].endSlur = [];
                          for (var d = 0; d < u; d++) s(l.gracenotes[h], 1, 20);
                        }
                        l.gracenotes[h].startSlur &&
                          ((n = l.gracenotes[h].startSlur),
                          o(l.gracenotes[h], n, 20));
                      }
                    if (
                      (l.endSlur &&
                        ((n = l.endSlur), (l.endSlur = []), s(l, n, 0)),
                      l.startSlur && o(l, (n = l.startSlur), 0),
                      l.pitches)
                    ) {
                      for (var f = [], p = 0; p < l.pitches.length; p++)
                        if (l.pitches[p].endSlur) {
                          var m = l.pitches[p].endSlur;
                          l.pitches[p].endSlur = [];
                          for (var g = 0; g < m; g++) {
                            var v = s(l.pitches[p], 1, p + 1);
                            f.push(v);
                          }
                        }
                      for (p = 0; p < l.pitches.length; p++)
                        l.pitches[p].startSlur &&
                          ((n = l.pitches[p].startSlur),
                          o(l.pitches[p], n, p + 1, f));
                      l.gracenotes &&
                        l.pitches[0].endSlur &&
                        100 === l.pitches[0].endSlur[0] &&
                        l.pitches[0].startSlur &&
                        (l.gracenotes[0].endSlur
                          ? l.gracenotes[0].endSlur.push(
                              l.pitches[0].startSlur[0].label
                            )
                          : (l.gracenotes[0].endSlur = [
                              l.pitches[0].startSlur[0].label,
                            ]),
                        1 === l.pitches[0].endSlur.length
                          ? delete l.pitches[0].endSlur
                          : 100 === l.pitches[0].endSlur[0]
                          ? l.pitches[0].endSlur.shift()
                          : 100 ===
                              l.pitches[0].endSlur[
                                l.pitches[0].endSlur.length - 1
                              ] && l.pitches[0].endSlur.pop(),
                        1 === i[t][r][1].length
                          ? delete i[t][r][1]
                          : i[t][r][1].pop());
                    }
                  ...
                  if (void 0 !== e[s].staff)
                    for (o = 0; o < e[s].staff.length; o++) {
                      ...
                      for (c = 0; c < e[s].staff[o].voices.length; c++)
                        for (
                          var n = e[s].staff[o].voices[c], i = 0, l = 0;
                          l < n.length;
                          l++
                        )
                          if ("bar" === n[l].el_type) {
                            if (++i >= t && l < n.length - 1) {
                              ...
                              if (!h) {
                                ...
                                e.push(a.clone(u)), (h = e[e.length - 1]);
                                for (var d = 0; d < h.staff.length; d++)
                                  for (
                                    var f = 0;
                                    f < h.staff[d].voices.length;
                                    f++
                                  )
                                    h.staff[d].voices[f] = [];
                              }
                              ...
                              return (
                                (e[s].staff[o].voices[c] = e[s].staff[o].voices[
                                  c
                                ].slice(0, p)),
                                (h.staff[o].voices[c] = r.concat(
                                  g.concat(h.staff[o].voices[c])
                                )),
                                !0
                              );
                            }
              ...
              for (e.lineNum = 0; e.lineNum < e.lines.length; e.lineNum++) {
                ...
                if (g)
                  for (e.staffNum = 0; e.staffNum < g.length; e.staffNum++)
                    for (
                      g[e.staffNum].clef && f(g[e.staffNum].clef),
                        e.voiceNum = 0;
                      ...
                      for (var b = 0; b < v.length; b++)
                        "clef" === v[b].el_type && f(v[b]);
                      if (v.length > 0 && v[v.length - 1].barNumber) {
                        var y = m(e.lines, e.lineNum);
                        y && (y.staff[0].barNumber = v[v.length - 1].barNumber),
                          delete v[v.length - 1].barNumber;
                      }
                    }
              }
              return (
            ...
            (this.getLastNote = function () {
              if (
                ...
                for (
                  ...
                  var r =
                    e.lines[e.lineNum].staff[e.staffNum].voices[e.voiceNum][t];
            ...
            (this.addTieToLastNote = function (e) {
              ...
              return (
                ...
                ((t.pitches[0].startTie = {}),
                e && (t.pitches[0].startTie.style = "dotted"),
                !0)
              );
            }),
            ...
            (this.appendElement = function (r, n, i, s) {
              var o = e;
              (s.el_type = r),
                null !== n && (s.startChar = n),
                null !== i && (s.endChar = i);
              var c = function () {
                void 0 !== o.potentialStartBeam &&
                  void 0 !== o.potentialEndBeam &&
                  ((o.potentialStartBeam.startBeam = !0),
                  (o.potentialEndBeam.endBeam = !0)),
                  delete o.potentialStartBeam,
                  delete o.potentialEndBeam;
              };
              "note" === r
                ? t.getDuration(s) >= 0.25 ||
                  (s.force_end_beam_last && void 0 !== o.potentialStartBeam)
                  ? c()
                  : s.end_beam && void 0 !== o.potentialStartBeam
                  ? void 0 === s.rest
                    ? ((o.potentialStartBeam.startBeam = !0),
                      (s.endBeam = !0),
                      delete o.potentialStartBeam,
                  ...
                  : void 0 === s.rest &&
                    (void 0 === o.potentialStartBeam
                      ? s.end_beam ||
                        ((o.potentialStartBeam = s), delete o.potentialEndBeam)
                      : (o.potentialEndBeam = s))
                : c(),
                delete s.end_beam,
                delete s.force_end_beam_last,
                (function (e) {
                  var t = o.lines[o.lineNum].staff[o.staffNum];
                  if (t) {
                    if (void 0 !== e.pitches) {
                      var r = t.workingClef.verticalPos;
                      a.each(e.pitches, function (e) {
                        e.verticalPos = e.pitch - r;
                      });
                    }
                    if (void 0 !== e.gracenotes) {
                      var n = t.workingClef.verticalPos;
                      a.each(e.gracenotes, function (e) {
                        e.verticalPos = e.pitch - n;
                      });
                    }
                    t.voices[o.voiceNum].push(e);
                  }
                })(s);
            }),
            (this.appendStartingElement = function (t, r, n, i) {
              var s;
              this.closeLine(),
                "key" === t &&
                  ((s = i.impliedNaturals),
                  delete i.impliedNaturals,
                  delete i.explicitAccidentals);
              var o = a.clone(i);
              if (e.lines[e.lineNum] && e.lines[e.lineNum].staff) {
                e.lines[e.lineNum].staff.length <= e.staffNum &&
                  ((e.lines[e.lineNum].staff[e.staffNum] = {}),
                  (e.lines[e.lineNum].staff[e.staffNum].clef = a.clone(
                    e.lines[e.lineNum].staff[0].clef
                  )),
                  (e.lines[e.lineNum].staff[e.staffNum].key = a.clone(
                    e.lines[e.lineNum].staff[0].key
                  )),
                  e.lines[e.lineNum].staff[0].meter &&
                    (e.lines[e.lineNum].staff[e.staffNum].meter = a.clone(
                      e.lines[e.lineNum].staff[0].meter
                    )),
                  (e.lines[e.lineNum].staff[e.staffNum].workingClef = a.clone(
                    e.lines[e.lineNum].staff[0].workingClef
                  )),
                  (e.lines[e.lineNum].staff[e.staffNum].voices = [[]])),
                  "clef" === t &&
                    (e.lines[e.lineNum].staff[e.staffNum].workingClef = o);
                for (
                  var c =
                      e.lines[e.lineNum].staff[e.staffNum].voices[e.voiceNum],
                    l = 0;
                ...
                e.lines[e.lineNum].staff[e.staffNum][t] = i;
              }
            }),
            (this.pushLine = function (t) {
              e.vskipPending &&
                ((t.vskip = e.vskipPending), delete e.vskipPending),
                e.lines.push(t);
            }),
            ...
            (this.addText = function (e, t) {
              this.pushLine({
                text: { text: e, startChar: t.startChar, endChar: t.endChar },
              });
            }),
            ...
            (this.containsNotesStrict = function (e) {
              for (var t = 0; t < e.length; t++)
                if (
                  "note" === e[t].el_type &&
                  (void 0 === e[t].rest || void 0 !== e[t].chord)
                )
                  return !0;
              return !1;
            }),
              ...
              var a = function (e) {
                  ...
                  if (
                    ...
                    if (void 0 !== r.voices[0]) {
                      for (var a = !1, i = 0; i < r.voices[0].length; i++)
                        "stem" === r.voices[0].el_type && (a = !0);
                      a ||
                ...
                i = function (e) {
                  e.key &&
                    ...
                    void 0 !== e.stafflines &&
                      ((n.lines[n.lineNum].staff[n.staffNum].clef.stafflines =
                        e.stafflines),
                      (n.lines[n.lineNum].staff[
                        n.staffNum
                      ].workingClef.stafflines = e.stafflines)),
                    e.staffscale &&
                      (n.lines[n.lineNum].staff[n.staffNum].staffscale =
                        e.staffscale),
                    e.annotationfont &&
                      t.setLineFont("annotationfont", e.annotationfont),
                    e.gchordfont && t.setLineFont("gchordfont", e.gchordfont),
                    e.tripletfont &&
                      t.setLineFont("tripletfont", e.tripletfont),
                    e.vocalfont && t.setLineFont("vocalfont", e.vocalfont),
                    e.bracket &&
                      (n.lines[n.lineNum].staff[n.staffNum].bracket =
                        e.bracket),
                    e.brace &&
                      (n.lines[n.lineNum].staff[n.staffNum].brace = e.brace),
                    e.connectBarLines &&
                      (n.lines[n.lineNum].staff[n.staffNum].connectBarLines =
                        e.connectBarLines),
                    e.barNumber &&
                      (n.lines[n.lineNum].staff[n.staffNum].barNumber =
                        e.barNumber),
                    a(e),
                    e.part &&
                      t.appendElement(
                    ...
                    void 0 !== e.meter &&
                      (n.lines[n.lineNum].staff[n.staffNum].meter = e.meter),
                    n.vskipPending &&
                      ((n.lines[n.lineNum].vskip = n.vskipPending),
                      delete n.vskipPending);
                };
              void 0 === e.lines[e.lineNum]
                ? (function (e) {
                    (n.lines[n.lineNum] = { staff: [] }), i(e);
                  })(r)
                ...
                ? (e.lineNum++, this.startNewLine(r))
                : r.part &&
                  t.appendElement("part", r.part.startChar, r.part.endChar, {
                    title: r.part.title,
                  });
            }),
            ...
            (this.setLineFont = function (t, r) {
              if (e.runningFonts[t]) {
                for (var n = !1, a = Object.keys(r), i = 0; i < a.length; i++)
                  e.runningFonts[t][a[i]] !== r[a[i]] && (n = !0);
            ...
            (this.hasBeginMusic = function () {
              for (var t = 0; t < e.lines.length; t++)
                if (e.lines[t].staff) return !0;
              return !1;
            }),
            (this.isFirstLine = function (t) {
              for (var r = t - 1; r >= 0; r--)
                if (void 0 !== e.lines[r].staff) return !1;
              return !0;
            }),
            (this.getCurrentVoice = function () {
              ...
              return r && void 0 !== r.voices[e.voiceNum]
                ? r.voices[e.voiceNum]
                : null;
            }),
            ...
            (this.addMetaText = function (t, r, n) {
              void 0 === e.metaText[t]
                ...
                : ((e.metaText[t] += "\n" + r),
                  (e.metaTextInfo[t].endChar = n.endChar));
            }),
      ...
      1756: function (e) {
        function t(e, t) {
          for (var r = [], n = [], a = 0, i = 0; i < e.length; i++) {
            ...
            o < t
              ? (a = o)
              : t - a < o - t && a > 0
              ? (r.push(i - 1), n.push(Math.round(a - s)), (a = s))
              : i < e.length - 1 && (r.push(i), n.push(Math.round(a)), (a = 0));
          }
          return n.push(Math.round(a)), { lineBreaks: r, totals: n };
        }
        function r(e) {
          for (var t = [], r = 0; r < e.length; r++) t.push(e[r]);
          return t;
        }
        function n(e, t, n, a, i, s, o, c, l, h, u) {
        ...
        function a(e, t, r, a) {
          for (
            var i = Math.ceil(e.total / t),
              s = Math.floor(e.total / i),
              o = [],
              c = 0;
            c < i;
            c++
          ...
          var p = 9999999,
            m = -1;
          for (c = 0; c < l.length; c++)
            (u = l[c]).aveVariance < p && ((p = u.aveVariance), (m = c));
          return {
            failed: !1,
        ...
        function i(e, t, r) {
          for (var n = [], a = [], i = 0, s = !1, o = 0; o < e.length; o++)
            (i += e[o]) > t && (s = !0),
              o % r == r - 1 &&
                (o !== e.length - 1 && n.push(o),
                a.push(Math.round(i)),
                (i = 0));
          return { failed: s, totals: a, lineBreaks: n };
        }
        e.exports = {
                    ...
                    if (o.staff) {
                      ...
                      for (var h = 0; h < o.staff.length; h++)
                        for (
                          ...
                          i = c;
                          for (
                            var f = 0, p = 0, m = u.voices[d], g = 0, v = 0;
                            v < m.length;
                            v++
                          )
                            "bar" === m[v].el_type &&
                      ...
                      r.push({ ogLine: s, line: i }), i++, (a = Math.max(a, i));
                  }
                  return r;
                })(n, t);
              (e.lines = (function (e, t, r) {
                for (
                  ...
                  if (e[c.ogLine].staff) {
                    ...
                    if (
                      (n[c.line] || (n[c.line] = { staff: [] }),
                      !n[c.line].staff[c.staff])
                    ) {
                      (n[c.line].staff[c.staff] = { voices: [] }),
                        void 0 !== r &&
                          0 === c.staff &&
                          c.line > 0 &&
                          (n[c.line].staff[c.staff].barNumber = s);
                      for (var h = Object.keys(l), u = 0; u < h.length; u++) {
                        var d = "voices" === h[u];
                        "meter" === h[u] && 0 !== c.line && (d = !0),
                          d || (n[c.line].staff[c.staff][h[u]] = l[h[u]]);
                      }
                      a[c.staff] && (n[c.line].staff[c.staff].key = a[c.staff]);
                    }
                    n[c.line].staff[c.staff].voices[c.voice] ||
                      (n[c.line].staff[c.staff].voices[c.voice] = []),
                      (n[c.line].staff[c.staff].voices[c.voice] = e[
                        c.ogLine
                      ].staff[c.staff].voices[c.voice].slice(
                        c.start,
                        c.end + 1
                      )),
                      i[10 * c.staff + c.voice] &&
                        n[c.line].staff[c.staff].voices[c.voice].unshift({
                          el_type: "stem",
                          direction: i[10 * c.staff + c.voice].direction,
                        });
                    for (
                      var f = n[c.line].staff[c.staff].voices[c.voice],
                        p = f.length - 1;
                      p >= 0;
                      p--
                    )
          ...
          calcLineWraps: function (e, r, n) {
            ...
            n.wrap.lastLineLimit &&
              !l &&
              (l = Math.max(parseFloat(n.wrap.lastLineLimit), 1));
            for (
              ...
              if (!y) {
                var x = t(p.measureWidths, g);
                b.attempts.push({
                  type: "Free Form",
                  lineBreaks: x.lineBreaks,
                  totals: x.totals,
                }),
                  (y = x.lineBreaks).length > 0 &&
      ...
      5633: function (e, t, r) {
        ...
        !(function () {
          ...
          function e(e, r, n) {
            var a = [],
              i = r.getKeySignature();
            if ("Hp" === i.root || "HP" === i.root) return a;
            a = a.concat(
              (function (e, t) {
                for (
                  var r = [], n = e.split("K:"), a = n[0].length, i = 1;
                  i < n.length;
                  i++
                ) {
                  var s = n[i],
            ...
            for (var s = 0; s < r.lines.length; s++) {
              ...
              if (o)
                for (var c = 0; c < o.length; c++) {
                  var l = o[c];
                  "perc" !== l.clef.type &&
                    (a = a.concat(t(e, l.voices, l.key, n)));
                }
            }
            return a;
          }
          function t(e, t, n, a) {
            for (var i = [], s = f(n, a), o = 0; o < t.length; o++)
              i = i.concat(h(e, t[o], n.root, r(n), s, a));
            return i;
          }
          function r(e) {
            for (var t = {}, r = 0; r < e.accidentals.length; r++) {
              ...
              "flat" === n.acc
                ? (t[n.note.toUpperCase()] = "_")
                : "sharp" === n.acc && (t[n.note.toUpperCase()] = "^");
            }
            return t;
          }
          function i(e, t, r) {
          ...
          function h(e, t, n, a, s, o) {
            for (
              var c = [], h = i(s, n, o), u = {}, d = {}, m = 0;
              m < t.length;
              m++
            ) {
              var g = t[m];
              if (g.chord)
                for (var v = 0; v < g.chord.length; v++) {
                  ...
                  if ("default" === b.position) {
                    var C =
                        s.accidentals.length && "flat" === s.accidentals[0].acc,
                      T = l(b.name, o, C, !0);
                    (T = T.replace(/♭/g, "b").replace(/♯/g, "#")) !== b.name &&
                      c.push(k(e, g.startChar, g.endChar, T));
                  }
                }
              if ("note" === g.el_type && g.pitches) {
                for (var S = 0; S < g.pitches.length; S++) {
                  var _ = y(g.pitches[S].name, n, a, u);
                  _.acc && (u[_.name.toUpperCase()] = _.acc);
                  var A = p(_, s, h, d);
                  A.acc && (d[A.upper] = A.acc),
                    c.push(w(e, g.startChar, g.endChar, A.acc + A.name, S));
                }
                if (g.gracenotes)
                  for (var E = 0; E < g.gracenotes.length; E++) {
                    var N = y(g.gracenotes[E].name, n, a, u);
                    N.acc && (u[N.name.toUpperCase()] = N.acc);
                    var M = p(N, s, h, u);
                    M.acc && (d[M.upper] = M.acc),
                      c.push(x(e, g.startChar, g.endChar, M.acc + M.name, E));
                  }
              } else
                "bar" === g.el_type
                  ? ((u = {}), (d = {}))
                  : "keySignature" === g.el_type &&
                    ((n = g.root), (a = r(g)), (h = i((s = f(g, o)), n, o)));
            }
            return c;
          }
          n = function (t, r, n) {
            if ("TEST" === r)
              return {
                ...
                transposeKey: o,
                relativeMode: c,
                transposeChordName: l,
              };
            n = parseInt(n, 10);
            var i,
              h = [];
            for (i = 0; i < r.length; i++) h = h.concat(e(t, r[i], n));
          ...
          function f(e, t) {
            if ("none" === e.root)
              return { root: o("C", t), mode: "", acc: "", accidentals: [] };
          ...
          function p(e, t, r, n) {
            ...
            for (; o < 0; ) c--, (o += 7);
            for (
              var l = u[s], h = "", d = e.adj, f = "=", m = 0;
              m < t.accidentals.length;
              m++
            )
              if (t.accidentals[m].note.toLowerCase() === l.toLowerCase()) {
                (d += "flat" === t.accidentals[m].acc ? -1 : 1),
                  (f = "flat" === t.accidentals[m].acc ? "_" : "^");
                break;
              }
            switch (d) {
              case -2:
            ...
            return (
              c > 4 && (l = l.toLowerCase()),
              { acc: h, name: l, upper: l.toUpperCase() }
            );
          }
          var m = /([_^=]*)([A-Ga-g])([,']*)/,
            g = /([_^=]*[A-Ga-g][,']*)(\d*\/*\d*)([\>\<\-\)\.\s\\]*)/,
          ...
          function w(e, t, r, n, a) {
            var i = e.substring(t, r),
              s = i.match(new RegExp(g.source + b.source), "");
            if (s) {
              var o = s[1].length,
          ...
          function x(e, t, r, n, a) {
            ...
            if (s) {
              for (var o = 1 + s[1].length, c = 0; c < a; c++)
                s[3 * c + 2] && (o += s[3 * c + 2].length),
                  s[3 * c + 3] && (o += s[3 * c + 3].length),
                  s[3 * c + 4] && (o += s[3 * c + 4].length),
                  s[3 * c + 5] && (o += s[3 * c + 5].length);
              s[3 * a + 2] && (o += s[3 * c + 2].length), (t += o);
              var l = s[3 * a + 3] ? s[3 * a + 3].length : 0;
              (l += s[3 * a + 4] ? s[3 * a + 4].length : 0),
                (r = t + (l += s[3 * a + 5] ? s[3 * a + 5].length : 0));
            }
            return { start: t, end: r, note: n };
          }
          function k(e, t, r, n) {
            var a = e.substring(t, r).match(/([^"]+)?(".+")+/);
            return (
              a[1] && (t += a[1].length),
              { start: t + 1, end: (r = t + a[2].length) - 1, note: n }
            );
          }
          function C(e, t, r) {
        ...
        !(function () {
          ...
          function V(e) {
            for (var t = u.length - 1; t >= 0; t--)
              if ("program" === u[t].cmd) return void (u[t].channel = e);
          }
          function G() {
            for (var e = !0, t = 0; t < p.length && e; t++)
              "note" === p[t].cmd && (e = !1);
            return e;
          }
          function Y(e) {
          ...
          n = function (n, a, i) {
            a || (a = {}),
              ...
              (T = []),
              (I = {}),
              n.length > 0 && n[0].length > 0 && (j = n[0][0].pickupLength),
              (function (e, t) {
                for (var r = 0; r < e.length; r++) {
                  for (
                    var n = e[r], a = {}, i = t.qpm, s = 0, o = 1, c = 0;
                    c < n.length;
                    c++
                  ) {
                    var l = n[c];
                        ...
                        for (var u = 0; u < l.pitches.length; u++) {
                          ...
                          if (d)
                            if (((d.duration = l.duration), d.startTie))
                              void 0 === a[d.pitch]
                                ? (a[d.pitch] = { el: c, pitch: u })
                                : ((n[a[d.pitch].el].pitches[
                                    a[d.pitch].pitch
                                  ].duration += d.duration),
                                  (l.pitches[u] = null));
                            else if (d.endTie) {
                    ...
                    } else i ? (o = l.qpm ? i / l.qpm : 1) : (i = l.qpm);
                  }
                  for (var m in a)
            ...
            for (var E = 0; E < n.length; E++) {
              r = 0;
              var q = n[E];
              (u = [{ cmd: "program", channel: E, instrument: l }]),
                (d = void 0),
                (x = 0);
              var R = !1;
              (!0 === a.voicesOff ||
                (a.voicesOff &&
                  a.voicesOff.length &&
                  a.voicesOff.indexOf(E) >= 0)) &&
                (R = !0);
              for (var U = 0; U < q.length; U++) {
                var X = q[U];
                switch (X.el_type) {
                  case "name":
                    d = { cmd: "text", type: "name", text: X.trackName };
                    break;
                  case "note":
                    Q(X, R) && (m = E);
                    break;
                  ...
                  case "instrument":
                    if (
                      (void 0 === l && (l = X.program),
                      (h = X.program),
                      u.length > 0 && "program" === u[u.length - 1].cmd)
                    )
                      u[u.length - 1].instrument = X.program;
                    else {
                      var K;
                      for (
                        K = u.length - 1;
                      ...
                      (K < 0 || u[K].instrument !== X.program) &&
                        u.push({
                          cmd: "program",
                          channel: 0,
                          instrument: X.program,
                        });
                    }
                    break;
                  case "channel":
                  ...
                  case "drum":
                    ...
                    break;
                  case "gchord":
                    a.chordsOff || (B = X.tacet);
                    break;
                  case "beat":
                    (H = X.beats[0]), (O = X.beats[1]), (z = X.beats[2]);
                    break;
                  case "vol":
                    k = X.volume;
                    break;
                  ...
                  default:
                    console.log(
                      "MIDI creation. Unknown el_type: " + X.el_type + "\n"
                    );
                }
              }
            ...
            return (
              a.detuneOctave &&
                ...
                })(s, parseInt(a.detuneOctave, 10)),
              G() || s.push(p),
              T.length > 0 && s.push(T),
              { tempo: o, instrument: l, tracks: s, totalDuration: f }
            );
          };
          var R = ["break", "(break)", "no chord", "n.c.", "tacet"];
          function U(e, t, r) {
            return (r - e) / t;
          }
          function X(e) {
            var t = !1,
              n = (function (e) {
                ...
                for (var t = 0; t < e.chord.length; t++) {
                  ...
                  if (R.indexOf(r.name.toLowerCase()) >= 0) return "break";
                }
                return null;
              })(e);
            if (n) {
                ...
                if (0 !== e.length) {
                  ...
                  if (n) {
                    ...
                    if (
                      ((i = ae(n, l[0])).length >= 3 &&
                        (s = s + (i[2] - i[0]) - 7),
                      2 === l.length && re[l[1].substring(0, 1)])
                    ) {
                      var h =
                        { "#": 1, "♯": 1, b: -1, "♭": -1 }[l[1].substring(1)] ||
                        0;
                      s = n = re[l[1].substring(0, 1)] + h + a;
                    }
                    return { boom: n, boom2: s, chick: i };
                  }
                }
              })(n);
              if (a) {
                0 === p.length &&
                  ((t = !0),
                  p.push({ cmd: "program", channel: v, instrument: 0 })),
                  (y = a);
                var i = U(x, W(A), Y(e.time));
                b.push({ chord: y, beat: i, start: Y(e.time) });
              }
            }
            return t;
          }
          ...
          function Q(e, t) {
            ...
            if (
              (e.gracenotes &&
                ...
                e.pitches[0] &&
                ((r = (function (e, t) {
                  for (var r, n = 0, a = [], s = 0; s < e.length; s++)
                    n += (r = e[s]).duration;
                  var o = t / 2 / n;
                  for (s = 0; s < e.length; s++) {
                    var c = J((r = e[s]));
              ...
              if (void 0 === e.elem.currentTrackMilliseconds)
                (e.elem.currentTrackMilliseconds = l),
                  (e.elem.currentTrackWholeNotes = c);
              else if (void 0 === e.elem.currentTrackMilliseconds.length)
                e.elem.currentTrackMilliseconds !== l &&
                  ((e.elem.currentTrackMilliseconds = [
                    e.elem.currentTrackMilliseconds,
                    l,
                  ]),
                  (e.elem.currentTrackWholeNotes = [
                    e.elem.currentTrackWholeNotes,
                    c,
                  ]));
              else {
                for (
                  var d = !1, p = 0;
                  p < e.elem.currentTrackMilliseconds.length;
                  p++
                )
                  e.elem.currentTrackMilliseconds[p] === l && (d = !0);
                d ||
                  (e.elem.currentTrackMilliseconds.push(l),
                  e.elem.currentTrackWholeNotes.push(c));
              }
            }
            if (e.pitches) {
              var m = "",
                  ...
                  if (e.decoration)
                    for (var n = 0; n < e.decoration.length; n++)
                      "staccato" === e.decoration[n]
                        ...
                        : "uppermordent" === e.decoration[n] ||
                          "mordent" === e.decoration[n]
                        ? (r.noteModification = "mordent")
                        : "turn" === e.decoration[n]
                        ? (r.noteModification = "turn")
                        : "roll" === e.decoration[n] &&
                          (r.noteModification = "roll");
                  return r;
                })(e, n);
              g.thisBreakBetweenNotes && (m = g.thisBreakBetweenNotes),
                g.velocity && (n = g.velocity);
              var v = e.pitches;
              if ("rhythm" === e.style && ((P = !0), y && y.chick)) {
                v = [];
                for (var b = 0; b < y.chick.length; b++) {
                  var w = a.clone(e.pitches[0]);
                  (w.actualPitch = y.chick[b]), v.push(w);
                }
              }
              ...
              for (var T = 0; T < v.length; T++) {
                var _ = v[T];
                if (_) {
                  _.startSlur && (D += _.startSlur.length),
                    _.endSlur && (D -= _.endSlur.length);
                  var N = _.actualPitch ? _.actualPitch : J(_);
                  if (h === E && S) {
                    var M = i(_);
                    M && S[M] && (N = S[M].sound);
                  }
                  ...
                  if (
                    ...
                    e.gracenotes &&
                      ...
                      (B.start = B.start + B.duration)),
                    e.elem && e.elem.midiPitches.push(B),
                    g.noteModification)
                  )
                    K(g.noteModification, B);
                  else {
                    switch (
                      (D > 0 ? (B.endType = "tenuto") : m && (B.endType = m),
                      B.endType)
                    ) {
                      case "tenuto":
                        B.gap = -0.001;
            ...
            return (f = Math.max(f, Y(e.time) + q(V))), s;
          }
          var $ = [0, 2, 4, 5, 7, 9, 11];
          function J(n) {
            ...
            var i =
              ...
              $[te(a)] +
              60;
            return void 0 !== e[a] ? (i += e[a]) : (i += t[te(a)]), (i += r);
          }
          function Z(e) {
            var t = [0, 0, 0, 0, 0, 0, 0];
            ...
            for (var r = 0; r < e.accidentals.length; r++) {
              ...
              t[te(a.note.toLowerCase().charCodeAt(0) - "c".charCodeAt(0))] +=
                n;
            }
            return t;
          }
          ...
          var re = { A: 33, B: 35, C: 36, D: 38, E: 40, F: 41, G: 43 },
            ne = {
              dim: [0, 3, 6],
              "°": [0, 3, 6],
              "˚": [0, 3, 6],
          ...
          function ae(e, t) {
            ...
            r ||
              (r =
                "ma" === t.slice(0, 2).toLowerCase() || "M" === t.charAt(0)
                  ? ne.M
                  : "m" === t.charAt(0) || "-" === t.charAt(0)
                  ? ne.m
                  : ne.M),
              (e += 12);
            for (var n = [], a = 0; a < r.length; a++) n.push(e + r[a]);
            return n;
          }
          ...
          function ce(e, t) {
            var r = A.num,
              ...
              i = a / 2,
              s = oe[r + "/" + n],
              o = parseInt(r, 10) / parseInt(n, 10) - (t - e) / _;
            if ((Math.abs(o) < 1e-5 && (o = !1), !s || o)) {
              s = [];
              for (var c = (t - e) / _ / a, l = 0; l < c; l++) s.push("chick");
            }
            if (
              (0 === b.length && b.push({ beat: 0, chord: y }),
              0 !== b[0].beat && y && w && b.unshift({ beat: 0, chord: w }),
              1 !== b.length)
            ) {
              for (
                var h = 0.125 === a ? 3 : 1, u = {}, d = 0;
                d < b.length;
                d++
              ) {
                var f = b[d];
              ...
              for (var p = 0; p < s.length; p++) {
                ...
                if ((u["" + p] && (m = u["" + p]), !P && m))
                  switch (s[p]) {
                    case "boom":
                      u["" + (p + 1)]
                        ? se(m.chord.chick, a, M, p, i)
                        : (ie(m.chord.boom, a, N, p, i), (g = m.chord.boom));
                      break;
                    case "boom2":
                      u["" + (p + 1)]
                        ? se(m.chord.chick, a, M, p, i)
                        : g === m.chord.boom
                        ? (ie(m.chord.boom2, a, N, p, i), (g = void 0))
                        : (ie(m.chord.boom, a, N, p, i), (g = m.chord.boom));
                      break;
                    case "chick":
                      se(m.chord.chick, a, M, p, i);
              ...
              for (var v = b[0].beat; v < s.length; v++)
                if (!P)
                  switch (s[v]) {
                    case "boom":
                      ie(b[0].chord.boom, a, N, v, i);
                      break;
                    case "boom2":
                      ie(b[0].chord.boom2, a, N, v, i);
                      break;
                    case "chick":
                      se(b[0].chord.chick, a, M, v, i);
                  }
          }
          function le(e) {
            if (0 === e.pattern.length || !1 === e.on) return { on: !1 };
            for (
              var t = e.pattern[0], r = [], n = "", a = 0, i = 0;
              i < t.length;
              i++
            )
              if (("d" === t[i] && a++, "d" === t[i] || "z" === t[i]))
                0 !== n.length ? (r.push(n), (n = t[i])) : (n += t[i]);
              else {
                if (0 === n.length) return { on: !1 };
                n += t[i];
              }
            if ((0 !== n.length && r.push(n), e.pattern.length !== 2 * a + 1))
              return { on: !1 };
            for (
            ...
            for (var p = 0, m = A.num / A.den, g = 0; g < s.pattern.length; g++)
              p += s.pattern[g].len;
          ...
          function he(e) {
            if (0 !== T.length || I.on) {
              ...
              if (0 === T.length) {
                if (f < t) return;
                T.push({ cmd: "program", channel: e, instrument: E });
              }
              if (I.on)
                for (var r = x, n = 0; n < I.pattern.length; n++) {
                  var a = q(I.pattern[n].len);
                  I.pattern[n].pitch &&
                    T.push({
                      cmd: "note",
                      pitch: I.pattern[n].pitch,
                      volume: I.pattern[n].velocity,
                      start: r,
                      duration: a,
                      gap: 0,
                      instrument: E,
      ...
      9991: function (e, t, r) {
        ...
        !(function () {
          ...
          function r(e, t) {
            for (var r = "", n = 0; n < e.length; n++)
              r += i(e.charCodeAt(n), 2);
            return "%00%FF" + t + i(r.length / 3, 2) + r;
          }
          function i(e, t) {
            var r = e.toString(16);
          ...
          (t.prototype.setTempo = function (e) {
            0 === this.trackcount &&
              (this.startTrack(),
              (this.track += "%00%FF%51%03" + i(Math.round(6e7 / e), 6)),
              this.endTrack());
          }),
            (t.prototype.setGlobalInfo = function (e, t, n, a) {
              if (0 === this.trackcount) {
                this.startTrack();
                var s = Math.round(6e7 / e);
                (this.track += "%00%FF%51%03" + i(s, 6)),
                  n &&
                    (this.track += (function (e) {
                      if (!e || !e.accidentals) return "";
                      for (
                        var t = "%00%FF%59%02", r = 0, n = 256, a = 0;
                        a < e.accidentals.length;
                        a++
                      )
                        "sharp" === e.accidentals[a].acc
                          ? r++
                          : "flat" === e.accidentals[a].acc && n--;
                      var s = i(256 !== n ? n : r, 2),
                        o = "m" === e.mode ? "%01" : "%00";
                      return t + s + o;
                    })(n)),
                  a &&
                    (this.track += (function (e) {
                      var t,
                        r = "%00%FF%58%04" + i(e.num, 2),
                        n = { 1: 0, 2: 1, 4: 2, 8: 3, 16: 4, 32: 5 }[e.den];
                      if (!n) return "";
                      switch (((r += i(n, 2)), e.num + "/" + e.den)) {
                        case "2/4":
                        case "3/4":
                        case "4/4":
                        case "5/4":
            ...
            (t.prototype.endTrack = function () {
              ...
              var e = i(this.track.length / 3 + 4, 8);
            ...
            (t.prototype.setInstrument = function (e) {
              (this.trackInstrument = "%00%C0" + i(e, 2)),
                (this.instrument = e);
            }),
            ...
            (t.prototype.startNote = function (e, t, r) {
              if (
                ...
                var n = Math.round(4096 * a(r));
                (this.track += s(8192 + n)),
                  (this.track += o(0)),
                  (this.noteWarped[e] = !0);
              }
              (this.track += this.noteOnAndChannel),
                (this.track += "%" + e.toString(16) + i(t, 2));
            }),
            ...
            (t.prototype.embed = function (t, r) {
              var n = this.getData(),
                a = e(document.createElement("a"), { href: n });
              if (
                ((a.innerHTML = "download midi"),
                t.insertBefore(a, t.firstChild),
                !r)
              ) {
                var i = e(document.createElement("embed"), {
                  src: n,
      ...
      1028: function (e, t, r) {
        ...
        !(function () {
          ...
          var e,
            t = 128;
          function r(e, t, r) {
            for (var n = 0, a = t + 1; a < e.length; a++)
              if (
                ("note" === e[a].el_type && n++,
                e[a].decoration && e[a].decoration.indexOf(r) >= 0)
              )
                return n;
            return n;
          }
          function i(e, t, r) {
            for (var n = Math.min(e.length, t + 3), a = t; a < n; a++)
              if ("note" === e[a].el_type && e[a].decoration)
                for (var i = 0; i < e[a].decoration.length; i++)
                  if (r.indexOf(e[a].decoration[i]) >= 0)
                    return e[a].decoration[i];
            return null;
          }
          function s(e) {
            for (var t = 0; t < e.length; t++)
              for (
                var r = e[t], n = r.length - 1;
                n >= 0 && "bar" !== r[n].el_type;

              )
                (r[n].noChordVoice = !0), n--;
          }
          function o(e, t) {
            if (e && !(e.length <= t) && e[t].title)
              return e[t].title.join(" ");
          }
          function c(e, t) {
            var r = 1 / 4;
          ...
          function f(e, t) {
            for (var r = e.length - 1; r >= 0; r--)
              if (e[r].el_type === t.el_type)
                return void (
                  JSON.stringify(e[r]) !== JSON.stringify(t) && e.push(t)
                );
            e.push(t);
          }
          n = function (n, h) {
            ...
            if (n.formatting.midi) {
              var _ = n.formatting.midi;
              _.program &&
                _.program.length > 0 &&
                ((m = _.program[0]),
                _.program.length > 1 &&
                  ((m = _.program[1]), (v = _.program[0])),
                (b = !0)),
                _.transpose && (g = _.transpose[0]),
                _.channel && ((v = _.channel[0]), (b = !0)),
                _.drum && (y = _.drum),
                _.drumbars && (w = _.drumbars[0]),
                _.drumon && (k = !0),
                10 === v && (m = t),
                _.beat && S.push({ el_type: "beat", beats: _.beat }),
                _.nobeataccents &&
                  S.push({ el_type: "beataccents", value: !1 });
            }
            p = h.qpm
              ? parseInt(h.qpm, 10)
              : n.metaText.tempo
              ...
              : 180;
            var A = [];
            T && A.push({ el_type: "bagpipes" }),
              A.push({ el_type: "instrument", program: m }),
              v && A.push({ el_type: "channel", channel: v }),
              g && A.push({ el_type: "transpose", transpose: g }),
              A.push({ el_type: "tempo", qpm: p });
                ...
                for (
                  var V = function (e) {
                      ...
                      if (e.decoration)
                        if (
                          ...
                          t &&
                            ((N = n[t].slice(0)),
                            M[Y].push({ el_type: "beat", beats: N.slice(0) }),
                            (B[R] = !1),
                            (P[R] = !1)),
                          e.decoration.indexOf("crescendo(") >= 0)
                        ) {
                          var a = r(U, ee, "crescendo)"),
                            s = Math.min(127, N[0] + 50),
                            o = i(U, ee + a + 1, Object.keys(n));
                          o && (s = n[o][0]),
                            (B[R] = a > 0 && Math.floor((s - N[0]) / a)),
                            (P[R] = !1);
                        } else if (e.decoration.indexOf("crescendo)") >= 0)
                          B[R] = !1;
                        else if (e.decoration.indexOf("diminuendo(") >= 0) {
                          var c = r(U, ee, "diminuendo)"),
                            l = Math.max(15, N[0] - 50),
                            h = i(U, ee + c + 1, Object.keys(n));
                          h && (l = n[h][0]),
                            (B[R] = !1),
                            (P[R] = c > 0 && Math.floor((l - N[0]) / c));
                        } else
                          e.decoration.indexOf("diminuendo)") >= 0 &&
                            (P[R] = !1);
                    },
                    G = j.staff,
                    Y = 0,
                  ...
                  if (!W.clef || "TAB" !== W.clef.type)
                    for (var R = 0; R < W.voices.length; R++) {
                      var U = W.voices[R];
                      if (!M[Y]) {
                        M[Y] = [].concat(JSON.parse(JSON.stringify(A)));
                        var X = o(j.staff, Y);
                        X && M[Y].unshift({ el_type: "name", trackName: X });
                      }
                      if (
                        (g &&
                          "perc" === W.clef.type &&
                          M[Y].push({ el_type: "transpose", transpose: 0 }),
                        W.clef && "perc" === W.clef.type && !b)
                      )
                        for (var K = 0; K < M[Y].length; K++)
                          "instrument" === M[Y][K].el_type &&
                            (M[Y][K].program = t);
                      else W.key && u(M[Y], W.key);
                      W.meter && d(M[Y], W.meter),
                        !F &&
                          k &&
                          (M[Y].push({
                            el_type: "drum",
                            params: { pattern: y, bars: w, on: k, intro: x },
                          }),
                          (F = !0)),
                        W.clef &&
                          "perc" !== W.clef.type &&
                            ...
                            if (
                              ...
                              if (
                                (te.style
                                  ...
                                  : C[Y] && (re.style = C[Y]),
                                (re.duration =
                                  0 === te.duration ? 0.25 : te.duration),
                                te.startTriplet)
                              ) {
                                if (
                                  (($ = te.tripletMultiplier),
                                  (J = te.startTriplet * $ * te.duration),
                                  te.startTriplet !== te.tripletR &&
                                    ee + te.tripletR <= U.length)
                                ) {
                                  for (
                                    var ne = 0, ae = ee;
                                    ae < ee + te.tripletR;
                                ...
                                (re.duration = re.duration * $),
                                  (re.duration =
                                    Math.round(1e6 * re.duration) / 1e6),
                                  (Z = re.duration);
                              } else
                                $ &&
                                  (te.endTriplet
                              ...
                              te.rest && (re.rest = te.rest),
                                te.decoration &&
                                  (re.decoration = te.decoration.slice(0)),
                                te.pitches &&
                                  (re.pitches = a.cloneArray(te.pitches)),
                                te.gracenotes &&
                                  (re.gracenotes = a.cloneArray(te.gracenotes)),
                                te.chord && (re.chord = a.cloneArray(te.chord)),
                                M[Y].push(re),
                                "rhythm" === te.style && s(M),
                                Q++,
                                (L[Y] += re.duration);
                          ...
                          case "bar":
                            ...
                            if (ie) {
                              ...
                              for (var he = ce; he < le; he++) {
                                var ue = a.clone(M[Y][he]);
                                ue.pitches &&
                                  (ue.pitches = a.cloneArray(ue.pitches)),
                                  M[Y].push(ue);
                              }
                          ...
                          case "midi":
                            ...
                            switch (te.cmd) {
                              ...
                              case "transpose":
                                M[Y].push({
                                  el_type: "transpose",
                                  transpose: te.params[0],
                                });
                                break;
                              case "gchordoff":
                                M[Y].push({ el_type: "gchord", tacet: !0 });
                                break;
                              case "gchordon":
                                M[Y].push({ el_type: "gchord", tacet: !1 });
                                break;
                              case "beat":
                                M[Y].push({
                                  el_type: "beat",
            ...
            if (
              ((function (e, t) {
                if (t && 0 !== t.length)
                  for (var r = Object.keys(t), n = 0; n < e.length; n++)
                    for (
                      var a = e[n], i = t[0] ? t[0].qpm : 0, s = 0;
                      s < a.length;
                      s++
                    ) {
                      var o = a[s];
                      "tempo" === o.el_type && (i = o.qpm),
              ...
              for (var fe = n.getPickupLength(), pe = 0; pe < M.length; pe++) {
                for (
                  var me = 0;
                  "note" !== M[pe][me].el_type && M[pe].length > me;
            ...
            return (
              M.length > 0 &&
                M[0].length > 0 &&
                (M[0][0].pickupLength = n.getPickupLength()),
              M
            );
          };
        })(),
                  ...
                  case "note":
                    if (e.duration > 0) {
                      ...
                      var o = {
                        ...
                        end: Math.round(1e6 * (e.start + s - i)) / 1e6,
                        volume: e.volume,
                      };
        ...
        e.exports = function (e, t) {
          ...
          if ("string" == typeof e) {
            ...
            if (!(e = document.querySelector(n)))
              throw new Error('Cannot find element "' + n + '" in the DOM.');
          ...
          if (
            ...
            (r.disable = function (e) {
              ...
              e
                ? t.classList.add("abcjs-disabled")
                : t.classList.remove("abcjs-disabled");
            }),
            (r.setWarp = function (e, t) {
              (r.parent.querySelector(".abcjs-midi-tempo").value =
                Math.round(t)),
                r.setTempo(e);
            }),
            ...
            (r.resetAll = function () {
              for (
                var e = r.parent.querySelectorAll(".abcjs-pushed"), t = 0;
                t < e.length;
                t++
              )
            ...
            var f = !1;
            r.options.ac
              ? (f = "suspended" !== r.options.ac.state)
              : i() && (f = "suspended" !== i().state),
      ...
      5594: function (e, t, r) {
        ...
        e.exports = function () {
          ...
          (e.audioBufferPossible = void 0),
            ...
            (e.init = function (t) {
              ...
              (e.soundFontUrl = n.soundFontUrl ? n.soundFontUrl : m),
                ...
                n.programOffsets
                  ...
                  : (e.programOffsets = {});
              var a =
                void 0 !== n.fadeLength ? parseInt(n.fadeLength, 10) : NaN;
              if (
                ((e.fadeLength = isNaN(a) ? 200 : a),
                (a = void 0 !== n.noteEnd ? parseInt(n.noteEnd, 10) : NaN),
                (e.noteEnd = isNaN(a) ? 0 : a),
                (e.pan = n.pan),
                (e.meterSize = 1),
                t.visualObj)
              )
                (e.flattened = t.visualObj.setUpAudio(n)),
                  t.visualObj.getMeterFraction().den &&
                    (e.meterSize =
                      t.visualObj.getMeterFraction().num /
                      t.visualObj.getMeterFraction().den);
              else {
                if (!t.sequence)
              ...
              (e.millisecondsPerMeasure = t.millisecondsPerMeasure
                ...
                : 1e3),
                (e.beatsPerMeasure = t.visualObj
                  ? t.visualObj.getBeatsPerMeasure()
                  : 4),
              ...
              e.flattened.tracks.forEach(function (e) {
                e.forEach(function (e) {
                  if (
                    ...
                    if (r)
                      ...
                      var a = g + ":" + r;
                      console.log("Can't find note: ", t, a),
                ...
                e.debugCallback &&
                  e.debugCallback(
                    "note gathering time = " +
                      Math.floor(1e3 * (s().currentTime - r)) +
                      "ms"
                  ),
                (r = s().currentTime);
              var v = [];
              ...
              for (var b = [], y = 0; y < v.length; y += 256)
                b.push(v.slice(y, y + 256));
              return new Promise(function (t, n) {
                var a = { cached: h, error: u, loaded: [] },
                  i = 0;
                !(function o() {
                  i < b.length
                    ? e._loadBatch(b[i], e.soundFontUrl, r).then(function (e) {
                        (r = s().currentTime),
                          e &&
                            (e.error && (a.error = a.error.concat(e.error)),
                            e.loaded && (a.loaded = a.loaded.concat(e.loaded))),
                          i++,
                          o();
                      }, n)
                    : t(a);
            ...
            (e._loadBatch = function (t, r, a, i) {
              var o = [];
              return (
                t.forEach(function (e) {
                  o.push(n(r, e.instrument, e.note, s()));
                }),
                Promise.all(o)
                  .then(function (n) {
                    e.debugCallback &&
                      e.debugCallback(
                        "mp3 load time = " +
                          Math.floor(1e3 * (s().currentTime - a)) +
                          "ms"
                      );
                    for (
                      var o = [], c = [], l = [], h = [], u = 0;
                    ...
                    if (l.length > 0) {
                        ...
                        return new Promise(function (t, n) {
                          setTimeout(function () {
                            ...
                            for (u = 0; u < l.length; u++)
                              (f = l[u].split(":")),
                                s.push({ instrument: f[0], note: f[1] });
                            e._loadBatch(s, r, a, i)
                              .then(function (e) {
                                t(e);
                              })
                              .catch(function (e) {
                      ...
                      for (var p = [], m = 0; m < t.length; m++)
                        p.push(t[m].instrument + "/" + t[m].note);
                      return Promise.reject(
                        new Error("timeout attempting to load: " + p.join(", "))
                      );
                    }
                    return Promise.resolve({ loaded: o, cached: c, error: h });
                  })
                  .catch(function (e) {})
              );
            }),
                ...
                e.audioBufferPossible
                  ? (e.debugCallback && e.debugCallback("prime called"),
                    new Promise(function (r) {
                      ...
                      var c = a(e.flattened);
                      e.sequenceCallback &&
                        e.sequenceCallback(c, e.callbackContext);
                      var l = (function (e, t) {
                          ...
                          if (t.length) {
                            for (var n = 0; n < e; n++)
                              if (n < t.length) {
                                ...
                                a < -1 ? (a = -1) : a > 1 && (a = 1), r.push(a);
                              } else r.push(0);
                            return r;
                          }
                          var i = parseFloat(t);
                          if (i * (e - 1) > 2) return null;
                          for (
                            var s = e % 2 == 0,
                              o = s ? 0 - i / 2 : 0,
                              c = o + i,
                      ...
                      c.forEach(function (e, t) {
                        ...
                        e.forEach(function (e) {
                          var t =
                            ...
                            e.volume +
                            ":" +
                            Math.round(1e3 * (e.end - e.start)) / 1e3 +
                            ":" +
                            r +
                            ":" +
                            i +
                            ":" +
                            (e.cents ? e.cents : 0);
                          h[t] || (h[t] = []), h[t].push(e.start);
                        });
                      });
                      for (
                        var d = [],
                          f = s().createBuffer(2, o, s().sampleRate),
                          p = 0;
                      ...
                      function b(e) {
                        var t =
                          e && e.audioBuffers && e.audioBuffers.length > 0
                            ? e.audioBuffers[0].duration
                            : 0;
                      ...
                      (e.audioBuffers = [f]),
                        e.debugCallback &&
                          ...
                          e.debugCallback(
                            "creationTime = " +
                              Math.floor(1e3 * (s().currentTime - n)) +
                              "ms"
                          )),
            ...
            (e._deviceCapable = function () {
              return (
                !!o() ||
                (console.warn(f), e.debugCallback && e.debugCallback(f), !1)
              );
            }),
            ...
            (function (e) {
              ...
              for (; h < i; ) {
                for (t = 0; t < c.length; t++)
                  (r =
                    0 |
                    (0.5 + (r = Math.max(-1, Math.min(1, c[t][l]))) < 0
                      ? 32768 * r
                      : 32767 * r)),
                    o.setInt16(h, r, !0),
                    (h += 2);
      ...
      562: function (e, t, r) {
        var n = r(1592),
          a = r(3284),
          i = function (e, t, r, n) {
            var a = ["abcjs-download-midi", "abcjs-midi-" + n];
            t.downloadClass && a.push(t.downloadClass);
            var i = '<div class="' + a.join(" ") + '">';
            t.preTextDownload && (i += t.preTextDownload);
            var s,
              o,
              c =
                e.metaText && e.metaText.title ? e.metaText.title : "Untitled";
            return (
              (s =
                t.downloadLabel &&
                (o = t.downloadLabel) &&
              ...
              (i +=
                '<a download="' +
                (t.fileName ? t.fileName : c + ".midi") +
                '" href="' +
                r +
                '">' +
                s +
                "</a>"),
              t.postTextDownload && (i += t.postTextDownload),
              i + "</div>"
            );
          };
        e.exports = function (e, t) {
          ...
          function o(e, t, n) {
            ...
            switch (r.midiOutputType) {
              ...
              case "binary":
                ...
                o = (o = o.replace(/MThd/g, "%4d%54%68%64")).replace(
                  /MTrk/g,
                  "%4d%54%72%6b"
                );
                for (
                  var c = new ArrayBuffer(o.length / 3),
                    l = new Uint8Array(c),
                    h = 0;
                  h < o.length / 3;
                  h++
          ...
          return (
            (r.generateInline = !1),
            "string" == typeof e ? n.renderEngine(o, "*", e, r) : o(0, e, 0)
          );
        };
      },
      5343: function (e) {
                  ...
                  (s.onload = function () {
                    if (200 === s.status) {
                      var e = a.decodeAudioData(
                        ...
                        function () {
                          i(Error("Can't decode sound at " + o));
                        }
                      );
                      e && "function" == typeof e.catch && e.catch(i);
                    } else i(Error("Can't load sound at " + o));
                  }),
                  (s.onerror = function () {
                    i(Error("Can't load sound at " + o));
                  }),
                  s.send();
              }).catch(function (e) {
                throw (
                  (console.error("Didn't load note", t, r, ":", e.message), e)
                );
              })),
            i[r]
          );
      ...
      4586: function (e, t, r) {
        var n = r(4771),
          ...
          s = function (e, t, r) {
            for (var n = 0; n < 2; n++)
              for (
                var a = t.getChannelData(n), i = e.getChannelData(n), s = 0;
                s < a.length;
                s++
              )
                i[s + r] += a[s];
          };
        e.exports = function (e, t, r, o, c, l, h, u) {
          var d =
              window.OfflineAudioContext || window.webkitOfflineAudioContext,
            f = r.len * r.tempoMultiplier;
          l && (f += l / 1e3), (f -= u) < 0 && (f = 0.005);
          var p = new d(2, Math.floor((f + h) * t), t),
            m = a[r.pitch],
            g = n[r.instrument][m];
          return g
            ? g
                .then(function (n) {
                  var a = p.createBufferSource();
                  a.buffer = n.audioBuffer;
                  var u,
                    d = (r.volume / 96) * c;
                  return (
                    (a.gainNode = p.createGain()),
                    r.pan &&
                      p.createStereoPanner &&
                      ((a.panNode = p.createStereoPanner()),
                      a.panNode.pan.setValueAtTime(r.pan, 0)),
                    (a.gainNode.gain.value = d),
                    a.gainNode.gain.linearRampToValueAtTime(
                      a.gainNode.gain.value,
                      f
                    ),
                    a.gainNode.gain.linearRampToValueAtTime(0, f + h),
                    r.cents && (a.playbackRate.value = i(r.cents)),
                    a.panNode
                      ? (a.panNode.connect(p.destination),
                        a.gainNode.connect(a.panNode))
                      : a.gainNode.connect(p.destination),
                    a.connect(a.gainNode),
                    a.start(0),
                    a.noteOff ? a.noteOff(f + h) : a.stop(f + h),
                    (p.oncomplete = function (n) {
                      if (n.renderedBuffer && n.renderedBuffer.getChannelData)
                        for (var a = 0; a < o.length; a++) {
                          var i = o[a] * r.tempoMultiplier;
                          l && (i -= l / 1e3),
                            i < 0 && (i = 0),
                            (i = Math.floor(i * t)),
                            s(e, n.renderedBuffer, i);
                        }
                      u();
                    }),
                    p.startRendering(),
      ...
      4718: function (e, t, r) {
        ...
        e.exports = function (e, t, r) {
          for (var a = new n(), o = 0; o < e.length; o++) {
            var c = e[o],
              l = a.addTrack();
            if ((a.setInstrument(l, c.instrument), 0 === o && t))
              for (var h = 0; h < t.length; h++) {
                var u = t[h];
                a.appendNote(l, u.pitch, 1 / 64, u.volume, u.cents);
              }
            a.appendNote(l, c.pitch, c.duration, c.volume, c.cents);
          }
          var d = i();
        ...
        e.exports = function () {
          ...
          (e.warp = 100),
            ...
            (e.seek = function (t, r) {
              e.timer &&
                e.midiBuffer &&
                (e.timer.setProgress(t, r), e.midiBuffer.seek(t, r));
            }),
            ...
            (e.beatCallback = function (t, r, n, a) {
              var i = t / r;
              e.setProgress(i, n),
                e.cursorControl &&
                  e.cursorControl.onBeat &&
                  "function" == typeof e.cursorControl.onBeat &&
                  e.cursorControl.onBeat(t, r, n, a);
            }),
      ...
      2029: function (e) {
        e.exports = function () {
          ...
          (e.tracks = []),
            ...
            (e.appendNote = function (t, r, n, a, i) {
              var s = {
                cmd: "note",
                duration: n,
                gap: 0,
      ...
      1484: function (e, t, r) {
        ...
        (a.prototype.notesToNumber = function (e, t) {
          return this.strings.notesToNumber(e, t);
        }),
          (a.prototype.stringToPitch = function (e) {
      ...
      5952: function (e, t, r) {
        ...
        (c.prototype.init = function (e, t, r) {
          ...
          (c.prototype.render = function (e, t, r) {
            this._super.inError ||
              this.tablature.bypass(t) ||
              (o(this.abcTune), new i(this, e, t, r).doLayout());
          }),
          (e.exports = function () {
            return { name: "GuitarTab", tablature: c };
          });
      },
      1921: function (e, t, r) {
        var n = r(6776),
        ...
        function i(e, t) {
          for (var r = [], a = 0; a < t.length; a++) {
            var i = o(e, new n.TabNote(t[a].name));
            r.push(i);
          }
          return (
            (function (e, t) {
              for (var r = 0; r < t.length - 1; r++) {
                var n = t[r],
                  a = t[r + 1];
                if (n.str == a.str) {
                  if (n.str == e.strings.length - 1)
                    return (n.num = "?"), void (a.num = "?");
                  a.num < n.num
                    ? (a.str++,
                      (a = s(
                        e,
        ...
        function s(e, t, r, n, a) {
          var i = e.strings;
          t.checkKeyAccidentals(e.accidentals), n && (i = n);
          var s = t.emitNoAccidentals(),
            o = i[r].indexOf(s),
            c = t.acc;
          if (-1 != o) {
            if ((n && (o += a), (t.isFlat || -1 == t.acc) && 0 == o)) {
              var l = t.getAccidentalEquiv();
              (o = i[++r].indexOf(l.emit())), (c = 0);
            }
        ...
        function o(e, t) {
          var r = null,
            a = 0,
            i = e.strings[e.strings.length - 1],
            o = new n.TabNote(i[0]);
          if (t.isLowerThan(o))
            return {
              num: "?",
              str: e.strings.length - 1,
              note: t,
              error: t.emit() + ": unexpected note for instrument",
            };
          for (; a < e.strings.length; ) {
            if ((r = s(e, t, a))) return r;
            a++;
          }
          return null;
        }
        ...
        function l(e) {
          var t = e.tuning,
            r = e.capo,
            i = e._super.params.highestNote;
          if (
            ((this.linePitch = e.linePitch),
            (this.highestNote = "a'"),
            i && (this.highestNote = i),
            (this.capo = 0),
            r && (this.capo = r),
            (this.tuning = t),
            this.capo > 0 &&
              (this.capoTuning = (function (e) {
                ...
                if (e.capo > 0) {
                  ...
                  for (var a = 0; a < r.length; a++) {
                    for (var i = new n.TabNote(r[a]), s = 0; s < e.capo; s++)
                      i = i.nextNote();
                    t[a] = i.emit();
                  }
                }
        ...
        (l.prototype.stringToPitch = function (e) {
          return 5.3 + (this.strings.length - 1 - e) * this.linePitch;
        }),
          (l.prototype.notesToNumber = function (e, t) {
            var r,
              a,
              s = null,
              l = null;
            if (
              (e &&
                ((l = []),
                e.length > 1
                  ? (l = i(this, e)).error && (s = l.error)
                  : (a = o(this, (r = new n.TabNote(e[0].name))))
                  ? l.push(a)
                  : (c(l, r), (s = l.error))),
              s)
            )
            ...
            if (t) {
              ...
              for (var u = 0; u < t.length; u++)
                (a = o(this, (r = new n.TabNote(t[u].name))))
                  ? h.push(a)
                  : (c(h, r), (s = l.error));
            }
            return { notes: l, graces: h, error: s };
          }),
          (l.prototype.toString = function () {
            return this.tuning.join("").replaceAll(",", "").toUpperCase();
          }),
          (l.prototype.tabInfos = function (e) {
      ...
      6776: function (e) {
          ...
          e.startsWith("_")
            ...
            ? ((a = !0),
              ...
              "/" == e[1]
                ? ((a = !1), (s = "^"), (c = 0))
                : "^" == e[1] && ((o = !0), (c += 1)))
            : e.startsWith("=") && ((i = !0), (c = 0)),
            ((t = r || a || null != s) || i) &&
              (n = null != s || o ? e.slice(2) : e.slice(1));
          var l = (e.match(/,/g) || []).length,
            h = (e.match(/'/g) || []).length;
          (this.name = n),
            (this.acc = c),
            (this.isSharp = a),
        ...
        (r.prototype.sameNoteAs = function (e) {
          return (
            this.name == e.name &&
            this.hasComma == e.hasComma &&
            this.isLower == e.isLower &&
            this.isQuoted == e.isQuoted &&
            this.isSharp == e.isSharp &&
            this.isFlat == e.isFlat
          );
        }),
          (r.prototype.isLowerThan = function (e) {
            var t = ["C", "D", "E", "F", "G", "A", "B"];
            if (this.hasComma > e.hasComma) return !0;
            if (e.hasComma > this.hasComma) return !1;
            if (this.isQuoted > e.isQuoted) return !1;
            if (e.isQuoted > this.isQuoted) return !0;
            if (this.isLower) {
              if (!e.isLower) return !1;
            } else if (e.isLower) return !0;
            var r = e.name[0].toUpperCase(),
              n = this.name[0].toUpperCase();
            return t.indexOf(n) < t.indexOf(r);
          }),
          (r.prototype.checkKeyAccidentals = function (e) {
            if (e)
              for (var t = this.name, r = 0; r < e.length; r++) {
                var n = e[r];
                t == n.note.toUpperCase() &&
                  ("flat" == n.acc && ((this.acc = -1), (this.isKeyFlat = !0)),
                  "sharp" == n.acc && ((this.acc = 1), (this.isKeySharp = !0)));
              }
          }),
          (r.prototype.getAccidentalEquiv = function () {
            var e = n(this);
            return (
              e.isSharp || e.isKeySharp
                ? (((e = e.nextNote()).isFlat = !0),
                  (e.isSharp = !1),
                  (e.isKeySharp = !1))
                : (e.isFlat || e.isKeyFlat) &&
                  (((e = e.prevNote()).isSharp = !0),
                  (e.isFlat = !1),
                  (e.isKeyFlat = !1)),
              e
            );
          }),
          (r.prototype.nextNote = function () {
            var e = n(this);
            if (this.isSharp || this.isKeySharp)
              (e.isSharp = !1), (e.isKeySharp = !1);
            else if ("E" != this.name && "B" != this.name)
              return (e.isSharp = !0), e;
            var r = t.indexOf(this.name);
            return (
              r == t.length - 1 ? (r = 0) : r++,
              (e.name = t[r]),
              "C" == e.name &&
          ...
          (r.prototype.prevNote = function () {
            var e = n(this);
            if (this.isSharp) return (e.isSharp = !1), e;
            var r = t.indexOf(this.name);
            return (
              0 == r ? (r = t.length - 1) : r--,
              (e.name = t[r]),
              ...
              this.isFlat
                ? ((e.isFlat = !1), e)
                : ("E" != this.name && "B" != this.name && (e.isSharp = !0), e)
            );
          }),
          (r.prototype.emitNoAccidentals = function () {
            var e = this.name;
      ...
      6629: function (e, t, r) {
        ...
        (i.prototype.build = function () {
          ...
          if (-1 == i || -1 == s) return n;
          for (var o = !1; !o; )
            n.push(e.emit()), (e = e.nextNote()).sameNoteAs(t) && (o = !0);
          return n;
        }),
          (e.exports = i);
      },
      4916: function (e, t, r) {
        ...
        (c.prototype.init = function (e, t, r) {
          ...
          (e.exports = function () {
            return { name: "ViolinTab", tablature: c };
          });
      },
      346: function (e) {
        e.exports = function (e) {};
      ...
      1696: function (e, t, r) {
        ...
        function s(e, t) {
          for (var r in t)
            t.hasOwnProperty(r) &&
              (Array.isArray(t[r]) ||
                (null != (n = t[r]) && n.constructor === Object) ||
                (e[r] = t[r]));
          var n;
        }
        function o(e) {
          ...
          return (
            ...
            e.abcelem &&
              ((t.abcelem = {}),
              s(t.abcelem, e.abcelem),
              "note" === t.abcelem.el_type &&
                (t.abcelem.el_type = "tabNumber")),
            t
          );
        }
        function c(e, t) {
          var r = o(e);
          if (t)
            for (var n = e.children, i = !0, c = 0; c < n.length; c++) {
              var l = n[c],
                h = new a("", 0, 0, 0, "");
              s(h, l),
                (i = t.tablature.setRelative(l, h, i)),
                r.children.push(h);
            }
          return r;
        }
        function l(e, t, r) {
          var i = "tab.tiny",
            s = 7.5;
          e.isTabBig && ((i = "tab.big"), (s = 10));
          var o = new n(
            { el_type: "tab", icon: i, Ypos: s },
            0,
            0,
            "symbol",
            0
          ...
          o.x = t;
          var c = new a(i, 0, 0, 7.5, "tab");
          return (
            (c.x = r),
            o.children.push(c),
            "tab" == o.abcelem.el_type && (c.pitch = s),
            o
          );
        }
        function h(e) {
        ...
        function d(e, t, r, n, i) {
          ...
          var c = new a(s, 0, 0, o + 0.3, { type: "tabNumber" });
          return (
            (c.x = t), (c.isGrace = i), (c.isAltered = n.note.isAltered), c
          );
        }
        function f(e, t) {
          var r = 0;
        ...
        function m(e, t, r, n) {
          if (e.transpose) {
            for (var a = 0; a < r.length; a++) r[a] = t.transposeNote(r[a]);
            if (n)
              for (var i = 0; i < n.length; i++) n[i] = t.transposeNote(n[i]);
          }
        }
        function g(e, t, r) {
          ...
          if (n.graces && n.notes) {
            var a = n.notes.length - 1;
            n.notes[a].graces = n.graces;
          }
          return n;
        }
        function v(e, t, r, n, a) {
          for (var i = 0; i < n.length; i++) {
            var s = {
              ...
              o = d(e, f(r, i), s, n[i], !0);
            t.children.push(o), a.push(s);
          }
        }
        (u.prototype.build = function (e, t, r, n, a, s) {
          var u = (function (e) {
              for (var t = 0, r = 0; r < e.length; r++)
                e[r].tabNameInfos || t++;
              return t;
            ...
            x = null,
            k = null;
          "clef" != b.children[0].abcelem.el_type &&
            "none" != s &&
            b.children.splice(0, 0, s);
          for (var C = 0; C < b.children.length; C++) {
            var T = b.children[C],
              S = T.x,
              _ = S;
            switch ((T.isClef && y.children.push(l(e, S, _)), T.type)) {
              case "staff-extra key-signature":
                (this.accidentals = T.abcelem.accidentals),
                  (e.semantics.strings.accidentals = this.accidentals),
                  e.transpose &&
                    (w = new i(T.abcelem.accidentals, e.transpose));
                break;
              case "bar":
                var A = !1;
                C === b.children.length - 1 && (A = !0);
                var E = c(T, e);
                if (E.abcelem.barNumber) {
                  delete E.abcelem.barNumber;
                  for (var N = 0; N < E.children.length; N++)
                    if ("barNumber" === E.children[N].type) {
              ...
              case "rest":
                var M = p(T);
                if (M) {
                  if ((m(e, w, null, M), (x = g(e, null, M)).error)) return;
                  (D = {
                    el_type: "note",
                    startChar: T.abcelem.startChar,
                    endChar: T.abcelem.endChar,
              ...
              case "note":
                var B = o(T);
                (B.x = T.heads[0].x + T.heads[0].w / 2), (B.lyricDim = h(T));
                var P = T.abcelem.pitches,
                  L = T.abcelem.gracenotes;
                if (
                  ((B.type = "tabNumber"),
                  m(e, w, P, L),
                  (x = g(e, P, L)).error)
                  ...
                  return;
                if (x.graces) {
                  var H = x.notes.length - 1;
                  x.notes[H].graces = x.graces;
                }
                k = {
                  el_type: "note",
                  startChar: T.abcelem.startChar,
                ...
                for (var O = 0; O < x.notes.length; O++) {
                  var z = x.notes[O];
                  if (z.graces)
                    for (var F = 0; F < z.graces.length; F++) {
                      var D = {
                          el_type: "note",
                          startChar: T.abcelem.startChar,
                          endChar: T.abcelem.endChar,
                        ...
                        I = d(e, f(T, F), D, z.graces[F], !0);
                      B.children.push(I), r.push(D);
                    }
                  var j = d(e, B.x + T.heads[O].dx, k, z, !1);
                  B.children.push(j);
                }
                (k.abselem = B), r.push(k), y.children.push(B);
            }
          }
        }),
          (e.exports = u);
      ...
      8660: function (e) {
        ...
        (t.prototype.setError = function (e) {
          ...
          e &&
            ((this.error = e),
            (this.inError = !0),
            t.warnings ? t.warnings.push(e) : (t.warnings = [e]));
        }),
          (e.exports = t);
      },
      676: function (e, t, r) {
        ...
        function l(e, t) {
          return "clef" === e[t].children[0].abcelem.el_type
            ? null
            : 0 == t
            ? "none"
            : e[t - 1].children[0];
        ...
        (s.prototype.doLayout = function () {
          ...
          if (e) {
            ...
            if (t && t.clef && 0 == t.clef.stafflines)
              return void this.plugin._super.setError(
                "No tablatures when stafflines=0"
              );
          ...
          var r = this.line.staffGroup,
            ...
            s = (function (e) {
              for (var t = 0, r = 0; r < e.children.length; r++) {
                var n = e.children[r];
                n.specialY &&
                  n.specialY.lyricHeightBelow > t &&
                  (t = n.specialY.lyricHeightBelow);
              }
              return t;
            })(a[0]),
            h = this.staffIndex,
          ...
          var f = {
            ...
            p = (function (e, t) {
              for (var r = e.staffIndex, n = 0, a = 0, i = 0; ; ) {
                if (!t[n]) return -1;
                if (
                  (t[n].isTabStaff || (i = t[n].voices.length), t[n].isTabStaff)
                ) {
                  if ((a++, o(n, t) && a < i)) return n + 1;
                } else if (((a = 0), n >= r)) {
          ...
          if (-1 !== p) {
            (f.parentIndex = p - 1),
              r.staffs.splice(p, 0, f),
              (r.height += this.tabSize + 3);
            var m,
              g,
              v,
              b,
            ...
            for (var C = 0; C < k; C++) {
              var T = new n(0, 0),
                S =
                  ...
                  (w = b.calc(y, "tablabelfont", "text instrumentname")),
                  (g.tabNameInfos = { textSize: w, name: y }),
                  w.height / i.STEP);
              (r.staffs[this.staffIndex].top += S),
                (r.height += S * i.STEP),
                (T.staff = f),
                a.splice(a.length, 0, T);
              var _ = l(a, C + this.staffIndex);
      ...
      4506: function (e, t, r) {
        var n = r(6776);
        function a(e, t) {
          var r = t.getAccidentalEquiv();
          return e.note.toUpperCase() == r.name.toUpperCase()
            ? ((r.isSharp = !1), (r.isFlat = !1), r)
            : t;
        }
        function i(e, t) {
          if ("sharp" == e.acc) {
            if (t.isFlat) return a(e, t);
            t.isSharp &&
              (e.note.toUpperCase() == t.name.toUpperCase()
                ? ((t.isSharp = !1), (t.isKeySharp = !0))
                : e.note.toUpperCase() == t.name.toUpperCase() &&
                  (t.natural = !0));
          } else if ("flat" == e.acc) {
            if (t.isSharp) return a(e, t);
            t.isFlat
              ? e.note.toUpperCase() == t.name.toUpperCase() &&
                ((t.isFlat = !1), (t.isKeyFlat = !0))
              : e.note.toUpperCase() == t.name.toUpperCase() &&
                (t.natural = !0);
          }
          return t;
        ...
        function s(e, t) {
          for (var r = e.transposedKey, n = 0; n < r.length; n++)
            t = i(r[n], t);
          return t;
        }
        function o(e, t) {
          (this.transposeBy = t),
            (this.transposedKey = e),
            (this.lastEnd = this.kEnd + 1);
        }
        (o.prototype.transposeNote = function (e) {
          var t = e,
            r = new n.TabNote(t.name);
          if (this.transposeBy > 0)
            for (var a = 0; a < this.transposeBy; a++)
              r = s(this, r.nextNote());
          else if (this.transposeBy < 0)
            for (var i = this.transposeBy; i < 0; i++)
              r = s(this, r.prevNote());
          return (t.name = r.emit()), t;
        }),
          (o.prototype.upgradeSource = function (e, t, r) {
            !(function (e, t, r, n) {
              if (e.lastEnd)
                for (; r > e.lastEnd; )
                  e.updatedSrc.push(e.abcSrc[e.lastEnd]), e.lastEnd++;
              for (var a = t.split(""), i = 0; i < a.length; i++)
                e.updatedSrc.push(a[i]);
              for (var s = r + i; n >= s; ) e.updatedSrc.push(a[s]), s++;
              e.lastEnd = n;
            })(this, new n.TabNote(e.name).emit(), t, r - 1);
          }),
          (e.exports = o);
      },
      3255: function (e, t, r) {
        ...
        var n = r(907),
          ...
          i = function (e, t, r, n, a, i) {
            i || (i = {}),
              ...
              (this.abcelem = e),
              (this.duration = t),
              (this.durationClass = i.durationClassOveride
                ? i.durationClassOveride
                : this.duration),
              (this.minspacing = r || 0),
              (this.x = 0),
              (this.children = []),
      ...
      6548: function (e, t, r) {
        ...
        function A(e, t) {
          var r = e[t];
          if ("note" !== r.el_type || !r.startBeam || r.endBeam)
            return { count: 1, elem: r };
          for (
            var n = [];
            t < e.length &&
            "note" === e[t].el_type &&
            (n.push(e[t]), !e[t].endBeam);
        ...
        (_.prototype.reset = function () {
          ...
          (_.prototype.setStemHeight = function (e) {
            this.stemHeight = Math.round((10 * e) / p.STEP) / 10;
          }),
          (_.prototype.getCurrentVoiceId = function (e, t) {
            return "s" + e + "v" + t;
          }),
          (_.prototype.pushCrossLineElems = function (e, t) {
            (this.slursbyvoice[this.getCurrentVoiceId(e, t)] = this.slurs),
              (this.tiesbyvoice[this.getCurrentVoiceId(e, t)] = this.ties),
              (this.endingsbyvoice[this.getCurrentVoiceId(e, t)] =
                this.partstartelem),
              (this.scaleByVoice[this.getCurrentVoiceId(e, t)] =
                this.voiceScale);
          }),
          (_.prototype.popCrossLineElems = function (e, t) {
            (this.slurs =
              this.slursbyvoice[this.getCurrentVoiceId(e, t)] || {}),
              (this.ties =
                this.tiesbyvoice[this.getCurrentVoiceId(e, t)] || []),
              (this.partstartelem =
                this.endingsbyvoice[this.getCurrentVoiceId(e, t)]),
              (this.voiceScale =
                this.scaleByVoice[this.getCurrentVoiceId(e, t)]),
          ...
          (_.prototype.createABCLine = function (e, t, r) {
            ...
            for (var a = 0; a < e.length; a++)
              T && this.restoreState(),
                (T = !1),
                this.createABCStaff(n, e[a], t, a, r);
            return n;
          }),
          (_.prototype.createABCStaff = function (e, t, r, n, a) {
            ...
            for (var c = 0; c < t.voices.length; c++) {
              ...
              var u =
                (!this.initialClef || 0 === a) && s(t.clef, this.tuneNumber);
              u &&
                (0 === c &&
                  t.barNumber &&
                  this.addMeasureNumber(t.barNumber, u),
                h.addChild(u),
              ...
              if ((d && (h.addChild(d), (this.startlimitelem = d)), t.meter)) {
                "specified" === t.meter.type
                  ? (this.measureLength =
                      t.meter.value[0].num / t.meter.value[0].den)
          ...
          (_.prototype.createABCVoice = function (e, t, r, a, i, s) {
            ...
            for (var f = 0 === r, p = 0; p < this.abcline.length; ) {
              var m = A(this.abcline, p),
                b = this.createABCElement(f, i, s, m.elem);
              if (b)
          ...
          (_.prototype.saveState = function () {
            (this.tiesSave = k.cloneArray(this.ties)),
              ...
              (this.tiesbyvoiceSave = k.cloneHashOfArrayOfHash(
                this.tiesbyvoice
              ));
          }),
          (_.prototype.restoreState = function () {
            (this.ties = k.cloneArray(this.tiesSave)),
              ...
              (this.tiesbyvoice = k.cloneHashOfArrayOfHash(
                this.tiesbyvoiceSave
              ));
          }),
          (_.prototype.createABCElement = function (e, t, r, a) {
            var i = [];
            switch (a.el_type) {
              case void 0:
                i = this.createBeam(t, r, a);
                break;
              case "note":
                (i[0] = this.createNote(a, !1, t, r)),
                  this.triplet &&
                ...
                break;
              case "bar":
                (i[0] = this.createBarLine(r, a, e)),
                  r.duplicate && i.length > 0 && (i[0].invisible = !0);
                break;
              case "meter":
                (i[0] = l(a, this.tuneNumber)),
                  (this.startlimitelem = i[0]),
                  r.duplicate && i.length > 0 && (i[0].invisible = !0);
                break;
              case "clef":
                if (((i[0] = s(a, this.tuneNumber)), !i[0])) return null;
                r.duplicate && i.length > 0 && (i[0].invisible = !0);
                break;
              case "key":
                var h = o(a, this.tuneNumber);
                h && ((i[0] = h), (this.startlimitelem = i[0])),
                  r.duplicate && i.length > 0 && (i[0].invisible = !0);
                break;
              case "stem":
                this.stemdir = "auto" === a.direction ? void 0 : a.direction;
                break;
              case "part":
                var u = new n(a, 0, 0, "part", this.tuneNumber),
                  d = this.getTextSize.calc(a.title, "partsfont", "part");
                u.addFixedX(
                  new f(a.title, 0, 0, void 0, {
                    type: "part",
              ...
              case "tempo":
                ...
                m.addFixedX(new g(a, this.tuneNumber, c)), (i[0] = m);
                break;
              case "style":
              ...
              default:
                ...
                v.addFixed(
                  new f("element type " + a.el_type, 0, 0, void 0, {
                    type: "debug",
                  })
                ),
                  (i[0] = v);
          ...
          (_.prototype.createBeam = function (e, t, r) {
            var n = [],
              i = new a(
            ...
            T && i.setHint();
            for (var s = 0; s < r.length; s++) i.runningDirection(r[s]);
            i.setStemDirection();
            var o = this.stemdir;
            for (
              this.stemdir = i.stemsUp ? "up" : "down", s = 0;
              s < r.length;
              s++
            ) {
              var c = r[s],
            ...
            return i.calcDir(), t.addBeam(i), (this.stemdir = o), n;
          });
        var N = function (e) {
            var t;
            do {
          ...
          M = function (e, t, r, n, a, i, s, o, c) {
            for (var l = r; l > 11; l--)
              l % 2 != 0 ||
                n ||
                e.addFixed(new f(null, o, (a + 4) * c, l, { type: "ledger" }));
            for (l = t; l < 1; l++)
              l % 2 != 0 ||
                n ||
                e.addFixed(new f(null, o, (a + 4) * c, l, { type: "ledger" }));
            for (l = 0; l < i.length; l++) {
              ...
              "down" === s && (h = -h),
                e.addFixed(
                  new f(null, h + o, (a + 4) * c, i[l], { type: "ledger" })
                );
            }
          };
        function B(e, t) {
        ...
        (_.prototype.addGraceNotes = function (e, t, r, n, i, s, o) {
          var l = 0.6;
          i = Math.round(0.7 * i);
          var h,
            u,
          ...
          e.gracenotes.length > 1 &&
            ((p = new a(i, "grace", s)), T && p.setHint(), (p.mainNote = r));
          var m = [];
          for (u = e.gracenotes.length - 1; u >= 0; u--)
            (o += 10), (m[u] = o), e.gracenotes[u].accidental && (o += 7);
          for (u = 0; u < e.gracenotes.length; u++) {
            var g = e.gracenotes[u].verticalPos;
            h = p ? null : S.uflags[s ? 5 : 3];
            ...
            b.notehead.highestVert = b.notehead.pitch + i;
            var y = b.notehead;
            if (
              (this.addSlursAndTies(r, e.gracenotes[u], y, t, "up", !0),
              r.addExtra(y),
              e.gracenotes[u].acciaccatura)
            ) {
              var w = e.gracenotes[u].verticalPos + 4.2,
                x = p ? 5 : 6;
              r.addRight(
                new f("flags.ugrace", -m[u] + x, 0, w, { scalex: l, scaley: l })
              );
            }
            if (p) {
            ...
            0 !== u ||
              ...
              !this.graceSlurs ||
              N ||
              t.addOther(new v({ anchor1: y, anchor2: n, isGrace: !0 }));
          }
          return p && (p.calcDir(), t.addBeam(p)), o;
        }),
          (_.prototype.addNoteToAbcElement = function (
            e,
            t,
            r,
            n,
            ...
            for (
              n && (_ = n),
                ((a = t.style ? t.style : a) && "normal" !== a) || (a = "note"),
                (m = i ? S[a].nostem : S[a][-s]) ||
                  console.log("noteSymbol:", a, s, i),
                g = "down" === _ ? t.pitches.length - 2 : 1;
              "down" === _ ? g >= 0 : g < t.pitches.length;
              g = "down" === _ ? g - 1 : g + 1
            ) {
              var A = t.pitches["down" === _ ? g + 1 : g - 1],
                E = t.pitches[g],
                N = "down" === _ ? A.pitch - E.pitch : E.pitch - A.pitch;
              N <= 1 &&
                !A.printer_shift &&
                ((E.printer_shift = N ? "different" : "same"),
                (E.verticalPos > 11 || E.verticalPos < 1) &&
                  w.push(E.verticalPos - (E.verticalPos % 2)),
                "down" === _
                  ? (b = d.getSymbolWidth(m) + 2)
                  : (v = d.getSymbolWidth(m) + 2));
            }
            var M = t.pitches.length;
            for (g = 0; g < t.pitches.length; g++) {
              var P, L;
              if (
                (o ||
                  (P =
                    ("down" === _ && 0 !== g) || ("up" === _ && g !== M - 1)
                      ? null
                      : S["down" === _ ? "dflags" : "uflags"][-s]),
                t.pitches[g].style)
              )
                L = S[t.pitches[g].style][-s];
              else if (l.isPercussion && this.percmap) {
                L = m;
                var H = this.percmap[x(t.pitches[g])];
                H && H.noteHead && S[H.noteHead] && (L = S[H.noteHead][-s]);
              } else L = m;
              if (
                ...
                if (
                  ((t.startSlur || 1 === M) &&
                    ((t.pitches[g].highestVert = t.pitches[M - 1].verticalPos),
                    C(t) < 1 &&
                      ("up" === n || "up" === _) &&
                      (t.pitches[g].highestVert += 6)),
                  t.startSlur)
                )
                  for (
                    t.pitches[g].startSlur || (t.pitches[g].startSlur = []),
                      p = 0;
                    p < t.startSlur.length;
                    p++
                  )
            ...
            if (O) {
              var F = Math.round(70 * this.voiceScale) / 10,
                D = "down" === _ ? t.minpitch - F : t.minpitch + 1 / 3;
              D > 6 && !n && (D = 6);
              var I = "down" === _ ? t.maxpitch - 1 / 3 : t.maxpitch + F;
              I < 6 && !n && (I = 6);
              var j = "down" === _ || 0 === e.heads.length ? 0 : e.heads[0].w,
                V = "down" === _ ? 1 : -1;
              h &&
                "noteheads.slash.quarter" === h.c &&
                ("down" === _ ? (I -= 1) : (D += 1)),
                e.addRight(
                  new f(null, j, 0, D, {
                    type: "stem",
          ...
          (_.prototype.addLyric = function (e, t) {
            var r = "";
            k.each(t.lyric, function (e) {
          ...
          (_.prototype.createNote = function (e, t, r, a) {
            var i,
              s = null,
              o = 0,
              l = 0,
            ...
            0 === p && ((m = !0), (p = 0.25), (t = !0));
            for (
              var g = Math.floor(Math.log(p) / Math.log(2)),
                v = 0,
                y = Math.pow(2, g),
                x = y / 2;
              y < p;
            ...
            e.rest && "multimeasure" === e.rest.type && (k = 1),
              e.rest &&
                "invisible-multimeasure" === e.rest.type &&
                (k = this.measureLength * e.rest.text);
            var _ = e.rest ? "rest" : "note",
              A = new n(e, k, 1, _, this.tuneNumber, {
                durationClassOveride: e.duration * this.tripletmultiplier,
              });
            if ((T && A.setHint(), e.rest)) {
              this.measureLength === p &&
                "invisible" !== e.rest.type &&
                "spacer" !== e.rest.type &&
                e.rest.type.indexOf("multimeasure") < 0 &&
                (e.rest.type = "whole");
              var E = (function (e, t, r, n, a, i, s, o, l) {
                var h,
                  u,
                  p,
                  m,
                ...
                switch (
                  ...
                  case "whole":
                    ...
                    break;
                  case "rest":
                    (h = "rhythm" === t.style ? S.rhythm[-o] : S.rest[-o]),
                      (t.averagepitch = g),
                      (t.minpitch = g),
                      (t.maxpitch = g);
                    break;
                  ...
                  case "multimeasure":
                    ...
                    var b = new f("" + t.rest.text, v, v, 16, {
                ...
                if (
                  ...
                  "invisible" !== t.rest.type
                ) {
                  var y = c(e, h, { verticalPos: g }, { dot: n, scale: l });
                  (u = y.notehead) &&
                    (e.addHead(u), (p = y.accidentalshiftx), (m = y.dotshiftx));
                }
              ...
              (s = E.noteHead), (o = E.roomTaken), (l = E.roomTakenRight);
            } else {
              var N = this.addNoteToAbcElement(
                A,
                e,
                v,
                this.stemdir,
            ...
            if (
              (void 0 !== e.lyric && this.addLyric(A, e),
              void 0 !== e.gracenotes &&
              ...
              e.barNumber &&
                A.addFixed(
                  new f(e.barNumber, -10, 0, 0, { type: "barNumber" })
                ),
              M(A, e.minpitch, e.maxpitch, e.rest, h, u, i, -2, 1),
              void 0 !== e.chord)
            ) {
              var B = w(this.getTextSize, A, e, o, l, h, this.jazzchords);
              (o = B.roomTaken), (l = B.roomTakenRight);
            }
            return (
              e.startTriplet &&
                (this.triplet = new b(e.startTriplet, s, {
          ...
          (_.prototype.addSlursAndTies = function (e, t, r, n, a, i) {
            if (t.endTie && this.ties.length > 0) {
              for (var s = !1, o = 0; o < this.ties.length; o++)
                if (
                  ...
                  this.ties[o].setEndAnchor(r),
                    n.setRange(this.ties[o]),
                    this.ties.splice(o, 1),
                    (s = !0);
                  break;
                }
              s ||
                (this.ties[0].setEndAnchor(r),
                n.setRange(this.ties[0]),
            ...
            if (t.endSlur)
              ...
              for (var f in this.slurs)
                this.slurs.hasOwnProperty(f) &&
                  this.slurs[f].addInternalNote(r);
            if (t.startSlur)
              for (d = 0; d < t.startSlur.length; d++)
                (l = t.startSlur[d].label),
                  (c = new v({
                    ...
                    stemDir: this.stemdir,
                    voiceNumber: h,
                    style: t.startSlur[d].style,
                  })),
                  T && c.setHint(),
                  (this.slurs[l] = c),
                  n.addOther(c);
          }),
          (_.prototype.addMeasureNumber = function (e, t) {
            var r = this.getTextSize.calc(e, "measurefont", "bar-number"),
              n = 0;
            t.isClef && (n += r.width / 2);
            var a = r.width > 10 && "treble" === t.abcelem.type ? 13 : 11;
            t.addFixed(
              new f(e, n, r.width, a + r.height / p.STEP, {
                type: "barNumber",
                dim: this.getTextSize.attr("measurefont", "bar-number"),
              })
            );
          }),
          (_.prototype.createBarLine = function (e, t, r) {
            var a = new n(t, 0, 10, "bar", this.tuneNumber),
              i = null,
              s = 0;
            t.barNumber && this.addMeasureNumber(t.barNumber, a);
            var o =
                "bar_right_repeat" === t.type || "bar_dbl_repeat" === t.type,
              c =
            ...
            if (o || d) {
              for (var p in this.slurs)
                this.slurs.hasOwnProperty(p) && this.slurs[p].setEndX(a);
              this.startlimitelem = a;
            }
            if (
              (o &&
                (a.addRight(new f("dots.dot", s, 1, 7)),
                a.addRight(new f("dots.dot", s, 1, 5)),
                (s += 6)),
              c &&
                ((i = new f(null, s, 1, 2, {
                  type: "bar",
              ...
              this.partstartelem &&
                t.endEnding &&
                ((this.partstartelem.anchor2 = i), (this.partstartelem = null)),
              h &&
                ((i = new f(null, (s += 3), 1, 2, {
                  type: "bar",
                  pitch2: 10,
                  linewidth: 0.6,
                })),
              ...
              var m = this.getTextSize.calc(
                t.startEnding,
                "repeatfont",
                ""
              ).width;
              (a.minspacing += m + 10),
                (this.partstartelem = new u(t.startEnding, i, null)),
                e.addOther(this.partstartelem);
            }
            return (
              (a.extraw -= 5),
              void 0 !== t.chord && w(this.getTextSize, a, t, 0, 0, 0, !1),
              a
            );
          }),
          (e.exports = _);
          ...
          (t.prototype.calcDir = function () {
            (this.average = r(this.total, this.elems.length)),
              this.forceup
                ...
                : (this.stemsUp = this.average < 6);
            for (
              var e = this.stemsUp ? "up" : "down", t = 0;
              t < this.elems.length;
              t++
            )
              for (var n = 0; n < this.elems[t].heads.length; n++)
                this.elems[t].heads[n].stemDir = e;
          }),
          (e.exports = t);
      },
      355: function (e) {
      ...
      7561: function (e, t, r) {
        ...
        e.exports = function (e, t) {
          ...
          switch (((o.isClef = !0), e.type)) {
            ...
            default:
              o.addFixed(
                new i("clef=" + e.type, 0, 0, void 0, { type: "debug" })
              );
          }
          if (r) {
            var c = a.symbolHeightInPitches(r),
              l = (function (e) {
                switch (e) {
                  case "clefs.G":
                    return -5;
            ...
            if (
              (o.addRight(
                new i(r, 5, a.getSymbolWidth(r), e.clefPos, {
                  top: c + e.clefPos + l,
                  bottom: e.clefPos + l,
                })
              ),
              ...
              var h = 2 / 3,
                u = (a.getSymbolWidth(r) - a.getSymbolWidth("8") * h) / 2,
                d = s > 0 ? o.top + 3 : o.bottom - 1,
                f = s > 0 ? o.top + 3 : o.bottom - 3,
                p = f - 2;
              "bass-8" === e.type && ((d = 3), (u = 0)),
                o.addRight(
                  new i("8", 5 + u, a.getSymbolWidth("8") * h, d, {
                    scalex: h,
                    scaley: h,
                    top: f,
                    bottom: p,
      ...
      6166: function (e, t, r) {
        ...
        e.exports = function (e, t) {
          if (
            ...
            !e.accidentals || 0 === e.accidentals.length)
          )
            return null;
          ...
          return (
            s.each(
              ...
              function (e) {
                ...
                r.addRight(
                  new i(t, o, a.getSymbolWidth(t), e.verticalPos, {
                    thickness: a.symbolHeightInPitches(t),
                    top: e.verticalPos + a.symbolHeightInPitches(t) + n,
                    bottom: e.verticalPos + n,
                  })
                ),
                  (o += a.getSymbolWidth(t) + 2);
              },
              this
            ),
            r
      ...
      3268: function (e, t, r) {
        ...
        e.exports = function (e, t, r, i) {
          i || (i = {});
          var s,
            o = void 0 !== i.dir ? i.dir : null,
            c = void 0 !== i.headx ? i.headx : 0,
            l = void 0 !== i.extrax ? i.extrax : 0,
            h = void 0 !== i.flag ? i.flag : null,
            u = void 0 !== i.dot ? i.dot : 0,
            d = void 0 !== i.dotshiftx ? i.dotshiftx : 0,
            f = void 0 !== i.scale ? i.scale : 1,
            p = void 0 !== i.accidentalSlot ? i.accidentalSlot : [],
            m = void 0 !== i.shouldExtendStem && i.shouldExtendStem,
            g = void 0 === i.printAccidentals || i.printAccidentals,
            v = r.verticalPos,
            b = 0,
            y = 0,
            w = 0;
          if (void 0 === t)
            e.addFixed(new a("pitch is undefined", 0, 0, 0, { type: "debug" }));
          else if ("" === t) s = new a(null, 0, 0, v);
          else {
            var x = c;
            if (r.printer_shift) {
            ...
            if (
              (((s = new a(t, x, n.getSymbolWidth(t) * f, v, C)).stemDir = o),
              h)
            ) {
              ...
              m &&
                ("down" === o && T > 6 && (T = 6),
                "up" === o && T < 6 && (T = 6));
              var S = "down" === o ? c : c + s.w - 0.6;
              e.addRight(
                new a(h, S, n.getSymbolWidth(h) * f, T, {
                  scalex: f,
                  scaley: f,
                })
              );
          ...
          if ((s && (s.highestVert = r.highestVert), g && r.accidental)) {
            ...
            switch (r.accidental) {
              case "quartersharp":
                A = "accidentals.halfsharp";
                break;
              case "dblsharp":
                A = "accidentals.dblsharp";
                break;
              case "sharp":
                A = "accidentals.sharp";
                break;
              case "quarterflat":
                A = "accidentals.halfflat";
                break;
              case "flat":
                A = "accidentals.flat";
                break;
            ...
            for (var E = !1, N = l, M = 0; M < p.length; M++)
              if (v - p[M][0] >= 6) {
                (p[M][0] = v), (N = p[M][1]), (E = !0);
                break;
              }
            !1 === E &&
              ((N -= n.getSymbolWidth(A) * f + 2),
              p.push([v, N]),
              (b = n.getSymbolWidth(A) * f + 2));
            var B = n.symbolHeightInPitches(A);
            e.addExtra(
              new a(A, N, n.getSymbolWidth(A), v, {
                scalex: f,
                scaley: f,
                top: v + B / 2,
                bottom: v - B / 2,
          ...
          if ("specified" === e.type)
            for (var s = 0, o = 0; o < e.value.length; o++)
              if (
                (0 !== o &&
                  (r.addRight(
                    new i("+", s + 1, a.getSymbolWidth("+"), 6, {
                      thickness: a.symbolHeightInPitches("+"),
                    })
                  ),
                  (s += a.getSymbolWidth("+") + 2)),
                e.value[o].den)
              ) {
                ...
                var u = Math.max(c, h);
                r.addRight(
                  new i(e.value[o].num, s + (u - c) / 2, c, 8, {
                    thickness: a.symbolHeightInPitches(
                      e.value[o].num.charAt(0)
                    ),
                  })
                ),
                  r.addRight(
                    new i(e.value[o].den, s + (u - h) / 2, h, 4, {
                      thickness: a.symbolHeightInPitches(
                        e.value[o].den.charAt(0)
                      ),
                    })
                  ),
                  (s += u);
            ...
            "common_time" === e.type
              ? r.addRight(
                  new i(
                    "timesig.common",
                    0,
                    a.getSymbolWidth("timesig.common"),
                    6,
              ...
              : "cut_time" === e.type
              ? r.addRight(
                  new i("timesig.cut", 0, a.getSymbolWidth("timesig.cut"), 6, {
              ...
              ? r.addRight(
                  new i(
                    "timesig.imperfectum",
                    0,
                    a.getSymbolWidth("timesig.imperfectum"),
                    6,
                    {
              ...
              ? r.addRight(
                  new i(
                    ...
                    0,
                    a.getSymbolWidth("timesig.imperfectum2"),
                    6,
                    {
                      thickness: a.symbolHeightInPitches(
                        "timesig.imperfectum2"
              ...
              ? r.addRight(
                  new i(
                    "timesig.perfectum",
                    0,
                    a.getSymbolWidth("timesig.perfectum"),
                    6,
              ...
              ? r.addRight(
                  new i(
                    "timesig.perfectum2",
                    0,
                    a.getSymbolWidth("timesig.perfectum2"),
                    6,
      ...
      7841: function (e, t, r) {
        var n = r(5672),
          ...
          h = function (e, t, r, n, a) {
            function i(e, t) {
              ...
              c += "down" === a ? -5 : 3;
              for (var l = 0; l < t; l++)
                (i -= 1), n.addFixedX(new o(e, c, s.getSymbolWidth(e), i));
            }
        ...
        (l.prototype.dynamicDecoration = function (e, t, r, n) {
          for (var s, o, c, l = 0; l < t.length; l++)
            switch (t[l]) {
              case "diminuendo(":
                ...
                break;
              case "diminuendo)":
                (s = { start: this.startDiminuendoX, stop: r }),
                  (this.startDiminuendoX = void 0);
                break;
              case "crescendo(":
          ...
          s && e.addOther(new a(s.start, s.stop, ">", n)),
            o && e.addOther(new a(o.start, o.stop, "<", n)),
            c && e.addOther(new i(c.start, c.stop));
        }),
          (l.prototype.createDecoration = function (
            e,
            t,
            r,
            a,
            ...
            f ||
              ...
              })(e, t, i, f.volumePosition),
              this.dynamicDecoration(e, t, i, f.dynamicPosition),
              h(t, 0, a, i, u);
            var m = (function (e, t, r, n, a, i, l, h) {
              for (var u, d = 0; d < t.length; d++) {
                if (
                  ...
                  r > 9 && u++;
                  var p = n / 2;
                  "center" !== s.getSymbolAlign(f) &&
                    (p -= s.getSymbolWidth(f) / 2),
                    a.addFixedX(new o(f, p, s.getSymbolWidth(f), u));
                }
                if ("slide" === t[d] && a.heads[0]) {
                  var m = a.heads[0].pitch,
                    g = new o("", -i - 15, 0, (m -= 2) - 1),
                    v = new o("", -i - 5, 0, m + 1);
                  a.addFixedX(g),
                    a.addFixedX(v),
                    e.addOther(new c({ anchor1: g, anchor2: v, fixedY: !0 }));
                }
              }
              return void 0 === u && (u = r), { above: u, below: a.bottom };
            })(e, t, r, a, i, l, u, d);
            (m.above = Math.max(m.above, this.minTop)),
              (function (e, t, r, n, a, i, c) {
                ...
                function d(e, n) {
                  ...
                  var i = s.symbolHeightInPitches(e) + 1,
                    c = h(n);
                  (c = "above" === n ? c + i / 2 : c - i / 2),
                    r.addFixedX(
                      new o(e, a, s.getSymbolWidth(e), c, {
                        klass: "ornament",
              ...
              })(t, a, i, m, f.ornamentPosition, this.minTop, this.minBottom),
              (function (e, t, r) {
                  ...
                  if ("arpeggio" === e[n])
                    for (
                      ...
                      t.addExtra(
                        new o(
                          "scripts.arpeggio",
                          2 * -s.getSymbolWidth("scripts.arpeggio") - r,
                          0,
                          a + 2,
                          {
                            klass: "ornament",
                            thickness:
                              s.symbolHeightInPitches("scripts.arpeggio"),
                          }
                        )
                      );
              })(t, i, l);
      ...
      5132: function (e, t, r) {
        ...
        (b.prototype.reset = function () {
          ...
          (b.prototype.getMeasureWidths = function (e) {
            ...
            for (var t, r = [], n = !0, a = 0; a < e.lines.length; a++) {
              var i = e.lines[a];
              if (i.staff) {
                if (
                  (n &&
                    ((t = { left: 0, measureWidths: [], total: 0 }),
                    r.push(t),
                    (n = !1)),
                  i.staffGroup.voices.length > 0)
                )
                  for (
                    var s = i.staffGroup.voices[0], o = !1, c = 0, l = 0;
                    l < s.children.length;
                    l++
                  ) {
                    var h = s.children[l];
                    o ||
                      h.isClef ||
                      h.isKeySig ||
                      ((o = !0), (t.left = h.x), (c = h.x)),
                      "bar" === h.type &&
                        (t.measureWidths.push(h.x - c),
                        (t.total += h.x - c),
                        (c = h.x));
                  }
              } else n = !0;
          ...
          (b.prototype.setupTune = function (e, t) {
            this.classes.reset(),
              void 0 !== e.formatting.jazzchords &&
                (this.jazzchords = e.formatting.jazzchords),
              this.renderer.newTune(e),
              (this.engraver = new a(this.getTextSize, t, {
          ...
          (b.prototype.constructTuneElements = function (e) {
            ...
            for (t = 0; t < e.lines.length; t++)
              if ((r = e.lines[t]).staff)
                ...
                if (a) {
                  var i = this.width / 2 + this.renderer.padding.left;
                  r.nonMusic = new c(
          ...
          (b.prototype.engraveTune = function (e, t, r) {
            ...
            this.constructTuneElements(e);
            var a = d(this.renderer, e, this.width, this.space);
            ...
            if (
              ((this.staffgroups = i.staffgroups),
              (this.selectables = i.selectables),
              this.oneSvgPerLine)
            ) {
              var s = this.renderer.paper.svg.parentNode;
              this.svgs = (function (e, t, r) {
                t || (t = "Untitled");
                var n = e.querySelector("svg");
                "resize" === r && (e.style.paddingBottom = "");
                for (
                  var a = n.querySelector("style"),
                    i =
                      "resize" === r
                        ? n.viewBox.baseVal.width
                        : n.getAttribute("width"),
                    s = e.querySelectorAll("svg > g"),
                    o = 0,
                    c = [],
                    l = 0;
                  l < s.length;
                  ...
                  var h = s[l],
                    ...
                    m = "overflow: hidden;";
                  "resize" !== r && (m += "height:" + f + "px;"),
                    p.setAttribute("style", m);
                  var g = y(n),
                    v = 'Sheet Music for "' + t + '" section ' + (l + 1);
                  g.setAttribute("aria-label", v),
                    "resize" !== r && g.setAttribute("height", f),
                    "resize" === r && (g.style.position = ""),
                    g.setAttribute("viewBox", "0 " + o + " " + i + " " + f),
                    g.appendChild(a.cloneNode(!0));
                ...
                return e.removeChild(n), c;
              })(s, e.metaText.title, this.responsive);
        ...
        var n = r(8613),
          ...
          i = function (e) {
            for (var t = [], r = 0, n = e.length; r < n; r++) {
              t[r] = [];
              for (var a = 0, i = e[r].length; a < i; a++) t[r][a] = e[r][a];
            }
            return t;
          },
          s = {
            ...
            getPathForSymbol: function (e, t, r, n, s) {
              if (((n = n || 1), (s = s || 1), !a[r])) return null;
              var o = i(a[r].d);
              return (
                (1 === n && 1 === s) ||
                  (function (e, t, r) {
      ...
      1577: function (e) {
        var t = function (e, t, r, n, a) {
          switch (
            ...
            a.dim && (this.dim = a.dim),
            a.position && (this.position = a.position),
            (this.height = a.height ? a.height : 4),
            a.top && (this.top = a.top),
            a.bottom && (this.bottom = a.bottom),
            a.name
              ? (this.name = a.name)
              : this.c
              ? (this.name = this.c)
        ...
        (t.prototype.getChordDim = function () {
          ...
          (t.prototype.invertLane = function (e) {
            void 0 === this.lane && (this.lane = 0),
              (this.lane = e - this.lane - 1);
          }),
        ...
        (i.prototype.reset = function () {
          ...
          (i.prototype.setVerticalSpace = function (e) {
            void 0 !== e.staffsep &&
              ...
              void 0 !== e.textspace &&
                (this.spacing.text = (4 * e.textspace) / 3),
              void 0 !== e.musicspace &&
              ...
              void 0 !== e.topspace &&
                (this.spacing.top = (4 * e.topspace) / 3),
              void 0 !== e.vocalspace &&
          ...
          i = function (e, t, r) {
            (this.type = "TempoElement"),
              ...
              this.tempo.duration &&
                ...
                (this.note = this.createNote(r, e, t));
          };
        (i.prototype.setX = function (e) {
          this.x = e;
        }),
          (i.prototype.createNote = function (e, t, r) {
            ...
            l <= 1 / 32
              ? ((o = "noteheads.quarter"), (s = "flags.u32nd"), (i = 0))
              : l <= 1 / 16
              ? ((o = "noteheads.quarter"), (s = "flags.u16th"), (i = 0))
              : l <= 3 / 32
              ? ((o = "noteheads.quarter"), (s = "flags.u16nd"), (i = 1))
              : l <= 1 / 8
              ? ((o = "noteheads.quarter"), (s = "flags.u8th"), (i = 0))
              : l <= 3 / 16
              ? ((o = "noteheads.quarter"), (s = "flags.u8th"), (i = 1))
              : l <= 1 / 4
              ? ((o = "noteheads.quarter"), (i = 0))
              : l <= 3 / 8
              ? ((o = "noteheads.quarter"), (i = 1))
              : l <= 0.5
              ? ((o = "noteheads.half"), (i = 0))
              : l <= 3 / 4
              ? ((o = "noteheads.half"), (i = 1))
              : l <= 1
              ? ((o = "noteheads.whole"), (i = 0))
              : l <= 1.5
              ? ((o = "noteheads.whole"), (i = 1))
              : l <= 2
              ? ((o = "noteheads.dbl"), (i = 0))
              : ((o = "noteheads.dbl"), (i = 1));
            var u,
              d = e(
                ...
                o,
                { verticalPos: 0 },
                { dir: "up", flag: s, dot: i, scale: c }
              ).notehead;
            if (
              (h.addHead(d), "noteheads.whole" !== o && "noteheads.dbl" !== o)
            ) {
              var f = d.dx + d.w;
              (u = new a(null, f, 0, 0.25, {
                type: "stem",
                pitch2: 3.75,
                linewidth: -0.6,
              })),
        ...
        (t.prototype.addInternalNote = function (e) {
          ...
          (t.prototype.setEndAnchor = function (e) {
            (this.anchor2 = e),
              this.anchor1
                ? ((this.top =
                    Math.max(this.anchor1.pitch, this.anchor2.pitch) + 4),
                  (this.bottom =
                    Math.min(this.anchor1.pitch, this.anchor2.pitch) - 4))
      ...
      7193: function (e) {
        var t = function (e, t, r) {
          (this.type = "TripletElem"),
            ...
            (this.durationClass = (
              "d" +
              Math.round(1e3 * t.parent.durationClass) / 1e3
            ).replace(/\./, "-")),
            (this.middleElems = []),
            (this.flatBeams = r.flatBeams);
        };
        (t.prototype.isClosed = function () {
          ...
          (t.prototype.setCloseAnchor = function (e) {
            (this.anchor2 = e),
              (this.anchor1.parent.beam && "up" !== this.anchor1.stemDir) ||
      ...
      8462: function (e) {
        ...
        (t.prototype.addChild = function (e) {
          ...
          (t.prototype.adjustRange = function (e) {
            void 0 !== e.bottom &&
              (this.bottom = Math.min(this.bottom, e.bottom)),
      ...
      347: function (e, t, r) {
        var n = r(1577),
          a = r(8613),
          i = r(2854);
        e.exports = function (e, t, r, s, o, c, l) {
          for (var h = 0; h < r.chord.length; h++)
            for (
              var u = r.chord[h].position,
                d = r.chord[h].rel_position,
                f = r.chord[h].name.split("\n"),
                p = f.length - 1;
              p >= 0;
              p--
            ) {
              ...
              "above" === u ||
              d
                ? ((g = "annotationfont"), (v = "annotation"))
                : ((g = "gchordfont"), (v = "chord"), l && (b = i(b)));
              var w = e.attr(g, v),
                x = e.calc(b, g, v),
                k = x.width,
                C = x.height / a.STEP;
              switch (u) {
                ...
                default:
                  if (d) {
                    var T = d.y + 3 * a.STEP;
                    t.addRight(
                      new n(b, y + d.x, 0, r.minpitch + T / a.STEP, {
                        position: "relative",
                        type: "text",
                        height: C,
                        dim: w,
                    ...
                    var S = "above";
                    r.positioning &&
                      r.positioning.chordPosition &&
                      (S = r.positioning.chordPosition),
                      "hidden" !== S &&
                        t.addCentered(
                          new n(b, c / 2, k, void 0, {
                            type: "chord",
                            position: S,
                            height: C,
                            dim: w,
        ...
        e.exports = function (e, t, r) {
          if (t.text) {
            ...
            t.absElemType && (n.absElemType = t.absElemType),
              ...
              e.push(n);
            var a = r.calc("A", t.font, t.klass),
              i = t.text.split("\n").length;
            if (("\n" === t.text[t.text.length - 1] && i--, !t.noMove)) {
              var s = 1.1 * a.height * i;
              e.push({ move: Math.round(s) }),
        ...
        function a(e, t, r, n, a, i) {
          (this.rows = []),
            e.unalignedWords &&
              ...
              this.unalignedWords(e.unalignedWords, n, a, i),
            this.extraText(e, n, a, i),
            e.footer && r && this.footer(e.footer, t, n, i);
        }
        (a.prototype.unalignedWords = function (e, t, r, a) {
          var i = "meta-bottom unaligned-words",
            s = "wordsfont";
          this.rows.push({
          ...
          for (var c = 0; c < e.length; c++)
            if ("" === e[c]) this.rows.push({ move: o.height });
              ...
              for (var l = 0, h = 0, u = 0; u < e[c].length; u++) {
                ...
                var p = a.calc(d.text, s, i);
                (l = Math.max(l, p.height)),
                  (h += p.width),
                  " " === d.text[d.text.length - 1] && (h += o.width);
              }
          ...
          (a.prototype.footer = function (e, t, r, a) {
            var i = "header meta-bottom",
              s = "footerfont";
            this.rows.push({ startGroup: "footer", klass: i }),
              n(
                this.rows,
                {
                  marginLeft: r,
        ...
        (t.prototype.reset = function () {
          ...
          (t.prototype.measureTotal = function () {
            for (var e = 0, t = 0; t < this.lineNumber; t++)
              e += this.measureTotalPerLine[t]
                ? this.measureTotalPerLine[t]
                : 0;
      ...
      4750: function (e, t, r) {
        ...
        e.exports = function (e, t, r, c, l) {
          if (!t.invisible) {
            var h =
              t.children.length > 0 && "TempoElement" === t.children[0].type;
            (t.elemset = []), o.beginGroup(e.paper, e.controller);
            for (var u = 0; u < t.children.length; u++) {
              var d = t.children[u];
              "TempoElement" === d.type ? n(e, d) : a(e, d, r);
            }
            var f = t.type;
            if (
              ...
              (f = (f +=
                " d" + Math.round(1e3 * t.durationClass) / 1e3).replace(
                /\./g,
                "-"
              )),
              t.abcelem.pitches)
            )
              for (var p = 0; p < t.abcelem.pitches.length; p++)
                f += " p" + t.abcelem.pitches[p].pitch;
            ...
            if (m)
              if (h)
                ...
                t.elemset.push(m);
                var g = !1;
                ("note" !== t.type && "tabNumber" !== t.type) || (g = !0),
                  c.add(t, m, g, l);
              }
            else
              t.elemset.length > 0 &&
                c.add(t, t.elemset[0], "note" === t.type, l);
            if (
              ...
              t.notePositions = [];
              for (var v = 0; v < t.heads.length; v++)
                t.notePositions.push({
                  x: t.heads[v].x + t.heads[v].w / 2,
                  y: l.zero - t.heads[v].pitch * i.STEP,
                });
            }
          }
        };
      ...
      7489: function (e, t, r) {
        ...
        function i(e, t, r, n, i, s) {
          (r = a(e.calcY(r))), (i = a(e.calcY(i))), (t = a(t)), (n = a(n));
          var o = a(r + s);
          return (
            "M" +
            t +
            ...
            for (var r = "", a = 0; a < t.beams.length; a++) {
              ...
              if (o.split) {
                ...
                for (h = 0; h < l.length; h++) {
                  ...
                  r += i(e, l[h][0], u, l[h][1], d, o.dy);
                }
              } else r += i(e, o.startX, o.startY, o.endX, o.endY, o.dy);
            }
      ...
      129: function (e, t, r) {
        ...
        var o = function (e, t, r, o, c, l, h) {
          ...
          if (l) {
            ...
            var d = r + (o - r) / 2;
            (d -= e.controller.getTextSize.baselineToCenter(
              l,
              "voicefont",
              "staff-extra voice-name",
              0,
              ...
              ? (u = (function (e, t, r, n, a) {
                  var i = n - r,
                    o = s(
                      ...
                      [0, i / 5.5, i / 3.14, i / 2, i / 2.93, i / 4.88, 0]
                    );
                  return (
                    (o += s(
                      t,
                      ...
                      [i / 2, i / 1.46, i / 1.22, i, i / 1.19, i / 1.42, i / 2]
                    )),
                    e.paper.path({
                      path: o,
                      stroke: e.foregroundColor,
                      fill: e.foregroundColor,
                      class: e.controller.classes.generate(a),
                      "data-name": a,
                    })
                  );
                })(e, t, r, o, c))
        ...
        e.exports = function (e, t, r) {
          var n = t.startVoice.staff.absoluteY - 10 * a.STEP;
          return (
            t.endVoice && t.endVoice.staff
              ? (t.endY = t.endVoice.staff.absoluteY - 2 * a.STEP)
              : t.lastContinuedVoice && t.lastContinuedVoice.staff
              ? (t.endY = t.lastContinuedVoice.staff.absoluteY - 2 * a.STEP)
              : (t.endY = t.startVoice.staff.absoluteY - 2 * a.STEP),
      ...
      3245: function (e, t, r) {
        ...
        e.exports = function (e, t, r) {
          ...
          var n,
            a = e.calcY(t.pitch) + 4,
            i = t.anchor1 ? t.anchor1.x : 0,
            o = t.anchor2 ? t.anchor2.x : 800;
          return (
            (n =
              "<" === t.dir
                ? s(e, a + 4, a, a + 4, a + 8, i, o)
                : s(e, a, a + 4, a + 8, a + 4, i, o)),
            r.wrapSvgEl(
      ...
      5012: function (e, t, r) {
        ...
        function c(e, t, r, a) {
          n(e, t, r, a);
          var i = t.height * s.STEP;
          return (e.y += i), t;
        }
        function l(e, t, r, n) {
          var a = -(r.staffs[r.staffs.length - 1].bottom - 2),
            i = (n.staffs[0].top - 10 + a) * s.STEP;
          i < t && e.moveY(t - i);
        }
      ...
      9879: function (e, t, r) {
        ...
        e.exports = function (e, t, r) {
          ...
          var a = n(e, t.anchor.x, t.pitch, t.dec, {
            scalex: 1,
            scaley: 1,
      ...
      5947: function (e, t, r) {
        ...
        e.exports = function (e, t, r, o, c) {
          ...
          var l = s(e.calcY(t.pitch)),
            h = "";
          t.anchor1 &&
            ((r = s(t.anchor1.x + t.anchor1.w)),
            (h += n("M %f %f L %f %f ", r, l, r, s(l + 20)))),
            t.anchor2 &&
              ((o = s(t.anchor2.x)),
              (h += n("M %f %f L %f %f ", o, l, o, s(l + 20)))),
          ...
          return (
            c.wrapSvgEl({ el_type: "ending", startChar: -1, endChar: -1 }, u),
            [u]
          );
        };
      },
      9045: function (e, t, r) {
        ...
        function d(e, t) {
          for (var r = "", n = 0; n < e.length; n++)
            r += "l" + e[n][0] + " " + s(e[n][1], t, e[n][0]);
          return r;
        }
        var f = function (e, t, r, i, s) {
          var f,
            p = n("M %f %f", t, r);
          for (p += d(o, s), f = 0; f < i; f++) p += d(h, s);
          for (p += d(c, s), f = 0; f < i; f++) p += d(u, s);
          return (
            (p += d(l, s) + "z"),
            a(e, {
              path: p,
        ...
        e.exports = function (e, t, r) {
          ...
          var n,
            a,
            i = e.calcY(t.anchor1.heads[0].pitch),
      ...
      8832: function (e, t, r) {
        ...
        (a.prototype.beginGroup = function (e, t) {
          (this.paper = e),
            (this.controller = t),
            (this.path = []),
            (this.lastM = [0, 0]),
          ...
          (a.prototype.isInGroup = function () {
            return this.ingroup;
          }),
          (a.prototype.addPath = function (e) {
            if (0 !== (e = e || []).length) {
              (e[0][0] = "m"),
          ...
          (a.prototype.endGroup = function (e, t) {
            this.ingroup = !1;
            ...
            return (
              n &&
                ...
                n.setAttribute(
                  "fill",
                  this.controller.renderer.foregroundColor
                ),
        ...
        e.exports = function (e, t, r) {
          for (var i = 0; i < t.rows.length; i++) {
            ...
            if (s.absmove) e.absolutemoveY(s.absmove);
              ...
              e.paper.openGroup({ klass: s.klass, "data-name": s.name });
            else if (s.endGroup) {
      ...
      6637: function (e, t, r) {
        var n = r(6764),
          a = r(7199);
        e.exports = function (e, t, r, i, s, o, c) {
          c || (c = 0.35);
          ...
          return (
            o && (d["data-name"] = o), s && (d.class = s), e.paper.pathToBack(d)
          );
        };
      },
      6454: function (e) {
      ...
      3624: function (e, t, r) {
        ...
        e.exports = function (e, t, r, i, s, o, c) {
          ...
          return (
            ...
            c && (d["data-name"] = c),
            n.isInGroup() ||
              ((d.stroke = "none"), (d.fill = e.foregroundColor)),
            e.paper.pathToBack(d)
          );
        };
      },
      4777: function (e, t, r) {
        ...
        e.exports = function (e, t, r, s, o) {
          ...
          return (
            (l = a.getYCorr(s)),
            (c = i.isInGroup()
              ? a.printSymbol(t, e.calcY(r + l), s, e.paper, {
                  "data-name": o.name,
                })
              : a.printSymbol(t, e.calcY(r + l), s, e.paper, {
                  klass: o.klass,
        ...
        e.exports = function (e, t, r) {
          void 0 === t.pitch &&
            window.console.error(
              t.type + " Relative Element y-coordinate not set."
            );
          ...
          switch (t.type) {
            ...
            case "tabNumber":
              var l = "tabnumberfont",
                h = "tab-number";
              t.isGrace &&
                ((l = "tabgracefont"), (o += 2.5), (h = "tab-grace")),
                (t.graphelem = n(
                  e,
                  {
                    x: t.x,
      ...
      3524: function (e, t, r) {
        ...
        (i.prototype.getElements = function () {
          ...
          (i.prototype.add = function (e, t, r, n) {
            if (this.canSelect(e)) {
              var a;
              (a =
                ...
                this.paper.setAttributeOnElement(t, a);
              var i = { absEl: e, svgEl: t, isDraggable: r };
              void 0 !== n && (i.staffPos = n), this.elements.push(i);
            }
          }),
          (i.prototype.canSelect = function (e) {
            return !(
              ...
              (!0 !== this.selectTypes &&
                !(void 0 === this.selectTypes
                  ? "note" === e.abcelem.el_type ||
                    "tabNumber" === e.abcelem.el_type
      ...
      7611: function (e) {
        e.exports = function (e, t, r, n) {
          var a = (t + e.padding.right) * r,
            i = (e.y + e.padding.bottom) * r;
          if ((e.isPrint && (i = Math.max(i, 1056)), "" !== e.ariaLabel)) {
            var s = "Sheet Music";
            e.abctune &&
              e.abctune.metaText &&
          ...
          "resize" === n
            ? e.paper.setResponsiveWidth(a, i)
            : ((c.width = ""),
              (c.height = i + "px"),
              r < 1
                ? ((c.width = a + "px"), e.paper.setSize(a / r, i / r))
                : e.paper.setSize(a, i)),
            e.paper.setScale(r),
      ...
      6764: function (e) {
        ...
        e.exports = function () {
          for (var e, r, n, a, i, s = 0, o = arguments[s++], c = []; o; ) {
            if ((r = /^[^\x25]+/.exec(o))) c.push(r[0]);
              ...
              if (
                ...
                throw "Huh ?!";
              if (null == (e = arguments[r[1] || s++]) || null == e)
                throw "Too few arguments.";
              if (/[^s]/.test(r[7]) && "number" != typeof e)
                throw "Expecting number but found " + t(e);
              switch (r[7]) {
                case "b":
                  e = e.toString(2);
                  break;
              ...
              (e = /[def]/.test(r[7]) && r[2] && e > 0 ? "+" + e : e),
                (a = r[3] ? ("0" == r[3] ? "0" : r[3].charAt(1)) : " "),
                (i = r[5] - String(e).length),
                (n = r[5] ? str_repeat(a, i) : ""),
                c.push(r[4] ? e + n : n + e);
            }
        ...
        function h(e, t, r, i, s) {
          if (r)
            for (var o = 0; o < r.length; o++)
              r[o].isStartVoice(i) &&
                ((r[o].startY = t - 10 * n.STEP),
                (r[o].elemset = a(e, r[o], s)));
        }
        function u(e, t, r) {
          for (var a = 0; a < r.length; a++)
            for (var i = t[r[a]].children, s = 0; s < i.length; s++) {
              var c = i[s],
                l = c.getFixedCoords();
        ...
        e.exports = function (e, t, r, a) {
          for (var d, f, p, m = e.y, g = 0; g < t.staffs.length; g++) {
            ...
            e.moveY(n.STEP, v.top),
              (v.absoluteY = e.y),
              e.showDebug &&
                (e.showDebug.indexOf("box") >= 0 && u(e, t.voices, v.voices),
                e.showDebug.indexOf("grid") >= 0 &&
                  ...
                  (d = 0),
                  A(v, "chordHeightAbove"),
                  A(v, "chordHeightBelow"),
                  A(v, "dynamicHeightAbove"),
                  A(v, "dynamicHeightBelow"),
                  A(v, "endingHeightAbove"),
                  A(v, "lyricHeightAbove"),
                  A(v, "lyricHeightBelow"),
                  A(v, "partHeightAbove"),
                  A(v, "tempoHeightAbove"),
                  A(v, "volumeHeightAbove"),
                  A(v, "volumeHeightBelow"))),
          ...
          for (var b = 2, y = 0, w = 0; w < t.voices.length; w++) {
            var x = t.voices[w].staff,
              k = t.voices[w].tabNameInfos;
            if (
              ((e.y = x.absoluteY),
              e.controller.classes.incrVoice(),
              !t.voices[w].duplicate)
            ) {
              if ((f || (f = e.calcY(10)), (p = e.calcY(b)), 0 !== x.lines)) {
                x.linePitch && (b = x.linePitch),
                  e.controller.classes.newMeasure();
                var C = s(e, t.startx, t.w, x.lines, x.linePitch, x.dy);
                (p = C[1]),
                  (x.bottomLine = p),
                  (x.topLine = C[0]),
                  x.hasTab && (y = x.topLine),
                  x.hasStaff &&
                    ((y = x.hasStaff.topLine),
                    (t.voices[w].barto = !0),
                    (t.voices[w].topLine = f));
              }
              h(e, x.absoluteY, t.brace, w, r),
                h(e, x.absoluteY, t.bracket, w, r);
            }
            i(e, t.voices[w], y, r, {
              top: m,
              zero: e.y,
            ...
            if (k) {
              ...
              S.rows.push({ absmove: p + 2 }),
                ...
                S.rows.push({ move: k.textSize.height }),
                l(e, S),
                (T = k.textSize.height);
            }
            e.controller.classes.newMeasure(),
              t.voices[w].duplicate || (y = e.calcY(2 + T));
          }
          e.controller.classes.newMeasure();
          var _ = t.staffs.length;
          function A(t, r) {
            var a = [
              "rgb(207,27,36)",
              "rgb(168,214,80)",
            ...
            if (t.positionY[r]) {
              var i = t.specialY[r] * n.STEP;
              "chordHeightAbove" === r &&
                t.specialY.chordLines &&
                t.specialY.chordLines.above &&
                (i *= t.specialY.chordLines.above),
                "chordHeightBelow" === r &&
                  t.specialY.chordLines &&
          ...
          _ > 1 &&
            ...
            (p = t.staffs[_ - 1].bottomLine),
            c(e, t.startx, 0.6, f, p, null)),
            (e.y = m);
        };
      },
      7865: function (e, t, r) {
        var n = r(6637);
        e.exports = function (e, t, r, a, i, s, o) {
          var c = e.calcY(a);
          return n(e, t, r, c, i, s, o);
        };
      },
      7641: function (e, t, r) {
        var n = r(7865);
        e.exports = function (e, t, r, a, i, s) {
          ...
          var l = 0,
            h = 0;
          if (1 === a) n(e, t, r, 6, o), (l = e.calcY(10)), (h = e.calcY(2));
          else
            for (var u = a - 1; u >= 0; u--) {
              var d = (u + 1) * c;
              (h = e.calcY(d)),
      ...
      3987: function (e, t, r) {
        ...
        e.exports = function (e, t) {
          ...
          if (t.tempo.preString) {
            ...
            var o = e.controller.getTextSize.calc(
              t.tempo.preString,
              "tempofont",
              "tempo",
              i
          ...
          if (t.note) {
            t.note.setX(r);
            for (var c = 0; c < t.note.children.length; c++)
              n(e, t.note.children[c], r);
            r += t.note.w + 5;
            var l = "= " + t.tempo.bpm;
            i = a(e, {
              x: r,
            ...
            var h = e.controller.getTextSize.calc(
              l,
              "tempofont",
              "tempo",
              i
      ...
      5759: function (e, t, r) {
        ...
        e.exports = function (e, t, r) {
          ...
          if (t.lane) {
            ...
            i += (t.dim.font.size + s) * t.lane;
          }
          t.dim
            ? ((a = t.dim).attr.class = t.klass)
            : (a = e.controller.getFontAndAttr.calc(t.type, t.klass)),
            t.anchor && (a.attr["text-anchor"] = t.anchor),
            (a.attr.x = t.x),
            (a.attr.y = i),
            t.centerVertically || (a.attr.y += a.font.size),
            "debugfont" === t.type &&
              (console.log("Debug msg: " + t.text),
              (a.attr.stroke = "#ff0000")),
            t.cursor && (a.attr.cursor = t.cursor);
          ...
          (o = o.replace(/^\n/, " \n")),
            a.font.box &&
              ...
              "end" === a.attr["text-anchor"]
                ? (a.attr.x -= a.font.padding)
                : "start" === a.attr["text-anchor"] &&
                  (a.attr.x += a.font.padding),
              (a.attr.y += a.font.padding),
              delete a.attr.class),
            t.noClass && delete a.attr.class,
            (a.attr.x = n(a.attr.x)),
            (a.attr.y = n(a.attr.y)),
            t.name && (a.attr["data-name"] = t.name);
          var c = e.paper.text(o, a.attr);
          if (a.font.box) {
            var l = c.getBBox(),
              h = 0;
            "middle" === a.attr["text-anchor"]
              ? (h = l.width / 2 + a.font.padding)
              : "end" === a.attr["text-anchor"] &&
                (h = l.width + 2 * a.font.padding);
            var u = 0;
            t.centerVertically && (u = l.height - a.font.padding),
              e.paper.rect({
                "data-name": "box",
                x: Math.round(t.x - h),
                y: Math.round(i - u),
                width: Math.round(l.width + 2 * a.font.padding),
      ...
      3272: function (e, t, r) {
        var n = r(6764),
          ...
          i = function (e, t, r) {
            e.anchor1 && e.anchor2
              ? e.anchor1.pitch === e.anchor2.pitch &&
                0 === e.internalNotes.length
                ? (e.isTie = !0)
                : (e.isTie = !1)
              : (e.isTie = !0),
              e.isTie
          ...
          s = function (e, t, r, i, s, o, c, l, h) {
            ...
            var d,
              ...
              w = v / 3.5,
              x = l ? 10 : 25,
              k = (o ? -1 : 1) * Math.min(x, Math.max(4, w)),
              C = a(t + w * b - k * y),
              T = a(f + w * y + k * b),
              S = a(r - w * b - k * y),
              _ = a(p - w * y + k * b);
            if (
              ...
              c += " dotted";
              var A = n("M %f %f C %f %f %f %f %f %f", t, f, C, T, S, _, r, p);
              d = e.paper.path({
                path: A,
                stroke: e.foregroundColor,
                fill: "none",
        ...
        e.exports = function (e, t, r, n, a) {
          ...
          return (
            a.wrapSvgEl({ el_type: "slur", startChar: -1, endChar: -1 }, l), [l]
          );
        };
      },
      4322: function (e, t, r) {
        var n = r(6764),
          ...
          s = r(7199);
        function o(e, t, r, a) {
          return n("M %f %f L %f %f", s(e), s(t), s(r), s(a));
        }
        e.exports = function (e, t, r) {
          e.paper.openGroup({
            ...
            t.hasBeam ||
              (function (e, t, r, n, a) {
                (r = e.calcY(r)), (a = e.calcY(a));
                var s = 5,
                  c = "";
                (c += o(t, r, t, r + s)), (c += o(n, a, n, a + s));
                var l = t + (n - t) / 2,
                  h = 8,
                  u = (a - r) / (n - t),
                  d = l - h;
          ...
          return (
            r.wrapSvgEl({ el_type: "triplet", startChar: -1, endChar: -1 }, n),
            n
          );
        };
      },
      3145: function (e, t, r) {
        ...
        e.exports = function (e, t, r, d, f) {
          var p,
            m,
            g = t.w - 1;
          if (((e.staffbottom = t.staff.bottom), t.header)) {
            var v = h(
              e,
              {
                x: e.padding.left,
          ...
          var b,
            y = !1;
          for (p = 0; p < t.children.length; p++) {
            ("note" !== (m = t.children[p]).type && "rest" !== m.type) ||
              (y = !0);
            var w = !1;
            "staff-extra" === m.type ||
              ...
              t.staff.isTabStaff &&
                ((m.invisible = !1),
                "bar" == m.type && m.abcelem.lastBar && (r = t.topLine)),
              u(e, m, t.barto || p === t.children.length - 1 ? r : 0, d, f),
              ("note" === m.type ||
                ("rest" === (b = m).type &&
                  !(
                    !b.abcelem ||
                    !b.abcelem.rest ||
                    "spacer" === b.abcelem.rest.type
                  ))) &&
                e.controller.classes.incrNote(),
              "bar" === m.type && !w && y && e.controller.classes.incrMeasure();
          }
          for (
            e.controller.classes.startMeasure(), p = 0;
            p < t.beams.length;
            p++
          ) {
            var x = t.beams[p];
            "bar" === x ? e.controller.classes.incrMeasure() : l(e, x, d);
          }
          for (
            e.controller.classes.startMeasure(), p = 0;
            p < t.otherchildren.length;
            p++
          )
            if ("bar" === (m = t.otherchildren[p]))
              ...
              switch (m.type) {
                ...
                case "TripletElem":
                  ...
                  break;
                case "EndingElem":
                  m.elemset = o(e, m, t.startx + 10, g, d);
                  break;
                case "TieElem":
                  m.elemset = c(e, m, t.startx + 10, g, d);
                  break;
                default:
                  console.log(m), u(e, m, t.startx + 10, g, d, f);
              }
        };
      },
      2854: function (e) {
        ...
        e.exports = function (e, t, r, n, a, i) {
          ...
          if ("" === o) this.rows.push({ move: 2 * c.attr["font-size"] });
            ...
            this.rows.push({ move: c.attr["font-size"] / 2 }),
              ...
              (s = i.calc(o, "textfont", "defined-text")),
            ...
            this.rows.push({
              ...
              (s = i.calc(e[0].text, "textfont", "defined-text")),
              this.rows.push({ move: s.height });
          }
        };
      },
      1059: function (e) {
        ...
        (t.prototype.updateFonts = function (e) {
          e.gchordfont && (this.formatting.gchordfont = e.gchordfont),
            ...
            e.annotationfont &&
              (this.formatting.annotationfont = e.annotationfont),
          ...
          (t.prototype.calc = function (e, t) {
            ...
            var n = this.formatting.fontboxpadding
      ...
      3460: function (e) {
        ...
        (t.prototype.updateFonts = function (e) {
          ...
          (t.prototype.calc = function (e, t, r, n) {
            ...
            var i = this.svg.getTextSize(e, a.attr, n);
            return a.font.box
              ? {
                  height: i.height + 4 * a.font.padding,
                  width: i.width + 4 * a.font.padding,
                }
              : i;
          }),
          (t.prototype.baselineToCenter = function (e, t, r, n, a) {
            return (
              0.5 * this.calc(e, t, r).height +
              (a - n - 2) * this.attr(t, r).font.size
            );
          }),
          (e.exports = t);
      },
      ...
      1897: function (e) {
        ...
        (t.beginLayout = function (e, t) {
          ...
          (t.layoutOneItem = function (e, t, r, n, a) {
            var i = r.children[r.i];
            if (!i) return 0;
            var s = e - r.minx,
              o = r.durationindex + i.duration > 0 ? n : 0;
            if (
              "note" === i.abcelem.el_type &&
              !i.abcelem.rest &&
              0 !== r.voicenumber &&
              a
            ) {
              var c = a.children[a.i],
                l =
                  c &&
                  ((i.abcelem.maxpitch <= c.abcelem.maxpitch + 1 &&
                    i.abcelem.maxpitch >= c.abcelem.minpitch - 1) ||
                    (i.abcelem.minpitch <= c.abcelem.maxpitch + 1 &&
                      i.abcelem.minpitch >= c.abcelem.minpitch - 1));
              if (
                (l &&
                  i.abcelem.minpitch === c.abcelem.minpitch &&
                  i.abcelem.maxpitch === c.abcelem.maxpitch &&
                  c.heads &&
                  c.heads.length > 0 &&
                  i.heads &&
                  i.heads.length > 0 &&
                  c.heads[0].c === i.heads[0].c &&
                  (l = !1),
                l)
              ) {
                var h =
                  c.heads && c.heads.length > 0
                    ? c.heads[0].realWidth
                    : c.fixed.w;
                i.adjustedWidth || (i.adjustedWidth = h + i.w),
                  (i.w = i.adjustedWidth);
                for (var u = 0; u < i.children.length; u++) {
                  var d = i.children[u];
                  d.name.indexOf("accidental") < 0 &&
                    (d.adjustedWidth || (d.adjustedWidth = d.dx + h),
                    (d.dx = d.adjustedWidth));
                }
              }
            }
            var f = (function (e, t) {
            ...
            return (
              s < f &&
                (0 === r.i ||
                  "bar" !== i.type ||
                  ("part" !== r.children[r.i - 1].type &&
                    "tempo" !== r.children[r.i - 1].type)) &&
                (e += f - s),
              i.setX(e),
              (r.spacingduration = i.duration),
              (r.minx =
                e +
                (function (e) {
                  return e.w;
                })(i)),
              r.i !== r.children.length - 1 && (r.minx += i.minspacing),
          ...
          (t.updateIndices = function (e) {
            this.layoutEnded(e) ||
              ...
              "bar" === e.children[e.i].type &&
                (e.durationindex = Math.round(64 * e.durationindex) / 64),
              e.i++);
          }),
          (e.exports = t);
      },
      6251: function (e, t, r) {
        ...
        function o(e, t, r, n) {
          ...
          for (var a = 0; a < e.children.length; a++) {
            var i = e.children[a];
            t && void 0 !== i.top && "flags.ugrace" === i.c
              ? (n = Math.max(n, i.top - r))
              : t ||
                void 0 === i.bottom ||
                "flags.ugrace" !== i.c ||
                (n = Math.max(n, r - i.bottom + 7));
          }
          return n;
        }
        function c(e, t, r) {
          ...
          e && (i += n.w - 0.6);
          var s = a.x;
          return [i, (s += e ? a.w : 0.6)];
        }
        e.exports = function (e) {
          if (0 !== e.elems.length && !e.allrests) {
            var t = (function (e, t) {
                var r = e ? a.STEP : -a.STEP;
                return t && (r *= 0.4), r;
              })(e.stemsUp, e.isgrace),
              r = e.elems[0],
            ...
            (h = o(r, e.stemsUp, u, h)),
              (h = o(l, e.stemsUp, u, h)),
              (h = Math.max(e.stemHeight, h + 3));
            var d =
                ((g = e.average),
                (v = e.elems.length),
                (b = h),
                (y = e.stemsUp),
                (w = r.abcelem.averagepitch),
                (x = l.abcelem.averagepitch),
                (k = e.isflat),
                (C = e.min),
                (T = e.max),
                (S = e.isgrace),
                ...
                (A = b - 2),
                (E = Math.round(
                  y ? Math.max(g + _, T + A) : Math.min(g - _, C - A)
                )),
                (N = (function (e, t, r, n) {
                  if (n) return 0;
                  var a = e - t,
                    i = r / 2;
                  return a > i && (a = i), a < -i && (a = -i), a;
                })(w, x, v, k)),
                (M = E + Math.floor(N / 2)),
                (B = E + Math.floor(-N / 2)),
                S || (((y && E < 6) || (!y && E > 6)) && ((M = 6), (B = 6))),
                [M, B]),
              f = c(e.stemsUp, r, l);
            e.addBeam({
              startX: f[0],
                  ...
                  for (var o = [], l = [], h = 0; h < e.length; h++) {
                    ...
                    if (!u.abcelem.rest) {
                      var d = u.heads[t ? 0 : u.heads.length - 1],
                        f = d.x + (t ? d.w : 0),
                        p = i(r.startX, r.startY, r.endX, r.endY, f),
                        m = t ? -1.5 : 1.5;
                      n && (m = (2 * m) / 3);
                      ...
                      for (var v = s(g); v < -3; v++) {
                        ...
                        if (
                          ...
                          h > 0 &&
                            u.abcelem.beambr &&
                            u.abcelem.beambr <= b + 1)
                        ) {
                          l[b].split || (l[b].split = [l[b].x]);
                          var y = c(t, e[h - 1], u);
                          l[b].split[l[b].split.length - 1] >= y[0] &&
                            (y[0] += u.w),
                            l[b].split.push(y[0]),
                            l[b].split.push(y[1]);
                        }
                      ...
                      for (var w = l.length - 1; w >= 0; w--)
                        if (
                          ...
                          l[w].single &&
                            ((x = 0 === h ? f + 5 : f - 5),
                            (k =
                              i(r.startX, r.startY, r.endX, r.endY, x) +
                              m * (w + 1)));
                          var C = {
                            startX: l[w].x,
                            endX: x,
            ...
            !(function (e, t, r, s, o) {
              for (var c = 0; c < e.length; c++) {
                ...
                if (!l.abcelem.rest) {
                  ...
                  h || (m += d.dx);
                  var g = d.x + m,
                    v = i(r.startX, r.startY, r.endX, r.endY, g),
                    b = t ? -0.6 : 0.6;
                  t || (v -= s / 2 / a.STEP),
                    h && (m += l.heads[0].dx),
                    "noteheads.slash.quarter" === d.c &&
                      (t ? (p += 1) : (p -= 1));
                  var y = new n(null, m, 0, p, {
                    type: "stem",
                    pitch2: v,
                    linewidth: b,
                  });
          ...
          var g, v, b, y, w, x, k, C, T, S, _, A, E, N, M, B;
        };
      },
      4760: function (e) {
        function t(e, t, r) {
          if (t)
            for (var n = 0; n < t.length; n++)
              if (t[n].header) {
                var a = r.calc(t[n].header, "voicefont", "");
        ...
        function r(e, t, r) {
          if (e)
            for (var a = 0; a < e.length; a++)
              n(t, e[a]), (r = Math.max(r, e[a].getWidth()));
          return r;
        }
        function n(e, t) {
          t.x = e;
        }
        e.exports = function (e, n, a, i, s) {
          var o,
            c,
            l = e.padding.left,
            h = 0;
          for (o = 0; o < a.length; o++)
            a[o].header &&
              ((c = n.calc(a[o].header, "voicefont", "")),
              (h = Math.max(h, c.width)));
          (h = t(h, i, n)),
            (h = t(h, s, n)) && (h += n.calc("A", "voicefont", "").width);
          var u = 0;
          return (u = r(i, (l += h), u)), l + (u = r(s, l, u));
        };
      },
      6807: function (e) {
        e.exports = function (e, t, r, n, a) {
          return t + ((n - t) / (r - e)) * (a - e);
        };
      },
      1564: function (e, t, r) {
        var n = r(6759),
          ...
          i = r(2432),
          s = r(4760),
          o = function (e, t, r, n, a, o, l) {
            for (
              var h = s(e, n.getTextSize, n.voices, n.brace, n.bracket),
                u = r,
                d = 0;
              d < 8;
              d++
        ...
        function c(e, t, r, n, a, i, s, o) {
          ...
          return Math.abs(r - n) < 2
            ? null
            : i > 0
            ? ((a = (r - (n - i * a)) / i) * s > 50 && (a = 50 / s), a)
            : null;
        }
        e.exports = function (e, t, r, i) {
          var s,
          ...
          for (s = 0; s < t.lines.length; s++)
            if ((c = t.lines[s]).staffGroup && c.staffGroup.voices) {
              for (var h = 0; h < c.staffGroup.voices.length; h++)
                n(c.staffGroup.voices[h]);
              a(e, c.staffGroup);
            }
          for (s = 0; s < t.lines.length; s++)
            (c = t.lines[s]).staffGroup && c.staffGroup.setHeight();
          return l;
        };
      },
      7590: function (e, t, r) {
        ...
        function i(e, t, r, n) {
          if (e.specialY[r]) {
            var i = e.specialY[r];
            n && (i *= n), (e.top += i + a), (t[r] = e.top);
          }
        }
        function s(e, t, r) {
          var n, a;
          for (n = 0; n < t.children.length; n++) o(e, (a = t.children[n]), r);
          for (n = 0; n < t.otherchildren.length; n++)
            switch ((a = t.otherchildren[n]).type) {
              case "CrescendoElem":
                c(e, a);
                break;
              case "DynamicDecoration":
        ...
        function o(e, t, r) {
          for (var n = 0; n < t.children.length; n++) {
            var a = t.children[n];
            for (var i in t.specialY)
              t.specialY.hasOwnProperty(i) &&
                a[i] &&
                ((a.pitch = e[i]),
                void 0 === a.top &&
                  ("TempoElement" === a.type ? u(e, a) : d(e, a, r),
                  t.pushTop(a.top),
                  t.pushBottom(a.bottom)));
          }
        }
        function c(e, t) {
        ...
        function u(e, t) {
          if (
            ...
            for (var n = 0; n < t.note.children.length; n++) {
              var a = t.note.children[n];
              (a.top += r),
                (a.bottom += r),
                (a.pitch += r),
                void 0 !== a.pitch2 && (a.pitch2 += r);
            }
          }
        }
        function d(e, t, r) {
          switch (t.type) {
            case "part":
              (t.top = e.partHeightAbove + t.height),
                (t.bottom = e.partHeightAbove);
              break;
            case "text":
            case "chord":
              t.chordHeightAbove
                ? ((t.top = e.chordHeightAbove),
                  (t.bottom = e.chordHeightAbove))
                : ((t.top = e.chordHeightBelow),
                  (t.bottom = e.chordHeightBelow));
              break;
            case "lyric":
              t.lyricHeightAbove
                ? ((t.top = e.lyricHeightAbove),
                  (t.bottom = e.lyricHeightAbove))
        ...
        e.exports = function (e, t) {
          for (var r, o = 0; o < t.staffs.length; o++) {
            ...
            if (
              ...
              i(c, l, "lyricHeightAbove"),
              i(c, l, "chordHeightAbove", c.specialY.chordLines.above),
              c.specialY.endingHeightAbove &&
                (c.specialY.chordHeightAbove
                  ? (c.top += 2)
                  : (c.top += c.specialY.endingHeightAbove + a),
                (l.endingHeightAbove = c.top)),
              c.specialY.dynamicHeightAbove && c.specialY.volumeHeightAbove
                ? ((c.top +=
                    Math.max(
                      c.specialY.dynamicHeightAbove,
                      c.specialY.volumeHeightAbove
                    ) + a),
                  (l.dynamicHeightAbove = c.top),
                  (l.volumeHeightAbove = c.top))
                : (i(c, l, "dynamicHeightAbove"), i(c, l, "volumeHeightAbove")),
              i(c, l, "partHeightAbove"),
              ...
              c.specialY.lyricHeightBelow &&
                ...
                (c.bottom -= c.specialY.lyricHeightBelow + a)),
              c.specialY.chordHeightBelow)
            ) {
              l.chordHeightBelow = c.bottom;
              var h = c.specialY.chordHeightBelow;
              c.specialY.chordLines.below && (h *= c.specialY.chordLines.below),
                (c.bottom -= h + a);
            }
            c.specialY.volumeHeightBelow && c.specialY.dynamicHeightBelow
              ...
              : c.specialY.volumeHeightBelow
              ? ((l.volumeHeightBelow = c.bottom),
                (c.bottom -= c.specialY.volumeHeightBelow + a))
              : c.specialY.dynamicHeightBelow &&
                ((l.dynamicHeightBelow = c.bottom),
                (c.bottom -= c.specialY.dynamicHeightBelow + a)),
              e.showDebug &&
                e.showDebug.indexOf("box") >= 0 &&
                (c.positionY = l);
            for (var u = 0; u < c.voices.length; u++)
              s(l, t.voices[c.voices[u]], e.spacing);
            if (void 0 !== r) {
              var d = r + (c.top - 10),
      ...
      2432: function (e, t, r) {
        ...
        e.exports = function (e, t, r, s, o) {
          ...
          var d,
            ...
            p = 0;
          for (
            r && console.log("init layout", e), c = 0;
            c < s.voices.length;
            c++
          )
            n.beginLayout(u, s.voices[c]);
          for (var m = 0; !a(s.voices); ) {
            for (p = null, c = 0; c < s.voices.length; c++)
              n.layoutEnded(s.voices[c]) ||
                (p && !(i(s.voices[c]) < p)) ||
                (p = i(s.voices[c]));
            var g = [],
              v = [];
            ...
            for (c = 0; c < g.length; c++)
              n.getNextX(g[c]) > u &&
                ((u = n.getNextX(g[c])),
                (m = n.getSpacingUnits(g[c])),
                (b = g[c].spacingduration));
            (l += m),
              (h = Math.min(h, m)),
              r && console.log("currentduration: ", p, l, h);
            var y = void 0;
            for (c = 0; c < g.length; c++) {
              var w = g[c];
              0 === w.voicenumber && (y = c);
              var x =
                void 0 !== y && g[y].voicenumber !== w.voicenumber
                  ? g[y]
                  : void 0;
              (f = x),
                ((d = w) &&
                  ...
                  (x = void 0);
              var k = n.layoutOneItem(u, e, w, t.minPadding, x),
                C = k - u;
              if (C > 0) {
                u = k;
            ...
            for (c = 0; c < v.length; c++)
              (v[c].spacingduration -= b), n.updateNextX(u, e, v[c]);
            for (c = 0; c < g.length; c++) {
              var S = g[c];
              n.updateIndices(S);
            }
          ...
          for (c = 0; c < s.voices.length; c++)
            n.getNextX(s.voices[c]) > u &&
              ((u = n.getNextX(s.voices[c])),
              (m = n.getSpacingUnits(s.voices[c])));
          return (
            (function (e) {
              for (var t = 0, r = 0; r < e.length; r++) {
                var n = e[r];
                if (n.children.length > 0) {
                  var a = n.children.length - 1,
                    i = n.children[a];
                  if ("bar" === i.abcelem.el_type) {
                    var s = i.children[0].x;
                    s > t ? (t = s) : (i.children[0].x = t);
                  }
                }
              }
            })(s.voices),
        ...
        e.exports = function (e) {
          if (e.anchor1 && e.anchor2) {
            ...
            if (
              ...
              var r = a(t) ? e.anchor1.x + e.anchor1.w : e.anchor1.x;
              (e.yTextPos = (function (e, t, r) {
                if (0 === r.beams.length) return 0;
                r = r.beams[0];
                var a = e + (t - e) / 2;
                return n(r.startX, r.startY, r.endX, r.endY, a);
              })(r, e.anchor2.x, t)),
                (e.yTextPos += a(t) ? 3 : -2),
                (e.xTextPos = ((o = r), (c = e.anchor2.x), o + (c - o) / 2)),
                (e.top = e.yTextPos + 1),
                (e.bottom = e.yTextPos - 2),
                a(t) && (e.endingHeightAbove = 4);
            } else {
              (e.startNote = Math.max(e.anchor1.parent.top, 9) + 4),
                (e.endNote = Math.max(e.anchor2.parent.top, 9) + 4),
                "rest" === e.anchor1.parent.type &&
                "rest" !== e.anchor2.parent.type
                  ? (e.startNote = e.endNote)
                  : "rest" === e.anchor2.parent.type &&
                    "rest" !== e.anchor1.parent.type &&
                    (e.endNote = e.startNote);
              for (var i = 0, s = 0; s < e.middleElems.length; s++)
                i = Math.max(i, e.middleElems[s].top);
              ((i += 4) > e.startNote || i > e.endNote) &&
                ((e.startNote = i), (e.endNote = i)),
                e.flatBeams &&
      ...
      6759: function (e, t, r) {
        ...
        function s(e) {
          for (var t = 0; t < e.elems.length; t++) {
            var r = e.elems[t];
            if (r.top)
              for (var n = l(r, e), a = 0; a < r.children.length; a++) {
                var i = r.children[a];
                if ("ornament" === i.klass && i.bottom - 1.5 < n) {
                  var s = n - i.bottom + 1.5;
                  (i.bottom += s),
                    (i.top += s),
                    (i.pitch += s),
                    (n = r.top = i.top);
        ...
        function o(e, t) {
          ...
          if (r) {
            for (var n = 0; n < e.length; n++)
              if (e[n] < r.left)
                return n > 0 && t.putChordInLane(n), void (e[n] = r.right);
            e.push(r.right), t.putChordInLane(e.length - 1);
          }
        }
        function c(e) {
          for (var t = 0, r = 0; r < e.children.length; r++)
            e.children[r].chordHeightBelow && t++;
          return t;
        }
        function l(e, t) {
          return (t = t.beams[0]), a(t.startX, t.startY, t.endX, t.endY, e.x);
        }
        e.exports = function (e) {
          ...
          for (
            e.staff.specialY.chordLines = (function (e) {
              ...
              for (t = 0; t < e.length; t++) {
                for (r = 0; r < e[t].children.length; r++)
                  (n = e[t].children[r]).chordHeightAbove && o(a, n);
                for (r = e[t].children.length - 1; r >= 0; r--)
                  (n = e[t].children[r]).chordHeightBelow && o(i, n);
              }
              return (
                (a.length > 1 || i.length > 1) &&
                  (function (e, t, r) {
                    for (var n = 0; n < e.length; n++) {
                      c(e[n]);
                      for (var a = 0; a < e[n].children.length; a++) {
                        var i = e[n].children[a];
                        i.chordHeightAbove && i.invertLane(t);
                      }
                    }
                  })(e, a.length, i.length),
                { above: a.length, below: i.length }
              );
            })(e.children),
              t = 0;
            ...
            "TripletElem" === a.type && (i(a), e.adjustRange(a));
          }
          (e.staff.top = Math.max(e.staff.top, e.top)),
            (e.staff.bottom = Math.min(e.staff.bottom, e.bottom));
        };
      ...
      2557: function (e, t, r) {
              ...
              (t = !0),
                ...
                this.dragTarget &&
                  ...
                  this.dragTarget.svgEl.setAttribute(
                    "transform",
                    "translate(0," + this.dragYStep * n.STEP + ")"
                  ));
              break;
            case 40:
              (t = !0),
            ...
            i = (function (e, t) {
              ...
              (function (e) {
                ...
                for (var t = e.getAttribute("selectable"); !t; )
                  t =
                    !e.parentElement ||
                    "svg" === (e = e.parentElement).tagName ||
                    e.getAttribute("selectable");
                return e;
              })(t.target)
            );
          return (
            i >= 0
              ? ((a = (function (e, t, r) {
                  return (e.x <= t.offsetX &&
                    ...
                    ? [t.offsetX, t.offsetY]
                    : [t.layerX, t.layerY];
                })(e.selectables[i].svgEl.getBBox(), t, e.scale)),
                (r = a[0]),
                (n = a[1]))
              : ((a = (function (e) {
                  var t,
                    ...
                    n = 1,
                    a = 1,
                    i = e.target.closest("svg"),
                    s = 0;
                  return (
                    i &&
                      i.viewBox &&
                      i.viewBox.baseVal &&
                      (0 !== i.viewBox.baseVal.width &&
                        (n = i.viewBox.baseVal.width / i.clientWidth),
                      0 !== i.viewBox.baseVal.height &&
                        (a = i.viewBox.baseVal.height / i.clientHeight),
                      (s = i.viewBox.baseVal.y)),
                ...
                (i = (function (e, t, r) {
                  for (
                    var n = 9999999, a = -1, i = 0;
                    i < e.selectables.length && n > 0;
                    i++
                  ) {
                    var s = e.selectables[i];
                    if (
                      (e.getDim(s),
                      s.dim.left < t &&
                        s.dim.right > t &&
                      ...
                      var o = Math.min(
                        Math.abs(s.dim.left - t),
                        Math.abs(s.dim.right - t)
                      );
                      o < n && ((n = o), (a = i));
                    } else if (s.dim.left < t && s.dim.right > t) {
                      var c = Math.min(
                        Math.abs(s.dim.top - r),
                        Math.abs(s.dim.bottom - r)
                      );
                      c < n && ((n = c), (a = i));
                    } else {
                      var l =
        ...
        function l(e) {
          var t = e;
          "touchstart" === e.type &&
            (c(e), e.touches.length > 0 && (t = e.touches[0]));
          var r = o(this, t);
          r.clickedOn >= 0 &&
        ...
        function h(e) {
          ...
          if (
            ...
            var r = o(this, t),
              a = Math.round((r.y - this.dragMouseStart.y) / n.STEP);
            a !== this.dragYStep &&
              ((this.dragYStep = a),
              this.dragTarget.svgEl.setAttribute(
                "transform",
                "translate(0," + a * n.STEP + ")"
              ));
          }
        }
        function u(e) {
        ...
        function f(e, t, r, n, a) {
          ...
          if (e.absEl.elemset) {
            for (var s = {}, o = 0; o < e.absEl.elemset.length; o++) {
              ...
              if (c)
                for (
                  var l = c.getAttribute("class").split(" "), h = 0;
                  h < l.length;
                  h++
                )
                  s[l[h]] = !0;
            ...
            for (var u = 0; u < Object.keys(s).length; u++)
              i.push(Object.keys(s)[u]);
          }
          for (var f = {}, m = 0; m < i.length; m++)
            p(i[m], "abcjs-v", f, "voice"),
              p(i[m], "abcjs-l", f, "line"),
              p(i[m], "abcjs-m", f, "measure");
          ...
          for (
            ...
            v.dataset &&
            !v.dataset.index &&
            "svg" !== v.tagName.toLowerCase();

          )
            v = v.parentNode;
          (f.name = v.dataset.name),
            (f.clickedName = g.dataset.name),
            (f.parentClasses = v.classList),
            (f.clickedClasses = g.classList),
        ...
        function g(e, t) {
          ...
          for (var r = 0; r < this.staffgroups.length; r++)
            for (var n = this.staffgroups[r].voices, a = 0; a < n.length; a++)
              for (var i = n[a].children, s = 0; s < i.length; s++) {
                var o = i[s].abcelem.startChar,
                  c = i[s].abcelem.endChar;
                ((t > o && e < c) || (t === e && t === c)) &&
                  ((this.selected[this.selected.length] = i[s]),
                  i[s].highlight(void 0, this.selectionColor));
              }
        }
        function v(e) {
          ...
          if (((e.rangeHighlight = g), e.dragging))
            for (var r = 0; r < e.selectables.length; r++) {
              ...
              "true" === n.svgEl.getAttribute("selectable") &&
                ...
                n.svgEl.addEventListener("keydown", i.bind(e)),
                n.svgEl.addEventListener("keyup", s.bind(e)),
                n.svgEl.addEventListener("focus", a.bind(e)));
            }
          for (var o = 0; o < t.length; o++)
            t[o].addEventListener("touchstart", l.bind(e)),
              t[o].addEventListener("touchmove", h.bind(e)),
              t[o].addEventListener("touchend", u.bind(e)),
      ...
      1009: function (e) {
        e.exports = function (e, t, r, n) {
          if (e)
            for (var a = 0; a < e.length; a++) {
              var i = e[a],
                s = i.getAttribute("highlight");
              s || (s = "fill"), i.setAttribute(s, n);
      ...
      9725: function (e) {
        e.exports = function (e, t, r, n, a, i) {
          ...
          var c = i.calc(r.text, "subtitlefont", "text subtitle");
      ...
      4101: function (e) {
        ...
        function n(e, t, r) {
          var n = r - e;
          return (
            "M " + e + " " + t + " l " + n + " 0 l 0 1  l " + -n + " 0  z "
          );
        }
        function a(e, t, r) {
          var n = r - t;
          return (
            "M " + e + " " + t + " l 0 " + n + " l 1 0  l 0 " + -n + "  z "
          );
        }
        (r.prototype.clear = function () {
            ...
            if (
              ...
              r
                ? r.indexOf("abcjs-container") < 0 &&
                  this.svg.parentNode.setAttribute(
                    "class",
                    r + " abcjs-container"
                  )
          ...
          (r.prototype.rectBeneath = function (e) {
            ...
            r.setAttribute("x", e.x),
              ...
              e["stroke-opacity"] &&
                r.setAttribute("stroke-opacity", e["stroke-opacity"]),
              e.fill && r.setAttribute("fill", e.fill),
              e["fill-opacity"] &&
                r.setAttribute("fill-opacity", e["fill-opacity"]),
              this.svg.insertBefore(r, this.svg.firstChild);
          }),
          (r.prototype.text = function (e, r, n) {
            var a = document.createElementNS(t, "text");
            for (var i in (a.setAttribute("stroke", "none"), r))
              r.hasOwnProperty(i) && a.setAttribute(i, r[i]);
            for (var s = ("" + e).split("\n"), o = 0; o < s.length; o++) {
              var c = document.createElementNS(t, "tspan");
              if (
                (c.setAttribute("x", r.x ? r.x : 0),
            ...
            return n ? n.appendChild(a) : this.append(a), a;
          }),
        ...
        (r.prototype.getTextSize = function (e, t, r) {
          ...
          var n;
          if (e.length < 20 && ((n = e + JSON.stringify(t)), i[n])) return i[n];
          var a,
            s = !r;
          r || (r = this.text(e, t));
          try {
          ...
          (r.prototype.setAttributeOnElement = function (e, t) {
            for (var r in t)
              t.hasOwnProperty(r) && e.setAttributeNS(null, r, t[r]);
          }),
      ...
      8135: function (e, t, r) {
        var n = r(3502);
        e.exports = function (e, t, r, a, i, s, o, c, l) {
          ...
          if (
            ...
            for (var f = 0; f < a.length && a[f].subtitle; )
              n(
                this.rows,
                {
                  marginLeft: d,
                  text: a[f].subtitle.text,
                  font: "subtitlefont",
          ...
          if (e.rhythm || e.origin || e.composer) {
            if (
              (this.rows.push({ move: c.composer }),
              e.rhythm && e.rhythm.length > 0)
            ) {
